...
export const honKhoIsland: Location = {
  ...
  tags: ["🏝️ Day Trip Island", "🐠 Coral Reefs", "🚤 Boat Tour", "📷 Rocky Coastline", "🌊 SUP & Seaweed Season"],
  ...
  insights: {
    highlights: [
      "Tidal path between the two island sections - only visible at low tide, one of Hòn Khô's most photographed features",
      "Rong mơ season May-July: golden seaweed carpets the sea floor, visible by SUP or snorkeling - 'golden ocean field' effect",
      "Clear turquoise water and granite boulder coastline - calm and quiet compared to Quy Nhơn's main beaches",
      "Lễ Hội Cầu Ngư: 12th-16th of the 3rd lunar month - fishing community festival with bài chòi, lion dance",
    ],
    thingsToKnow: {
      crowds: "Busiest June-August peak season. September offers good conditions with noticeably fewer visitors. Weekdays quieter than weekends year-round.",
      difficulty: "Easy beach day. Rocky terrain requires shoes beyond the main landing beach. SUP available for those who want to explore further.",
      safety: "Very exposed and sunny - hat and sunscreen essential. Floating seafood raft area has rubbish. Oct-Jan rough seas make boat access dangerous.",
      accessibility: "Boat from Nhơn Hải: 200,000-300,000 VND return. Island entrance: 80,000 VND/person (2025). 18km northeast of Quy Nhơn via Thị Nại Bridge.",
      seasonal: "Feb-Sep: dry season, boat access reliable, 25-32°C. May-Jul: rong mơ golden seaweed season - most distinctive visual. Oct-Jan: rough seas, avoid.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Hòn Khô from Quy Nhơn?",
        answer: "18km northeast via Thị Nại Bridge to Nhơn Hải fishing village - about 30-40 minutes by motorbike. Hire a boat from local fishermen: 200,000-300,000 VND return per boat, 10-15 minute crossing. Island entrance fee 80,000 VND/person from 2025.",
      },
      {
        question: "What is rong mơ season at Hòn Khô?",
        answer: "May to July, peaking in late May to early June. Golden seaweed (rong mơ) carpets the shallow sea floor around the island, creating a vivid yellow-amber 'golden ocean field' visible from above on calm days. Best experienced by SUP or snorkeling. One of the most distinctive seasonal spectacles on the central Vietnam coast.",
      },
      {
        question: "When is the tidal path visible?",
        answer: "At low tide only - a natural sand and rock path emerges between the two sections of the island when the water level drops. It disappears as the tide comes back in. Check tide times before visiting if this is a priority.",
      },
      {
        question: "When is the best time to visit Hòn Khô?",
        answer: "February to September for reliable boat access and good conditions. May-July for rong mơ golden seaweed season. September for fewer crowds with still-good weather. February-March (lunar calendar) for Lễ Hội Cầu Ngư fishing festival. Avoid October to January when rough seas make the crossing dangerous.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for clear water, the tidal path visual, granite boulder scenery, and the rong mơ season. Quieter and more peaceful than Quy Nhơn's main beaches.",
      negative: "Rubbish around the floating seafood raft area. Very exposed and hot without shade. Entrance fee added from 2025. Inconsistent snorkeling rental gear.",
    },
  },
}
