...
export const vietHaiVillage: Location = {
  ...
  insights: {
    highlights: [
      "141-hectare village of 87 households with no road access - reached only by boat or 12km jungle trek through the national park",
      "Rice paddies in a karst valley - June harvest turns the fields gold; Feb-Mar fog creates atmospheric photography conditions",
      "Guided walk to Hang Tiên Đức cave through jungle, with lunch at an abandoned village site",
    ],
    thingsToKnow: {
      crowds: "Busy with day tours from midday onward, especially weekends. Quiet on weekday mornings and after 3 PM when tours leave. Overnight stays give the best access to the village at its most peaceful.",
      difficulty: "Village itself is flat and easy. 12km jungle trek to reach it is moderate - 3-4 hours, good fitness helpful. Boat access is easy.",
      safety: "July-August rough seas can cut off boat access. Jungle trek requires closed shoes and awareness of terrain. No road in or out - plan accordingly.",
      accessibility: "Village is flat and navigable by bicycle. Jungle trek is not suitable for limited mobility. Boat access is the easier option for most visitors.",
      seasonal: "Feb-Mar: spring fog, cool air, atmospheric. Jun: rice harvest, lush and golden. Jul-Aug: rough seas may prevent boat access, use trek. Oct-Dec: quieter, good conditions.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Việt Hải?",
        answer: "Two options: boat from Bến Bèo pier in Cát Bà town (50,000 VND/person scheduled, or 400,000 VND for a 6-person speedboat), or 12km jungle trek through Cát Bà National Park (160,000 VND park entry). July-August rough seas sometimes prevent boat access - use the trek in those months. Many visitors combine both routes: trek in, boat out.",
      },
      {
        question: "Is Việt Hải worth visiting or is it too touristy?",
        answer: "Worth visiting if you go with the right expectations. The village has become a standard day tour stop and has tourist facilities around it. What hasn't changed is the setting: rice fields in a karst valley, no road access, working farm life. Go for the journey, the landscape, and an overnight stay if you can - not for an undiscovered fishing village experience.",
      },
      {
        question: "What is the best time to visit?",
        answer: "June for the rice harvest when the fields turn gold against the karst backdrop. February-March for spring fog that hangs over the village in the morning. Avoid July-August if planning to arrive by boat - rough seas frequently prevent access. October to May is the most reliable window overall.",
      },
    ],
    sentiment: {
      positive: "The setting is consistently praised - karst valley, rice fields, no road noise, and the journey in (jungle trek or bay approach by boat) is frequently described as the highlight. Overnight stays get strong reviews for the quiet and the homestay food.",
      negative: "Day tour crowds by midday. The village has been shaped by tourism - fish spa, snake wine stalls, electric carts. Visitors expecting an untouched fishing village will find it more developed than anticipated.",
    },
  },
}
