...
export const cuChiTunnels: Location = {
  ...
  insights: {
    highlights: [
      "Crawl through narrow tunnel sections to experience the underground living conditions firsthand - even the widened tourist sections are genuinely claustrophobic",
      "See displays of booby traps, weapons, and manufacturing processes used during the Vietnam War",
      "Fire historic weapons including AK-47 and M16 at the on-site shooting range (additional fee per round)",
    ],
    thingsToKnow: {
      crowds: "Gets extremely busy with tour groups, especially during peak season. Arrive before 9 AM or after 2 PM for a noticeably quieter experience.",
      difficulty: "Tunnels are very narrow and claustrophobic, requiring constant bending and crawling. Not recommended for claustrophobic visitors or those with heart or mobility issues. Some sections have no illumination - bring a phone torch.",
      safety: "Watch for bats in the tunnels. Mosquitoes present - bring repellent. Shooting range uses real historic weapons; ammunition charged per round at approximately $2-3 USD.",
      accessibility: "Located 1-1.5 hours from central HCMC by car. Multiple tunnel sections available - visitors can choose to crawl both, one, or skip entirely. Site entry and guided tour are separate fees.",
      seasonal: "Rainy season (May-October) turns unpaved paths muddy and tunnel access more uncomfortable. Dry season November-April is significantly more pleasant.",
    },
    visitorTips: [
    ...
    faq: [
      {
        ...
        answer: "Site entry is 35,000 VND/person. The guided tour service is an additional 100,000 VND/person and is strongly recommended - without it the displays are harder to contextualise. Children under 7 enter free.",
      },
      {
        question: "How physically demanding is crawling through the tunnels?",
        answer: "Very demanding. Even the widened tourist sections require constant bending and crawling with limited headroom. Some sections are unlit. Skip if claustrophobic or if you have heart or mobility issues.",
      },
      {
        question: "Ben Dinh or Ben Duoc - which should I visit?",
        answer: "Ben Dinh is closer to HCMC (40km), more polished, and where most group tours go. Ben Duoc is 20km further, significantly larger, less crowded, and has a more authentic atmosphere including a large war memorial temple. If you have independent transport, Ben Duoc is worth the extra distance.",
      },
    ],
    sentiment: {
      positive: "Overwhelmingly positive reviews praising the historical significance, the immersive experience of crawling through the tunnels, and the powerful understanding of Vietnamese resilience during wartime. Consistently rated one of the most worthwhile day trips from HCMC.",
      negative: "Some criticism of overcrowding during peak season, the jarring contrast of the shooting range with the historical context, and the additional cost of the guided tour on top of the entry fee.",
    },
  },
}
