...
export const phatDiemCathedral: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1779191965757!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQy04OW1mX3dF!2m2!1d20.09295580077188!2d106.0794880590288!3f358.8949301271462!4f-23.398552980335197!5f0.7820865974627469", },
  heroImage: heroUrl("phat-diem-cathedral_ub9j70"),
  gallery: [
    "phat-diem-cathedral_ub9j70",
    "phat-diem-cathedral-2_iuqr7q",
    "phat-diem-cathedral-5_wzapsk",
    "phat-diem-cathedral-3_vmuiro",
    "phat-diem-cathedral-6_uy5num",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "One of very few cathedrals in the world built almost entirely in Vietnamese architectural style rather than European Gothic or Baroque",
      "22-hectare complex blending Catholic liturgical function with traditional Vietnamese design",
      "Massive ironwood columns and monolithic stone construction completed in the late 19th century",
      "Centre of one of Vietnam's oldest and largest Catholic communities",
      "Phương Đình stone bell tower holding a 2-ton bell said to be audible more than 10km away",
    ],
    thingsToKnow: {
      crowds: "Generally quiet outside of Christmas and Easter; Christmas Eve mass draws tens of thousands of pilgrims and the surrounding town fills up completely",
      difficulty: "Flat, easy walking across a large 22-hectare site; no significant physical difficulty, though comfortable shoes help given the distances between buildings",
      safety: null,
      accessibility: "Grounds and the main cathedral are wheelchair-passable on paved paths; some interior floors and thresholds in the older side chapels may be uneven",
      seasonal: "Best visited Nov-Apr in the dry season; Christmas Eve is the most atmospheric time to visit but also by far the most crowded",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Why doesn't Phát Diệm Cathedral look like a European cathedral?", answer: "It was designed in Vietnamese architectural style from the outset, using the form of a communal house or pagoda for a Catholic church rather than importing European Gothic or Baroque design" },
      { question: "Do I need to be Catholic to visit?", answer: "No. The complex is open to all visitors, and most people come for the architecture rather than for religious reasons" },
      { question: "How long should I plan to spend at Phát Diệm?", answer: "At least 1-1.5 hours to see the main cathedral, the Phương Đình bell tower, and the four side chapels without rushing" },
