...
export const phatDiemCathedral: Location = {
  ...
  bestTime: "Nov - Apr (dry season; Christmas and Easter masses are significant events drawing thousands of pilgrims)",
  ...
  tips: [
    "The cathedral complex covers a large area with multiple chapels, a bell tower, and ornamental ponds - allow at least 1-1.5 hours to explore the full site",
    ...
    "The bell tower (Phương Đình) predates the cathedral and is the oldest structure on the site - climb to the upper levels for views across the surrounding rice plains",
    "Phát Diệm is the centre of one of Vietnam's largest Catholic communities - the Kim Sơn district has been a Catholic stronghold since the 17th century Jesuit missions",
