...
export const laNgauStream: Location = {
  ...
  type: ["stream", "river", "nature"],
  categories: ["hidden-gem", "nature"],
  experiences: ["trekking", "photography", "camping", "wildlife", "swimming"],
  ...
  gallery: [
    ...
    "la-ngau-stream-binh-thuan-8_kqa2hl",
    "la-ngau-stream-binh-thuan-1_hsnmc6",
    "la-ngau-stream-binh-thuan-7_p79piw",
    "la-ngau-stream-binh-thuan-10_ek3cpz",
    "la-ngau-stream-binh-thuan-15_cl0npy",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Rocky jungle stream with natural pools - cold, clear water over exposed rock formations",
      "Multiple campsites with facilities (toilets, showers, tent rental) - easy weekend setup from Saigon",
      "SUP rental available (100,000 VND/hour)",
      "Trek option to Hồ Tiên (Fairy Lake) upstream for more challenging exploration",
    ],
    thingsToKnow: {
      crowds: "Popular with Saigon weekend groups, busiest Saturday-Sunday. Quiet on weekdays. Multiple campsites spread the crowd.",
      difficulty: "Easy to moderate. Stream walking on rocky surface requires care. Last road section is unpaved. Upstream Hồ Tiên trek is more demanding.",
      safety: "⚠️ Dam releases from ~4 PM cause rapid water rise - within under a minute. At least 2 people have been swept away here. Always follow campsite manager warnings. Do not camp next to the stream. Water is cold - watch for cramps. Flash flood risk in wet season.",
      accessibility: "4-5 hours from HCMC. High-clearance vehicles recommended for final section; standard cars can stop at outer campsites. No electricity on site - bring power bank. Viettel has best signal.",
      seasonal: "Dec-Apr: dry season, clear water, best conditions. Jun-Oct: wet season, murky water, flash flood risk - avoid camping. Daily water cycle matters more than season for timing activities.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Is La Ngâu safe for swimming?",
      ...
      {
        question: "How much does it cost for a 2-day trip?",
        answer: "Approximately 500,000-600,000 VND for 2 people. Day visit: 20,000 VND/person. Overnight: ~50,000 VND/group. Tent rental with basic bedding: 250,000 VND/2-3 person tent. Bring your own food for BBQ - much better value than buying on-site.",
      },
      {
        question: "What facilities are available?",
        answer: "Managed campsites have toilets, shower facilities, and tent rental (250,000 VND includes blanket, pillow, light). No electricity - bring a power bank. Phone signal is weak; Viettel has the best coverage. SUP rental available at 100,000 VND/hour.",
      },
      {
        question: "When are the best water conditions?",
        answer: "12:00-16:00 daily is when water is at its lowest and calmest - best for swimming and playing in the stream. Morning 6-9 AM the water is higher and faster. From 4 PM the dam releases and water rises rapidly. These times vary with season and weather - follow campsite manager guidance.",
      },
      {
        question: "How do I get there from Ho Chi Minh City?",
        answer: "4-5 hours by car or motorbike via Highway 55 through Tánh Linh district. Search Google Maps for 'khu cắm trại tự túc vườn điều' for the campsite cluster. Most of the road is paved; the last section is unpaved with rocks. High-clearance 4WD is most comfortable but standard cars can park at outer campsites.",
      },
    ],
    sentiment: {
      positive: "Praised for the clear rocky stream, the easy weekend accessibility from Saigon, the affordable camping setup, and the cold water on hot days. SUP on the stream is a popular highlight.",
      negative: "Dam release timing catches first-time visitors off guard - the most serious complaint. Midday heat is intense. Tent sleeping can be hot. Limited food options on-site.",
    },
  },
}
