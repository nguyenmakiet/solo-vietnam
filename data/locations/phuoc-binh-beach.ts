...
export const phuocBinhBeach: Location = {
  ...
  insights: {
    highlights: [
      "4km of largely empty coastline next to Phước Tĩnh fishing village - almost no tourist presence",
      "Early morning fishing activity - boats landing, catch being sorted, occasional direct seafood sales",
      "Oct-Nov: best conditions - cool, clear, quiet",
    ],
    thingsToKnow: {
      crowds: "Minimal tourist traffic year-round. One of the least-visited beaches in Bà Rịa - Vũng Tàu. Fishing community is the main presence.",
      difficulty: null,
      safety: "Avoid swimming May-June due to jellyfish. Water quality is not resort-standard - murky and affected by fishing village activity. Few locals swim here.",
      accessibility: "Free access. No facilities along most of the beach - bring everything. Easy by motorbike from Long Hải or Phước Tĩnh.",
      seasonal: "Oct-Nov: best overall - cool, clear, less rain. Nov-Apr dry season: calmer sea. May-Jun: jellyfish season, avoid swimming. Jul-Sep: rainy season.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Is Phước Bình Beach clean and safe for swimming?",
        answer: "Water quality is a genuine concern - murky seawater and the effects of nearby fishing activity mean conditions are not resort-standard. Few locals swim here. The beach is better visited for the scenery and atmosphere than for swimming. May and June bring jellyfish - avoid the water in this period.",
      },
      {
        question: "When is the best time to visit?",
        answer: "October and November - cool weather, clear blue skies, less rain, and the beach at its most pleasant. The November to April dry season gives calmer seas overall. Avoid May-June for jellyfish.",
      },
      {
        question: "What makes Phước Bình different from other nearby beaches?",
        answer: "It barely exists as a tourist destination - almost no search results, no tourist infrastructure, and a genuine fishing village next door. The 4km of largely empty shoreline with fishing boat activity in the morning is the experience. For anyone specifically seeking quiet and undeveloped coastline near Saigon, this is one of the most genuinely off-the-map options in the province.",
      },
    ],
    sentiment: {
      positive: "Visitors who seek it out appreciate the complete absence of tourist infrastructure, the fishing village atmosphere, and the long empty shoreline.",
      negative: "Poor water quality limits swimming appeal. No facilities. The beach is not maintained and shows fishing village wear. Not suitable as a primary beach destination.",
    },
  },
}
