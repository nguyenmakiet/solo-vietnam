...
export const bungBinhThienLake: Location = {
  ...
  tips: [
    "Visit at dawn - the lotus flowers are fully open in the morning light and close by midday; early morning also avoids the heat and gives the best photography conditions",
    "The lake is most impressive during flood season (Aug - Oct) when the water level rises and the lotus coverage is at maximum - dry season visits find a much smaller lake with reduced flower cover",
    "Hire a boat from the village at the lake edge - the boatmen navigate through the lotus channels and know where the densest flower coverage is on a given day",
    "The surrounding villages are predominantly Cham Muslim communities - the mosques, traditional dress, and boat-based lifestyle make the area culturally interesting beyond the lake itself",
    "Bưng Bình Thiên is 15km from Châu Đốc - combine with the Sam Mountain temples and the Châu Đốc floating villages for a full An Giang border district day",
  ],
  content: {
    intro:
