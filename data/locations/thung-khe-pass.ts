...
export const thungKhePass: Location = {
  ...
  gallery: [
    ...
    "thung-khe-pass-03_e3tqk3",
    "thung-khe-pass-01_ztarbj",
    "thung-khe-pass-04_rtxbdv",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "White limestone cliffs from road construction - look like snow from a distance, unlike any other pass in northern Vietnam",
      "Panoramic Mai Chau valley view from the flagpole viewpoint - one of the best unobstructed valley panoramas in Hòa Bình province",
      "Natural weather variety in a single day: clear morning, warm midday, misty afternoon, foggy evening",
    ],
    thingsToKnow: {
      crowds: "Popular rest stop on the Hanoi - Mai Chau route. Busiest on weekends and Vietnamese public holidays. The pass itself is always passable - the stalls get crowded, not the road.",
      difficulty: "Not technically demanding - no extremely tight hairpins or near-vertical sections. Moderate mountain pass with winding road. Heavy trucks use this road regularly; the main risk is visibility, not gradient.",
      safety: "Drive in daylight only - fog becomes dangerously thick in the evening. Avoid July-August rain season due to landslide risk on the mountain terrain. Stop only at wide roadside areas, not the road edge. Heavy trucks on blind curves are the most common hazard.",
      accessibility: "Free. Roadside stalls sell food and drinks. Basic toilet facilities available (small fee). 30-minute stop is typical.",
      seasonal: "Sep-Nov: golden rice season, clearest skies - best overall. Mar-May: spring clarity, green vegetation. Nov-Feb: white rock most dramatic against bare trees and cloud. Jul-Aug: heavy rain, landslide risk - avoid.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Is the white on Thung Khe Pass actually snow?",
        answer: "No - it's white limestone rock. When Highway 6 was blasted through the mountain during construction, pale limestone broke away and slid down the slopes, coating the hillsides in bright white rock. From a distance it genuinely resembles snow, especially in winter when combined with bare trees and low cloud.",
      },
      {
        question: "How long should I stop at Thung Khe Pass?",
        answer: "About 30 minutes is enough for most visitors - photographs at the viewpoint, a snack from the roadside stalls, and a look at the valley below. It's a great rest stop on the Hanoi - Mai Chau route rather than a standalone destination.",
      },
      {
        question: "Is Thung Khe Pass dangerous to drive?",
        answer: "It's not technically difficult compared to Ha Giang or Sa Pa passes. The main hazards are heavy trucks on blind curves and fog - which thickens significantly in the afternoon and evening. Drive in daylight, keep speed moderate, don't overtake on curves, and avoid the pass during and after heavy rain when landslide risk increases.",
      },
      {
        question: "What is the best time to visit?",
        answer: "Morning for clear views and least fog. September to November for golden rice season and clear skies. March to May for spring clarity. Avoid July and August - heavy rain season with landslide risk. Winter (November to February) gives the most dramatic white rock effect against bare trees.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the unexpected visual impact of the white limestone, the Mai Chau valley view, and the atmospheric weather changes. Motorbike riders frequently describe it as one of the most photogenic stops on the Hanoi - Mai Chau route.",
      negative: "Short stop with limited activities beyond photography and snacks. Fog and poor visibility frustrate visitors who arrive in the afternoon. Heavy truck traffic on the road.",
    },
  },
}
