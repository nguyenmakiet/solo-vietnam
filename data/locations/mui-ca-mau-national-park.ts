...
export const muiCaMauNationalPark: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775378916111!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRHF5OUQweUFF!2m2!1d8.606796898501917!2d104.720717073254!3f358.832191651729!4f5.555515162533581!5f0.7820865974627469" },
  heroImage: heroUrl("mui-ca-mau-national-park-2_fjvmkp"),
  gallery: [
    "ca-mau-national-park-6_fisd6z",
    "ca-mau-national-park-7_tiqdic",
    "mui-ca-mau-national-park-5_oprg79",
    "mui-ca-mau-national-park-4_b5qoep",
    "mui-ca-mau-national-park-2_fjvmkp",
    "mui-ca-mau-national-park-3_twamno",
    "ca-mau-national-park-13_jzmsd0",
    "ca-mau-national-park-8_mdhobk",
    "ca-mau-national-park-10_xodf31",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Vietnam's southernmost point marked by the GPS 0001 national coordinate monument - a place of deep symbolic significance for Vietnamese visitors",
      "The only location in Vietnam where you can watch both sunrise over the East Sea and sunset over the Gulf of Thailand from the same spot",
      "A living coastline: Mekong sediment deposits push the land 50-80 meters further south each year - the ship monument has already been relocated once",
    ],
    thingsToKnow: {
      crowds: "Day-trippers from Cà Mau city arrive mid-morning and clear out by early afternoon; staying overnight gives access to the sunrise boat tour and a quieter experience overall",
      difficulty: "Easy terrain - flat walking trails and boat tours; the main consideration is travel time (100km from Cà Mau city by road, or 2.5-3 hours by boat)",
      safety: "Respect the GPS 0001 monument - don't climb on or stand on the marker; bring sun protection for the open boat sections and the coastal monument area",
      accessibility: "Road access now fully available (bus from Cà Mau's Năm Căn station ~100,000 VND, or motorbike); boat access from Cà Mau city also available; basic guesthouses on-site; limited food options so bring snacks or budget for the park restaurant",
      seasonal: "Dry season Dec-Apr for best conditions; wet season May-Nov brings heavy rain and rougher coastal conditions but the mangrove forest is accessible year-round",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get from Cà Mau city to Đất Mũi?",
        answer: "Two options: by bus from Cà Mau's Năm Căn bus station (Trường Giang or Đen Mập services, ~100,000 VND, road now fully paved), or by speedboat through the mangrove canals (2.5-3 hours, more atmospheric). Road access has improved significantly in recent years - the boat-only era is over.",
      },
      {
        question: "What are the main landmarks at Đất Mũi?",
        answer: "Four key monuments cluster together: the GPS 0001 national coordinate marker (southernmost point of Vietnam's mainland), the Ho Chi Minh Road terminus marker, the Hanoi Flag Tower replica (inaugurated 2019, modeled on the Thăng Long Citadel original), and the ship monument on the coast - all within walking distance of each other.",
      },
      {
        question: "Why does the southernmost point keep moving?",
        answer: "The Mekong River deposits sediment that extends the Cà Mau coastline 50-80 meters further south every year. The ship monument was already relocated seaward in 2019 to reflect the advancing land. The GPS 0001 marker records the official registered coordinate rather than a fixed geographic point.",
      },
    ],
    sentiment: {
      positive: "Vietnamese visitors consistently describe Đất Mũi as an emotionally significant destination - standing at the end of the country carries weight that goes beyond sightseeing; foreign visitors are often surprised by how much the monument area conveys",
      negative: "Limited food options inside the park; the restaurant near the entrance is considered expensive relative to quality; ongoing infrastructure construction affects the aesthetic in some areas",
    },
  },
}
