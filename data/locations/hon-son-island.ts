...
export const honSonIsland: Location = {
  ...
  heroImage: heroUrl("hon-son-island-kien-giang_qwh3nr"),
  gallery: [
    "hon-son-island-kien-giang-5_l4e0lg",
    "hon-son-island-kien-giang-10_pv0h3t",
    "hon-son-island-kien-giang-9_jo5lkr",
    "hon-son-island-kien-giang-3_hcbln0",
    "hon-son-island-kien-giang-2_sbakvu",
    "hon-son-island-kien-giang-4_tefahv",
    "hon-son-island-kien-giang_qwh3nr",
    "hon-son-island-kien-giang-7_nllavc",
    "hon-son-island-kien-giang-11_uovkif",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Bãi Bàng - the island's signature beach with coconut palms leaning over white sand",
      "Turtle-shaped rock formation (Hòn Rùa) - recently repainted (2026); the viewpoint here looks down over sea on one side and a peaceful fishing village on the other - one of the most distinctive perspectives on the island",
      "Ma Thiên Lãnh peak trek with panoramic views over the Gulf of Thailand",
      "Bãi Bàng, Palm Beach, main pier, and Bãi Đá Chài - four distinct sunset viewing spots",
      "Calmer seas and shorter crossing (~1.5 hours) than Phú Quý - better for those prone to seasickness",
      "Lăng Ô Nam Hải, Bãi Xếp, Làng Chài - fishing community culture alongside beaches",
    ],
    thingsToKnow: {
      crowds: "Weekends fill up fast - ferry tickets and sea-view rooms both book out. Weekdays are noticeably quieter. Dry season Dec-Apr is peak.",
      difficulty: "Ma Thiên Lãnh trek is moderately demanding. Island roads are manageable by motorbike. Some beaches have rocky sections.",
      safety: "Carry CCCD or passport - ID checks can happen at the pier. Bring cash; ATM access unreliable. Occasional power cuts - bring a portable charger. July to September rough season: heavy rain and rough seas can suspend ferry services for 1-3 days - risk of being stranded on the island is real. Build contingency days if visiting outside dry season.",
      accessibility: "Motorbike rental at pier: 150,000-200,000 VND/day. Essential for covering the island - too large to explore on foot. Ferry from Rạch Giá departs 6:30 AM earliest, ~1.5 hour crossing.",
      seasonal: "Nov-May: dry season, calm seas, clear water - best for beaches and snorkeling. Jun-Oct: wet season, rough conditions, less reliable crossings.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Hòn Sơn from Ho Chi Minh City?",
        answer: "Take an 11 PM overnight bus from Saigon to Rạch Giá, arriving around 4 AM. Allow 30 minutes to transfer to the ferry pier. Earliest ferry departs 6:30 AM, crossing ~1.5 hours. Book ferry tickets online in advance - weekends sell out. The pier also serves Phú Quốc and Nam Du ferries.",
      },
      {
        question: "How long should I spend on Hòn Sơn?",
        answer: "Minimum 2 nights. Day 1: Ma Thiên Lãnh trek and viewpoint (1.5-2 hours), lunch at a floating seafood restaurant, afternoon beach, Bãi Bàng or cross-island road. Day 2: morning island circuit, turtle-shaped rock check-in, seaside café, Lăng Ô Nam Hải. Sunset spots both evenings: Bãi Bàng, Palm Beach, main pier, or Bãi Đá Chài.",
      },
      {
        question: "Is Hòn Sơn better than Phú Quý for avoiding seasickness?",
        answer: "Yes - Hòn Sơn has calmer seas and a shorter crossing (~1.5 hours vs 2.5-3.5 hours for Phú Quý). Significantly better for those prone to motion sickness.",
      },
      {
        question: "Where are the best sunset spots on Hòn Sơn?",
        answer: "Four good options: Bãi Bàng (beach setting), Palm Beach (has drinks available), the main pier (cầu cảng), and Bãi Đá Chài (rocky coastal setting).",
      },
      {
        question: "What should I bring to Hòn Sơn?",
        answer: "Cash (ATMs unreliable), CCCD or passport (ID checks at pier), portable charger (occasional power cuts), motion sickness medication if prone to seasickness (take 30 minutes before boarding). Book sea-view accommodation well in advance. When renting a motorbike, always lock your helmet securely - helmets left hanging outside are frequently stolen and you'll be charged for replacement.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the peaceful atmosphere, fresh affordable seafood, clear water, and the Ma Thiên Lãnh trek views. The calmer crossing compared to other Gulf islands gets positive mentions.",
      negative: "Sea-view rooms book out quickly. Some beaches have garbage accumulation. Occasional power cuts. Motorbike rental prices considered high by some visitors.",
    },
  },
}
