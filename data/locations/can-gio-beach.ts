...
export const canGioBeach: Location = {
  ...
  content: {
    ...
    travelTips:
      "Cần Giờ Beach works best as an immersive day-trip-from-HCMC experience rather than a destination beach. The value is in the combination: the ferry crossing, the mangrove drive, the dark-sand coastal town, the seafood lunch, and the optional boat tour into the reserve. You get a full day of sensory variety - water, forest, fishing community, city escape - without leaving the city. For foreign visitors who want to see what Saigonese actually do on weekends, Cần Giờ is more revealing than any tourist attraction in the city center.",
  },
  insights: {
    highlights: [
