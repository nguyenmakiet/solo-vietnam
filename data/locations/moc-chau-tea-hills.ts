...
export const mocChauTeaHills: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775829962714!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJRHFpNUxEU3c.!2m2!1d20.83160500736458!2d104.6938966790051!3f164.18538034126735!4f-20.158399262836284!5f0.7820865974627469" },
  ...
  insights: {
    highlights: [
      "Contoured rows of tea bushes across rolling hills - most photogenic at dawn when mist fills the valleys",
      "Mar-Apr new shoots: vivid lime green with dew on the leaves at 6-7 AM - the peak visual season",
      "Oct-Nov: combine green tea hills with plum blossom and ban flowers for multi-colour landscape photography",
      "Harvest season (May, Oct): watch pickers working the rows - the most active, lived-in version of the landscape",
    ],
    thingsToKnow: {
      crowds: "Weekdays quieter. Peak season Oct-Nov and Mar-Apr brings more visitors. Early morning (before 8 AM) is the least crowded and best light window regardless of season.",
      difficulty: null,
      safety: "Roads can be slippery in rain - July and August particularly. Avoid driving on plateau roads in heavy rain.",
      accessibility: "10km from Moc Chau town by motorbike. Most hills accessible from plateau roads. Some private plots have small gate fees - ask before entering.",
      seasonal: "Mar-Apr: new green shoots, best for tea photography. May and Oct: harvest season, most activity. Oct-Nov: combine with surrounding flower fields. Jul-Aug: heavy rain, slippery roads, avoid.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "When is the best time to visit the Moc Chau Tea Hills?",
        answer: "March to April for vivid new green shoots after the winter-spring harvest - lime green with dew at dawn. October to November to combine the tea hills with plum blossom and ban flowers in the surrounding landscape. Both windows have the right morning mist conditions. Avoid July-August heavy rain season.",
      },
      {
        question: "Is there an entrance fee?",
        answer: "Most tea hills are free to enter. Some privately owned plots charge a small gate fee - ask before entering. The hills are family-owned working plantations, not public parks.",
      },
      {
        question: "What time should I visit for the best photos?",
        answer: "6:00-7:00 AM for soft light and morning mist between the rows. 5:00-6:00 PM for warm afternoon light. Midday is flat and not worth it for photography. The smell of tea leaves in the cool morning mist is a sensory bonus that doesn't show up in photos.",
      },
      {
        question: "How do I get to the tea hills from Moc Chau town?",
        answer: "About 10km from town centre by motorbike. Rent in town (~150,000 VND/day) and self-navigate the plateau roads. The best views are often on side roads 2-5km off the main highway, not at the signposted tourist stops.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the dawn atmosphere, the smell of tea in the morning mist, and the photographic variety across seasons. Visitors appreciate the working-farm authenticity compared to more curated highland attractions.",
      negative: "Some visitors find it underwhelming outside the Mar-Apr and Oct-Nov windows. Midday visits with harsh light disappoint photographers. Increasingly popular on social media which has made some spots crowded on weekends.",
    },
  },
}
