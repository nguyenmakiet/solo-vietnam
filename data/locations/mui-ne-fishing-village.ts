...
export const muiNeFishingVillage: Location = {
  ...
  gallery: [
    ...
    "fishing-village-mui-ne-phan-thiet4_apkfnf",
    "fishing-village-mui-ne-phan-thiet6_y8hq4b",
    "fishing-village-mui-ne-phan-thiet5_uhyrzb",
    "fishing-village-mui-ne-phan-thiet2_xaa5bh",
    "fishing-village-mui-ne-phan-thiet7_ziasjo",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Hundreds of round basket boats (thuyền thúng) moored in the bay - one of the most photographed scenes on Vietnam's south coast",
      "Morning fish market 5:00-8:00 AM - real commerce between fishermen and buyers, not a tourist performance",
      "Cinematic wide view from distance: rows of basket boats layered with larger fishing vessels across the full bay",
    ],
    thingsToKnow: {
      crowds: "Most active and atmospheric 5:00-8:00 AM when the night boats return and the market runs. Quieter but still worth visiting outside these hours.",
      difficulty: null,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Buy only visibly fresh seafood - live or recently caught. Inspect before purchasing and bring cash as stalls don't accept cards. Prices at the market are significantly lower than at nearby restaurants.",
      },
      {
        question: "What should I expect from the experience?",
        answer: "A working fishing harbour, not a tourist attraction. Expect intense sun, sea wind, and the strong smell of fresh seafood - the combination is overwhelming at first but memorable. The wide view of hundreds of basket boats layered across the bay is genuinely cinematic. Respectful photography is generally fine; ask before photographing individuals up close.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the authentic atmosphere, the visual spectacle of the basket boats, and the early morning market energy. The sensory intensity - sun, wind, smell - is frequently cited as what makes it memorable.",
      negative: "Significant rubbish from fish market and processing activity on the shore - shells, packaging, fishing waste. Inside market stalls are difficult to navigate without Vietnamese and price negotiation skills. Soho Café view is popular but crowded on weekends.",
    },
  },
}
