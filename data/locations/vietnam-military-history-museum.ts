...
export const vietnamMilitaryHistoryMuseum: Location = {
  ...
  type: ["museum", "history"],
  categories: [],
  experiences: ["history", "photography", "culture"],
  ...
  heroImage: heroUrl("vietnam-military-history-museum_zyaykl"),
  gallery: [
    "vietnam-military-history-museum_zyaykl",
    "vietnam-military-history-museum-5_ksjjk5",
    "vietnam-military-history-museum-2_ofseec",
    "vietnam-military-history-museum-3_yzvjhb",
    "vietnam-military-history-museum-4_tlaj9d",
    "vietnam-military-history-museum-8_scjcrw",
    "vietnam-military-history-museum-7_qblhnf",
    "vietnam-military-history-museum-6_ontvz5",
    "vietnam-military-history-museum-9_dgjmdp",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Massive new complex covering nearly 400,000 square meters opened November 2024",
      "Outdoor displays of B-52 wreckage, tanks, aircraft, and artillery from multiple wars",
      "Chronological galleries spanning Vietnamese military history from ancient dynasties to modern conflicts",
      "One of Vietnam's seven national museums and the most comprehensive military history collection in the country",
    ],
    thingsToKnow: {
      crowds: "Very popular since the new opening. Weekends can see up to 40,000 visitors per day. Weekday mornings are significantly quieter.",
      difficulty: "Easy. Flat grounds, well-maintained pathways. Suitable for all ages and fitness levels.",
      safety: "Safe, well-maintained national museum. Standard museum rules apply - no touching exhibits.",
      accessibility: "Large modern complex with accessible pathways. GrabBike or taxi recommended from city center.",
      seasonal: "Open year-round. Indoor galleries provide shade and air conditioning during Hanoi's hot summers.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Has the museum moved?",
        answer: "Yes. The old museum at 28A Dien Bien Phu Street, Ba Dinh permanently closed in September 2024. The new museum opened November 1, 2024 at Km6+500 Thang Long Boulevard, Nam Tu Liem District.",
      },
      {
        question: "What are the opening hours?",
        answer: "8:00 AM to 11:30 AM and 1:00 PM to 4:30 PM. Closed Mondays and Fridays.",
      },
      {
        question: "How much does it cost?",
        answer: "40,000 VND per person from April 12, 2025. Free for under 16, over 80, and war veterans. 50% discount for seniors 60+ with valid ID and students.",
      },
      {
        question: "How long does a visit take?",
        answer: "Allow at least 2 hours for a general visit. The new complex is nearly 400,000 square meters - history enthusiasts may want 3-4 hours.",
      },
    ],
    sentiment: {
      positive: "Visitors consistently praise the scale and quality of the new museum, the outdoor military equipment displays, and the comprehensive coverage of Vietnamese military history. The B-52 wreckage and aircraft displays are frequently highlighted.",
      negative: "The new location is further from the city center than the old museum, which surprises some visitors. Weekend crowds can make the experience feel rushed.",
    },
  },
}
