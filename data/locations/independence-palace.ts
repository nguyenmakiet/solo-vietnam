...
export const independencePalace: Location = {
  ...
  tips: [
    ...
    "The two tanks on the front lawn are reproductions - Tank 390 (which crashed through the main gate on April 30, 1975) is displayed at the Armored Forces Museum in Hanoi, while Tank 843 (which hit the side gate) is at the Vietnam Military History Museum",
