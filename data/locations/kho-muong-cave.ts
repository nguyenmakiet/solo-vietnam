...
export const khoMuongCave: Location = {
  ...
  bestTime: "Year-round; dry season (Nov - Apr) easiest underfoot. Afternoon for best photography.",
  bestMonths: [11, 12, 1, 2, 3, 4],
  entranceFee: "10,000 VND (parking included)",
  ...
  insights: {
    highlights: [
      "20-metre arch entrance dropping into a 2.5km cave system formed 250 million years ago - one of the most distinctive caves in the Pù Luông reserve core",
      "Self-guided descent on stone steps then bare rock - no infrastructure, no lighting, no guardrails below the halfway point",
      "Inner chamber at the bottom with the sound of running water and a passage that continues beyond the obvious dead-end",
    ],
    thingsToKnow: {
      crowds: "Very few visitors - this is off the main Pù Luông circuit and most travellers don't make the detour. You may have the cave entirely to yourself.",
      difficulty: "Moderate. Steps for the first third, bare rock after. Some sections damp and slippery. No rope or harness required but confident footing needed. Not suitable for sandals or flip flops.",
      safety: "Bring a proper flashlight - a phone torch is not sufficient for the lower sections. The rock is slippery in places. Tell someone where you're going before descending alone.",
      accessibility: "Not accessible for limited mobility - uneven rock descent with no handrails below the steps.",
      seasonal: "Accessible year-round. Dry season (Nov-Apr) is easier underfoot. Some lower sections may have seasonal water after heavy rain.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is this cave safe to visit alone?", answer: "It's possible but not ideal. The lower sections are dark, the rock is slippery in places, and there's no infrastructure or staff below the entrance steps. Going with at least one other person is strongly recommended. Bring a proper flashlight, wear shoes with grip, and tell someone where you're going." },
      { question: "Will I actually see bats?", answer: "Maybe. The cave is named Bat Cave and has an active colony in the upper roof, but mid-day visits often pass under a quiet roost without spotting any. Dawn and dusk give better chances of seeing the colony active." },
      { question: "How do I get there?", answer: "Kho Muong Village is reached via the steepest road in the Pù Luông reserve. Rent a manual (số) motorbike for 150,000 VND/day - automatics struggle on the gradient. Alternatively, hire a driver for around 400,000 VND/day. Entrance and parking at the cave is 10,000 VND." },
    ],
    sentiment: {
      positive: "Consistently praised by visitors who come prepared - the raw, unlit cave with a dramatic entrance arch and dark lower chambers is a genuinely different experience from developed show caves. The lack of infrastructure is the point.",
      negative: "Visitors who arrive with only phone torches or sandals have a poor experience and often turn back early. The steep access road is a barrier for some riders. Bats often not visible during daytime visits despite the name.",
    },
  },
}
