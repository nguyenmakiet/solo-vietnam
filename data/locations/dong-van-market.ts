...
export const dongVanMarket: Location = {
  ...
  tags: ["🛍️ Sunday Market", "🏔️ Karst Plateau", "🎎 Ethnic Minority", "📷 Photography"],
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1779290741521!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQ0JuNFRoLVFF!2m2!1d23.27707417844365!2d105.361235071521!3f6.271338387783817!4f-19.585984878107368!5f2.024745473904189", },
  heroImage: heroUrl("dong-van-market-ha-giang_wr2fga"),
  gallery: [
    "dong-van-market-ha-giang-1_f3phko",
    "dong-van-market-ha-giang-2_jcprkl",
    "dong-van-market-ha-giang-3_aoc6fr",
    "dong-van-market-ha-giang-4_ixvuyw",
    "dong-van-market-ha-giang-5_wzocl6",
    "dong-van-market-ha-giang-6_svcqzs",
    "dong-van-market-ha-giang-7_v9ey9y",
    "dong-van-market-ha-giang-8_zysfvq",
    "dong-van-market-ha-giang-9_wsenht",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "H'Mông, Tày, Nùng, and Lô Lô communities in traditional dress - the market doubles as a social gathering where young people meet and couples find each other",
      "Thắng cố (horse meat stew) and mèn mén (steamed corn cake) - H'Mông dishes specific to the Đồng Văn plateau",
      "Livestock section and side streets beyond the central hall are the most interesting parts",
    ],
    thingsToKnow: {
      crowds: "Sunday mornings are busy with both locals and Ha Giang Loop riders. Arrive before 9 AM for the most authentic atmosphere before tour groups arrive.",
      difficulty: "Flat walking through a town centre market - no physical difficulty.",
      safety: null,
      accessibility: "Town centre, flat and accessible on foot. Bring cash - no card or QR payment accepted.",
      seasonal: "Runs year-round. Oct-Mar is the richest atmosphere when highland communities are less busy with farming. Oct-Nov adds buckwheat flowers across the surrounding plateau.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Where exactly is the Sunday market - in the old quarter or somewhere else?",
        answer: "The Sunday market is in the new covered market building in Đồng Văn town centre - not in the French colonial stone market hall in the old quarter. The old hall is a few hundred metres away and now functions mainly as a cultural space and cafe area. Ask locals or your homestay host to point you toward the new market building.",
      },
      {
        question: "Does the market only happen on Sundays?",
        answer: "The full market with ethnic minority vendors from surrounding villages happens on Sundays. A smaller daily market operates in the covered hall on other days but is much less atmospheric and primarily serves local town residents. There is also a periodic market following the lunar calendar (days 1, 6, 11, 16, 21, and 26) - check if one falls during your visit.",
      },
      {
        question: "What is thắng cố and is it safe to eat?",
        answer: "Thắng cố is a traditional H'Mông stew made from horse meat and offal, cooked in a large communal pot. Safe to eat, but manage expectations - the original version is quite plain, a dish born from scarcity rather than flavour complexity. Some vendors adjust it for outside visitors. Mèn mén (steamed corn cake) is similarly plain - dry and starchy. Both are worth trying once for the cultural experience.",
      },
      {
        question: "Is Đồng Văn Market worth planning your Ha Giang Loop around?",
        answer: "Yes - if you can only choose one market on the entire Ha Giang Loop, make it Đồng Văn on a Sunday. The combination of ethnic minority communities from surrounding villages, the livestock trading, thắng cố and mèn mén, and the karst plateau setting is unlike any other market in the north. Arrive before 9 AM and give it at least 2 hours.",
      },
      {
        question: "Is the market touristy or still genuine?",
        answer: "More visited than it was five years ago, but still genuinely working. The livestock section and side streets retain the most authentic atmosphere - ethnic minority families trading animals and produce with each other, not performing for cameras. The central hall is busier with tourists. Some vendors are accustomed to visitors and will approach you; others are there purely to do business and will ignore you entirely.",
      },
      {
        question: "Can I buy good souvenirs here?",
        answer: "Yes - better quality than most tourist markets. Look for hand-embroidered H'Mông fabric, woven textiles, dried medicinal herbs, and local plateau honey. Prices are lower than in Hà Giang city. Avoid buying live animals unless you have a specific plan for them.",
      },
    ],
    sentiment: {
      positive: "Consistently rated as a Ha Giang Loop highlight - the ethnic minority atmosphere, the food, and the setting are unlike anything elsewhere in Vietnam.",
      negative: "More visited in recent years and some vendors are accustomed to tourists. Most authentic interactions tend to be in the livestock section and side streets rather than the central hall.",
    },
  },
}
