...
export const yTy: Location = {
  ...
  insights: {
    highlights: [
      "Sea of clouds pooling in the valleys - best Oct to Dec, most reliable after rain or cold nights (5:30-7 AM at Ngải Thầu Thượng or Choản Thèn)",
      "Ngải Thầu Thượng - one of the best viewpoints in northern Vietnam for watching clouds spill through the valleys below",
      "Choản Thèn - the other iconic cloud-hunting spot, equally famous in the Vietnamese photography community",
      "Thác Rồng (Dragon Waterfall) - waterfall trekking and SUP, must-visit",
      "Thung lũng The Pa - arguably the most beautiful rice terrace valley in Y Tý",
      "A Lù - one of the least-touched villages, Hà Nhì and H'Mông communities with minimal tourism impact",
      "Mốc 92 Lũng Pô - where two rivers merge to form the Red River entering Vietnam",
      "Golden rice terraces late July to September; mùa nước đổ (flooded mirror terraces) May to June",
      "Hà Nhì village life - trình tường earthen houses, Saturday market, traditional dress still in daily use",
      "Trekking peaks: Lảo Thẩn (2,860m), Ky Quan San, Nhìu Cồ San, Ngũ Chỉ Sơn",
      "Snow possible December to February - one of the few realistic snow destinations in Vietnam",
      "Milky Way photography on clear nights",
    ],
    thingsToKnow: {
      crowds: "One of the least-touristy highland destinations in northern Vietnam. Weekend and holiday periods bring more Vietnamese visitors but never the Sa Pa crowds. Permit requirement keeps foreign visitor numbers naturally low.",
      difficulty: "Village walking and valley exploration: easy. Thác Rồng trek: moderate. Peak treks (Lảo Thẩn, Ky Quan San): challenging, 2-day commitment with guide required.",
      safety: "Road now fully paved and upgraded. Slippery in rain - take care on descents, avoid driving at night or in thick fog. Foreign overnight permit required and enforced - check with your accommodation about current procedures. Cold year-round at altitude - pack warm layers. Winter below 0°C possible. Do not photograph local people without permission.",
      accessibility: "No direct bus from Hanoi. Lào Cai to Y Tý: Hiệp Linh minibus (~120,000 VND, ~3 hours) or motorbike rental. From Sa Pa: ~80km, 3-4 hours. Some homestays offer Hanoi transfer packages.",
      seasonal: "Late Jul - Sep: golden rice terraces, temperature 15-25°C, best overall. Oct - Dec: cloud hunting peak, temperatures drop to 5-8°C at night by late Dec. Jan - Feb: coldest, snow possible, below 0°C. May - Jun: mùa nước đổ, flooded terraces reflect sky like mirrors. Mar - Apr: transitional, quieter.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Y Tý from Hanoi?",
        answer: "No direct bus. Take overnight train or sleeper bus to Lào Cai city, then either rent a motorbike or take the Hiệp Linh minibus to Y Tý (~120,000 VND, ~3 hours). From Sa Pa, it's about 80km - 3-4 hours by motorbike. Some homestays offer Hanoi-Y Tý transfer packages (depart 6 PM, arrive ~2 AM).",
      },
      {
        question: "Do foreigners need a permit for Y Tý?",
        answer: "Yes - Y Tý is a border commune and foreign overnight visitors require a permit. Requirements and fees can change; check with your homestay or hotel before arriving as they handle this regularly and can guide you through the current process. Don't leave this until you arrive.",
      },
      {
        question: "When is the best time to visit Y Tý?",
        answer: "Two distinct windows: late July to September for golden rice terraces; October to February for cloud hunting season (most reliable sea of clouds). December to February is coldest with possible snow - rare but Y Tý is one of the few realistic snow destinations in Vietnam. Weather is unpredictable - flexible dates significantly improve your experience.",
      },
      {
        question: "What is the Saturday market like?",
        answer: "Y Tý's weekly market runs Saturday mornings in the commune centre - Hà Nhì, Mông, and Dao communities come down from surrounding villages to trade. One of the most authentic highland markets in the Lào Cai border region. Arrive early - it disperses by noon.",
      },
      {
        question: "What peaks can I trek from Y Tý?",
        answer: "Four major peaks are accessible: Lảo Thẩn (2,860m, 2-day trek), Ky Quan San, Nhìu Cồ San, and Ngũ Chỉ Sơn. All require a local guide - arrange through your homestay or Sa Pa operators. The Lảo Thẩn route involves 5-6 hours of hiking to a mountain hut, then an early push to the summit for sunrise.",
      },
    ],
    sentiment: {
      positive: "Overwhelmingly praised for dramatic cloud scenery, authentic Hà Nhì culture, Thác Rồng, and the rare combination of rice terraces and sea of clouds. The undeveloped, unhurried atmosphere is consistently cited as the main draw compared to Sa Pa.",
      negative: "Weather-dependent - visits without good cloud conditions can feel underwhelming. Remote access with no direct transport. Permit process adds friction for foreign visitors. Cold and harsh in deep winter.",
    },
  },
}
