...
export const marbleMountains: Location = {
  ...
  insights: {
    highlights: [
      "Huyền Không Cave morning sunbeams - sunlight falls through the collapsed ceiling onto Buddhist altars below between 9-11 AM on clear days",
      "5 mountains named after the 5 classical elements - one of the most historically layered sites in central Vietnam, spanning Cham, Buddhist, and Nguyễn dynasty history",
      "Âm Phủ Cave (separate ticket) - a descent into a cave carved with vivid Buddhist depictions of heaven, purgatory, and hell",
    ],
    thingsToKnow: {
      crowds: "Busy year-round as a major stop between Da Nang and Hoi An. Arrive before 9 AM on weekdays for the quietest experience and best cave light.",
      difficulty: "Moderate - significant stair climbing on uneven marble and stone surfaces. The elevator bypasses the main climb but stairs are still required in the upper sections.",
      safety: "Marble and stone surfaces are very slippery when wet. Wear shoes with grip. Some cave passages are narrow and low.",
      accessibility: "Elevator available for the main ascent (15,000 VND one-way). Upper cave sections and stairs are not wheelchair accessible.",
      seasonal: "Open year-round. Sunbeam effect in Huyen Khong Cave is best on clear mornings Feb-Aug. Rainy season (Sep-Nov) brings slippery surfaces.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Do I need a separate ticket for each cave?",
        answer: "The 40,000 VND ticket covers access to Thuy Son mountain and the caves within it (including Huyen Khong). Am Phu Cave at the base requires a separate 20,000 VND ticket. The two are treated as distinct sites. The elevator is a further 15,000 VND one-way if you choose to use it.",
      },
      {
        question: "Is Ngũ Hành Sơn worth visiting if I have limited time in Đà Nẵng?",
        answer: "Yes - it is one of the most concentrated sites in central Vietnam for history, architecture, and natural scenery in a 2-3 hour visit. It is particularly worthwhile if travelling between Da Nang and Hoi An, as the location makes it a natural stop rather than a detour.",
      },
      {
    ...
    sentiment: {
      positive: "The Huyen Khong Cave morning light is consistently described as one of the most memorable visual experiences in Vietnam. The combination of caves, pagodas, and war history layers impresses visitors who expect a simple tourist attraction.",
      negative: "Can be very crowded with tour groups from both Da Nang and Hoi An. The marble surfaces are genuinely slippery and some visitors find the climb more physical than expected. Some caves are very dark without a torch.",
    },
  },
}
