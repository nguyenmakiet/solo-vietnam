...
export const phongNhaCave: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775833709671!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRDRpb3pxM1FF!2m2!1d17.57988653826994!2d106.2819807699849!3f138.96369007313479!4f-1.841080357549302!5f0.7820865974627469", },
  ...
  insights: {
    highlights: [
      "30-minute boat ride up the turquoise Son River through jungle and karst before entering the cave mouth directly from the water",
      "Hand-rowed boat through 1km of cave chambers in near-silence - stalactite formations reflected in the underground river below",
      "The atmospheric counterpart to Paradise Cave - intimate and poetic where Paradise Cave is grand and overwhelming",
    ],
    thingsToKnow: {
      crowds: "Multiple boats enter the cave simultaneously during peak hours. Morning departures are quieter. The cave itself absorbs the boats well - it doesn't feel as crowded as outdoor attractions.",
      difficulty: "Easy boat section. Walking section inside Tien Son Cave involves uneven rock and light climbing - wear proper footwear. Suitable for most ages and fitness levels.",
      safety: "Life jackets mandatory throughout - cannot be removed on the boat. Cave is cool to cold inside - bring a light layer.",
      accessibility: "Boat is accessible with staff assistance. Walking section inside has uneven terrain - limited wheelchair accessibility.",
      seasonal: "Best Mar-Aug. Sep-Nov: heavy rainfall raises water levels and can prevent boat entry into the cave - check before visiting. Cave may close entirely during flood season.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How much does it cost and how does the boat pricing work?",
        answer: "The boat costs 700,000 VND per boat for up to 12 people - the cost is shared among whoever is in the group. Solo travellers and couples can ask at the dock to be grouped with other visitors to split the cost. Cave entry tickets are purchased separately at the visitor centre.",
      },
      {
        question: "What is the difference between Phong Nha Cave and Paradise Cave?",
        answer: "Phong Nha has an underground river - you enter by boat and the experience is intimate, cool, and atmospheric. Paradise Cave is a dry cave, much longer, and visually more overwhelming - cathedral-scale chambers with massive formations. They are genuinely different experiences and worth doing both if time allows.",
      },
      {
        question: "Can I visit during the rainy season?",
        answer: "The cave may close temporarily September to November depending on flood severity each year - conditions vary and should be checked before planning a visit in this window.",
      },
    ],
    sentiment: {
      positive: "The boat approach along the Son River and the hand-rowed section inside the cave are consistently described as the most atmospheric cave experiences in Quảng Bình. Visitors frequently contrast the intimacy of Phong Nha favourably with the scale of Paradise Cave.",
      negative: "Multiple boats inside the cave simultaneously can break the atmosphere. The cave is shorter and less visually dramatic than Paradise Cave - visitors expecting similar scale may be underwhelmed.",
    },
  },
}
