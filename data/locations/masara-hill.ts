...
export const masaraHill: Location = {
  ...
  content: {
    ...
    travelTips:
      "Masara is best approached as part of the Tà Năng-Phan Dũng trekking corridor or as a standalone side trip from Đà Lạt. For the Tà Năng trek, the hill is a natural add-on at the Lâm Đồng end of the route. For Đà Lạt visitors, it represents the kind of landscape - open, high, windswept grassland - that the Đà Lạt plateau used to have more of before development enclosed it. The pink grass season window is real and narrow. If you're planning the trip specifically for the color, check conditions in the week before traveling - early season (early November) and late season (after mid-December) are significantly less impressive than peak.",
  },
  insights: {
    highlights: [
