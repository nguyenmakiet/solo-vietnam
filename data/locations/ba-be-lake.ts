...
export const baBeLake: Location = {
  ...
  insights: {
    highlights: [
      "Three connected lakes (Pé Lèng, Pé Lù, Pé Lầm) - 8km long, 20-25m deep, Ramsar Wetland since 2011",
      "Động Puông: 300m limestone cave through which the river flows, 30m+ ceiling, large bat colony",
      "Đảo Bà Góa (Widow Island) and Đền An Mã temple - the iconic Ba Be photo spots",
      "Bản Pác Ngòi Tày village homestay - 80+ stilt houses on the lakeshore, traditional dugout canoe rides",
      "Tày legend origin story: the lake formed when the earth swallowed a village that failed a fairy's test of compassion",
    ],
    thingsToKnow: {
      crowds: "Generally quiet. Busier Mar-May and Sep-Nov peak seasons, especially weekends. Bản Pác Ngòi homestays fill during festivals.",
      difficulty: "Easy - all main sights accessible by boat. Forest trails and cave entries are moderate. 230km from Hanoi on winding mountain roads.",
      safety: "Life jacket mandatory on all boats - always provided. Lake is deep (up to 35m) - stay in the boat unless at designated spots. Cool temperatures year-round; cold Dec-Feb.",
      accessibility: "Boat hire from two piers. Motorboat 500,000 VND/boat (10-12 people). Kayak/SUP 1,200,000-1,500,000 VND (3 boats, max 6 people). Traditional dugout canoe available. Tours 1-5 hours.",
      seasonal: "Mar-May: best weather, spring green, Lồng Tồng festival. Sep-Nov: clear post-rain skies, calm water. Dec-Feb: cold (0°C possible), frost, cold boat rides. Jul-Aug: peak rain, murkier water.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "What does 'Ba Be' mean and what are the three lakes?",
        answer: "Ba Be means 'three lakes' in Vietnamese. The three connected bodies of water are Pé Lèng, Pé Lù, and Pé Lầm - collectively called Slam Pé in the Tày language. They are interconnected and form a single navigable system stretching about 8km through a karst valley.",
      },
      {
        question: "How long should I spend at Ba Be?",
        answer: "Minimum 2 nights. The main boat circuit (Puong Cave, Dau Dang Waterfall, Widow Island) takes 3-5 hours. A second day allows early morning paddling, forest walks, and village exploration. One overnight from Hanoi means more time in transit than at the lake.",
      },
      {
        question: "What are the boat options and costs?",
        answer: "Motorboat: 500,000 VND per boat for 10-12 people. Kayak or SUP: 1,200,000-1,500,000 VND for 3 boats (max 6 people) per day. Traditional dugout canoe (thuyền độc mộc): carved from a single tree, holds 2-3 people, the most culturally distinctive option. Life jacket included and mandatory. Tour circuits range from 1 hour (shortest) to 5 hours (full circuit).",
      },
      {
        question: "What is the Tày legend about Ba Be Lake?",
        answer: "According to Tày oral tradition, the lake formed when the earth swallowed a village whose people had been cruel to an old beggar woman at a festival - who was actually a fairy testing their character. Only two mothers and their children who had shown kindness were warned and escaped. The rest were swallowed as water rose from the ground and filled the valley. The three sections of the lake reflect the three parts of the flooded area.",
      },
      {
        question: "When is the best time to visit Ba Be?",
        answer: "March to May: mild temperatures (25-30°C), spring green, and the Lồng Tồng festival in early spring (9th-10th of the 1st lunar month) with boat racing and traditional games. September to November: clear skies after the rains, vivid green forest, calm water. Avoid December to February if sensitive to cold - temperatures can drop to 0°C and frost is possible.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the genuine quiet, the Tày homestay experience, the Puong Cave boat-through, and the early morning lake atmosphere. Visitors who stay two nights rate it significantly higher than day trippers.",
      negative: "Some find Dau Dang Waterfall underwhelming relative to the journey. Solo travel costs are higher (boats priced per vessel). Cold months make boat rides uncomfortable.",
    },
  },
}
