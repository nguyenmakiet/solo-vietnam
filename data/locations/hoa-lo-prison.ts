...
export const hoaLoPrison: Location = {
  ...
  insights: {
    highlights: [
      "Original French colonial guillotine used for executing Vietnamese political prisoners - on display",
    ...
    thingsToKnow: {
      crowds: "Moderate; busy with domestic tourists and school groups in the morning. Not overcrowded by Hanoi standards.",
      difficulty: "Flat site, no physical difficulty. Interior is air-conditioned.",
      safety: "Centrally located in Hoàn Kiếm district. Safe at all hours.",
      accessibility: "Main exhibits are ground-floor accessible; some underground sections have steps.",
      seasonal: "Open year-round. Oct-Apr more comfortable for the short outdoor sections between buildings.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "How long does a visit take?", answer: "1.5 to 2 hours with the audio guide, which is recommended. Without it, 60-90 minutes. Last entry is 4:30 PM - arrive before 3:00 PM to have enough time." },
      { question: "Is the audio guide worth renting?", answer: "Yes. It costs 50,000 VND on top of the 50,000 VND entrance fee. The English signage covers the facts; the audio guide adds the context and detail that makes the difference, particularly for the French colonial section which is less familiar to most international visitors." },
      { question: "Who was John McCain and why is he associated with Hoa Lo?", answer: "John McCain was a US Navy pilot shot down over Hanoi in 1967 and held as a POW at Hoa Lo for over five years. He later became a US Senator and presidential candidate. His flight suit is displayed in the museum. The American POW section presents events from the North Vietnamese government's perspective - former POW memoirs offer a different account of conditions there." },
    ],
    sentiment: {
      positive: "The French colonial section is frequently cited as unexpectedly moving - the physical preservation of cell blocks and the guillotine give the history immediate weight. Overall rated as one of the better history museums in Hanoi.",
      negative: "Some international visitors find the American POW section's framing one-sided. The museum is smaller than expected given its historical significance. Only three gallery images currently available.",
    },
  },
}
