...
export const muiDien: Location = {
  ...
  tags: ["🏮 Lighthouse", "🌅 First Sunrise", "🌊 Easternmost Cape"],
  ...
  gallery: [
    ...
    "mui-dien-phu-yen-4_prkdsc",
    "mui-dien-phu-yen-8_siwa3l",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "One of the first places on mainland Vietnam to witness sunrise - traditionally regarded as the easternmost cape, now officially second to Mũi Đôi in Khánh Hòa",
      "Historic lighthouse built by the French atop a 110m headland with panoramic views of the East Sea in both directions",
      "Scenic coastal road with mountains on one side and the sea on the other - worth the ride alone",
    ],
    thingsToKnow: {
      crowds: null,
      difficulty: "Walk of about 1.5km uphill to the lighthouse with some steep sections. Motorbike taxi available at base (~50,000 VND/trip). Rocky cliff areas near viewpoints require care.",
      safety: "Hot and exposed with no shade on the upper sections - hat and sunscreen essential. Watch footing near cliff edges when photographing. The path can be slippery after rain.",
      accessibility: "Motorbike to the base, then 1.5km walk uphill to the lighthouse. Motorbike taxi available for ~50,000 VND per trip. Lighthouse open 7:30-11:30 and 13:30-17:00 - closed midday.",
      seasonal: "Jan-Aug dry season gives the clearest conditions. Best light: early morning for sunrise and the first hour after. Afternoon for sunset from the cape.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is Mũi Điện really the easternmost point of Vietnam?", answer: "Traditionally yes - it has long been described as the easternmost point of mainland Vietnam. Modern geographic surveys now place that title at Mũi Đôi in Khánh Hòa. What Mũi Điện offers is the most accessible eastern cape in the country - fully reachable by road, with a working lighthouse and a beach below." },
      { question: "What is the entrance fee?", answer: "30,000 VND per adult. Parking fee applies separately." },
      { question: "How do I reach the lighthouse?", answer: "Walk the 1.5km uphill path from the gate - about 20-30 minutes with some steep sections. Motorbike taxis are available at the base for around 50,000 VND per trip. Wear proper shoes - rocky sections near the cliff viewpoints require grip." },
      { question: "When is the best time to visit?", answer: "April to September for the best weather - warm, sunny, with sea breeze. For sunrise, leave Tuy Hòa city by 4 AM. Note the lighthouse has a midday closure: open 7:30-11:30 AM and 13:30-17:00 PM." },
    ],
    sentiment: {
      positive: "Visitors consistently praise the dramatic coastal scenery, the historic lighthouse, and the combination of cliff-top views and the hidden Bãi Môn beach below. The sunrise experience gets strong mentions.",
      negative: "The uphill walk in midday heat is tiring. The descent to Bãi Môn is steep and requires care after rain.",
    },
  },
}
