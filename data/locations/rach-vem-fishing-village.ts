...
export const rachVemFishingVillage: Location = {
  ...
  name: "Rạch Vẹm Fishing Village & Starfish Beach",
  ...
  openingHours: "Open daily - best visited in the morning",
  ...
  tips: [
    ...
    "Go in the morning - less crowded, better light for photography, and the typical pattern is beach in the morning then lunch at the floating restaurants on the way back",
  ...
  insights: {
    highlights: [
      "Starfish Beach - shallow clear water with large red sea stars visible without snorkeling, accessible by 100,000 VND speedboat or coastal walk",
      "Traditional wooden stilt-house fishing village built over the sea - one of the last intact examples on Phú Quốc, under redevelopment pressure as of 2026",
      "Floating restaurant lunch - gỏi cá trích and cơm chiên ghẹ at local prices after the beach visit",
    ],
    thingsToKnow: {
      crowds: "Mornings are significantly quieter. The typical tourist pattern is arriving late morning, so an early start is rewarded.",
      difficulty: "Easy flat beach with gradual slope. The dirt access road requires care on motorbike in wet conditions.",
      safety: "No lifeguards. Water is shallow and calm in the dry season. Negotiate boat prices before boarding - 100,000 VND/person return is the standard rate.",
      accessibility: "No toilets, showers, or changing facilities at the beach as of 2026. Beach chair rental available (50,000 VND). The dirt road approach is rough.",
      seasonal: "Best Nov-Apr (dry season, calm water, best starfish visibility). May-Oct brings rougher conditions and lower visibility.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Do I need to take the boat or can I walk to Starfish Beach?",
        answer: "Both options work. The speedboat from the village costs 100,000 VND/person return and is the faster option. Alternatively, ride your motorbike past the village directly to Starfish Beach and walk along the shoreline - this is recommended for independent travelers and avoids the boat negotiation entirely.",
      },
      {
        question: "Is the village worth visiting or just the beach?",
        answer: "Both are worth the time. The stilt-house fishing village is one of the few remaining authentic fishing communities on Phú Quốc and is under rezoning pressure as of 2026 - it may look very different in a few years. The floating restaurants are also a reason to linger beyond the beach visit.",
      },
      {
        question: "Are there any facilities at the beach?",
        answer: "As of 2026, no - no toilets, no showers, no changing rooms. Beach chairs are available to rent (50,000 VND each). Bring everything you need from Dương Đông before making the trip north.",
      },
    ],
    sentiment: {
      positive: "Visitors consistently praise the authentic village atmosphere, the starfish viewing experience, and the fresh seafood at the floating restaurants. The unspoiled character of the northern coast is frequently highlighted.",
      negative: "No facilities at the beach (no toilets, showers, or changing rooms). Some litter on the beach. Boat pricing scams reported - always agree on the rate before boarding. The dirt access road is rough.",
    },
  },
}
