...
export const saigonCentralPostOffice: Location = {
  ...
  tags: ["🏛️ French Colonial Landmark", "📮 Working Post Office", "🏙️ French Colonial", "📸 Architecture"],
  ...
  insights: {
    ...
    faq: [
      ...
      { question: "Was it really designed by Gustave Eiffel?", answer: "Not quite, though the real story has more nuance than a simple yes or no. Architects Auguste Henri Vildieu and Marie-Alfred Foulhoux are credited as the building's architects (1886-1891). Some sources, including city heritage materials, also credit Eiffel's company with the steel roof structure and other steel elements, though this claim rests on less solid documentation than the architectural attribution - so Eiffel's firm may genuinely have been involved, just not as the architect. An earlier 1860-63 telegraph office on the same site is also associated with Eiffel in some accounts, which may have helped blur the two eras together into today's popular myth." },
    ],
    sentiment: {
