...
export const catBaNationalPark: Location = {
  ...
  heroImage: heroUrl("cat-ba-national-part-hai-phong_qvqhtv"),
  gallery: [
    "cat-ba-national-part-hai-phong_qvqhtv",
    "cat-ba-national-part-hai-phong-5_e6boux",
    "cat-ba-national-part-hai-phong-6_m4au8a",
    "cat-ba-national-part-hai-phong-4_veixht",
    "cat-ba-national-part-hai-phong-3_pwmlp0",
    "cat-ba-national-part-hai-phong-9_l31nbu",
    "cat-ba-national-part-hai-phong-7_gwinml",
    "cat-ba-national-part-hai-phong-8_v3bpsg",
    "cat-ba-national-part-hai-phong-2_rfqptr",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Last habitat of the golden-headed langur - fewer than 70 individuals remaining, the world's most endangered primate",
      "17,363 hectares combining tropical limestone forest, coastal mangrove, and inland forest - over 1,500 animal species",
      "12km jungle trek to Việt Hải village through primary forest, with a boat return option from the village",
    ],
    thingsToKnow: {
      crowds: "Weekdays are significantly quieter than weekends. Tour groups tend to cluster around Hang Trung Trang cave and Ngự Lâm viewpoint - the Việt Hải trek sees far fewer people.",
      difficulty: "Route 1 (Ngự Lâm + cave): moderate, 1.5-2 hours, steep sections but manageable. Route 2 (Việt Hải village): demanding, 3-4 hours one way, scrambling and challenging terrain, good fitness required. Route 3 (Hải Quân peak from Việt Hải): short but steep, 2km.",
      safety: "Trails are poorly marked beyond the main routes - hire a guide for anything beyond the cave. Wet limestone is extremely slippery; grip shoes essential. Snakes are occasionally encountered on the Ngự Lâm trail - stay on the path and check before stepping over rocks or roots. Bring sufficient water as none is available on the trails.",
      accessibility: "Hang Trung Trang cave and the entrance area are accessible for most visitors. Forest trails have steep, uneven terrain - not suitable for limited mobility. New concrete path covers first 2km of some trails.",
      seasonal: "Apr–May: butterfly season, trails come alive with species moving through the forest. Apr–Jun and Sep–Nov: best overall conditions. Rainy season makes trails slippery and dangerous.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What are the main trails and how long do they take?", answer: "Three ecotourism routes: Route 1 (1.5km, 1.5-2 hours) - Kim Giao forest to Ngự Lâm peak, then Hang Trung Trang cave 1km further (1 hour, included in full ticket). Route 2 (12km, 3-4 hours one way) - jungle trek via Ao Ếch to Việt Hải village; arrange a boat return from the village. Route 3 (2km, from Việt Hải village) - Hải Quân peak at 259m with panoramic views over Lan Hạ and Ha Long Bay." },
      { question: "What is the golden-headed langur and can I see one?", answer: "The golden-headed langur is the world's most endangered primate - fewer than 70 individuals remain, all exclusively on Cát Bà Island. Sightings are possible but not guaranteed. Ask park rangers at the entrance which areas have had recent activity before heading out." },
      { question: "Do I need a guide?", answer: "For Hang Trung Trang cave and the short viewpoint trail, guides are optional. For the Việt Hải village trek or any deep forest route, a guide is strongly recommended - the trails are poorly marked and the primary forest is easy to get disoriented in. Guides are available at the park entrance." },
    ],
    sentiment: {
      positive: "Praised for the genuine primary forest experience, the scale of the karst landscape, and the Việt Hải trek as a highlight of the island. Wildlife travellers rate the langur spotting potential highly even when sightings don't happen.",
      negative: "Some visitors report overgrown trail conditions and poor maintenance on less-used paths. The specimen house animal enclosures draw criticism. Views from Ngự Lâm can disappoint on hazy days.",
    },
  },
}
