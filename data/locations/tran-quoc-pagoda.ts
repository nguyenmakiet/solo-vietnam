...
export const tranQuocPagoda: Location = {
  ...
  heroImage: heroUrl("tran-quoc-pagoda-ha-noi_inxsre"),
  gallery: [
    "tran-quoc-pagoda-ha-noi_inxsre",
    "tran-quoc-pagoda-ha-noi-2_a97j9k",
    "tran-quoc-pagoda-ha-noi-3_xnuyz4",
    "tran-quoc-pagoda-ha-noi-4_ufiazh",
    "tran-quoc-pagoda-ha-noi-5_l6lc8r",
    "tran-quoc-pagoda-ha-noi-7_hfiauk",
    "tran-quoc-pagoda-ha-noi-8_ek7aa8",
  ],
  seoDescription:
    "Tran Quoc Pagoda is Hanoi's oldest Buddhist pagoda, dating to the 6th century AD and situated on a small peninsula in West Lake - its 11-tier lotus stupa rising above the water is one of the most recognised images in Vietnamese Buddhism.",
  tips: [
    ...
    "It's open year-round, but avoid public holidays, Tết, and the 1st and 15th of the lunar month if you'd rather stroll and pray in relative quiet - these draw the heaviest crowds of local worshippers",
    "The 11-tier Bảo Tháp Lục Độ Đài Sen stupa in the garden, built in 1998, holds 66 white gemstone statues of Amitabha Buddha across its arched windows, topped with a nine-tiered lotus throne (Cửu phẩm liên hoa) also carved from precious stone",
