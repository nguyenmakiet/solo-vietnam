...
export const hanoiTrainStreet: Location = {
  ...
  insights: {
    highlights: [
      "Working railway line passing within centimetres of houses and cafes - two accessible sections with different atmospheres",
      "Old Quarter section (5 Trần Phú): lively, atmospheric, best at night. South Side (210 Lê Duẩn): calmer, less crowded, better for daytime",
      "Afternoons and evenings have significantly more trains than mornings",
    ],
    thingsToKnow: {
      crowds: "Weekdays noticeably less crowded than weekends. Old Quarter section is busier overall. South Side is consistently easier to find a seat. Arrive 15-20 minutes before the train you want to catch.",
      difficulty: "No physical difficulty. Safety awareness required - follow cafe staff instructions when the train approaches.",
      safety: "When the train comes, stand against the wall immediately when directed - clearance is very small. The street was temporarily closed in 2019 after safety incidents. Don't stand on the track.",
      accessibility: "Narrow alleys with uneven ground. Not suitable for wheelchairs. Can be crowded to the point of difficult movement on weekends.",
      seasonal: "Accessible year-round. Oct-Apr is more comfortable in the cooler weather. The street is atmospheric in light rain. Avoid peak heat of summer for the outdoor waiting experience.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What is the difference between the two sections?", answer: "Old Quarter Train Street (enter via 5 Trần Phú): more lively and atmospheric, especially at night, closer to the Old Quarter. Sometimes blocked by police. South Side Train Street (enter via 210 Lê Duẩn): calmer, better for daytime visits, less crowded, consistently accessible. Both have trackside cafes and the same basic experience." },
      { question: "What are the train times?", answer: "Old Quarter: 8:50 AM, 9:20 AM, 11:45 AM, 3:15 PM, 7:30 PM, 9:15 PM, 10:00 PM, 10:40 PM (plus 5:40 PM and 6:10 PM on weekends). South Side: 8:55 AM, 10:10 AM, 11:40 AM, 12:50 PM, 4:10 PM, 7:20 PM, 7:50 PM, 8:10 PM, 8:50 PM, 9:25 PM, 9:50 PM. Times are approximate - verify with cafe staff on arrival." },
      { question: "Do I have to buy a drink?", answer: "Yes, if you want to sit at a cafe and wait for the train. Prices are above average for Hanoi. It's a reasonable arrangement - the cafes manage the crowds and keep visitors off the track. Walk the section before choosing a cafe; the touts can be pushy." },
    ],
    sentiment: {
      positive: "The moment the train passes is genuinely surprising regardless of how prepared you think you are - the proximity and the slow speed make it more visceral than expected. Evening visits to the Old Quarter section in particular draw strong praise for atmosphere.",
      negative: "Cafe touts are frequently reported as pushy or rude. Drinks are overpriced. Old Quarter section sometimes blocked by police without warning. The experience can feel crowded and staged on weekends.",
    },
  },
}
