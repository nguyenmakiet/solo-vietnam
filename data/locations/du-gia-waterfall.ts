...
export const duGiaWaterfall: Location = {
  ...
  tags: ["💧 Thác Ba Tiên", "🏊 Cliff Jumping", "🥾 River Trek", "📸 Photography"],
  ...
  insights: {
    highlights: [
      "Cliff jumping at two levels: 3.5m (lower) and 6m (upper) - popular with foreign visitors since 2023",
      "Cold clear pool fed by mountain forest springs - the best place to refresh on the eastern Ha Giang Loop",
      "Known locally as Thác Ba Tiên (Three Fairies Waterfall) for the tiered cascade resembling fairy hair",
    ],
    thingsToKnow: {
      crowds: "Morning tour groups peak before 11:30 AM. Quieter after midday and in late afternoon. Weekends bring local swimmers from midday onward.",
      difficulty: "Easy 5-15 minute flat walk from parking. Cliff jumping is the only challenging element - 3.5m lower level for confident swimmers, 6m upper level for experienced jumpers only.",
      safety: "Rocks around the pool are slippery and sharp - water shoes recommended. Strong currents possible at higher water levels. The 6m jump should only be attempted by strong, experienced swimmers. Privacy concerns have occasionally been reported by visitors during busy periods.",
      accessibility: "Motorbike parking available (20,000 VND). Flat trail to falls. Pool area has uneven rocky terrain. Towel rental available on site.",
      seasonal: "Summer (Jun–Aug): best conditions - clear water, warm weather, ideal for swimming. Rainy season increases water volume but also currents. Cold water year-round regardless of season.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is this a good waterfall for photography or just for swimming?", answer: "Primarily for swimming and cliff jumping. The falls are 6m high and 2m wide - quiet and atmospheric but not visually dramatic. Vietnamese visitors tend to skip it for this reason. Foreign visitors rate it highly for the cold water and cliff jumping. Come for the experience, not the photo." },
      { question: "What are the cliff jumping levels?", answer: "Two levels: a lower ledge at approximately 3.5m and an upper ledge at 6m above the water. The pool is deep. Rocks around it are slippery and sharp. The lower level is manageable for confident swimmers; the upper level is for experienced cliff jumpers only. Don't attempt either if you're not a strong swimmer." },
      { question: "When is the best time to visit?", answer: "Summer (June to August) for warm weather, clear water, and ideal swimming conditions. Arrive after 11:30 AM to avoid morning tour groups. The water is cold year-round - refreshing in summer, less appealing in the colder months." },
    ],
    sentiment: {
      positive: "Foreign visitors consistently rate it as a highlight of the eastern Ha Giang Loop - the cold water after a hot dusty day on the loop, the cliff jumping, and the quiet forest setting. Distinct from the main loop viewpoints in a way that adds variety to the itinerary.",
      negative: "Not visually impressive enough for visitors expecting a dramatic waterfall. Morning tour groups bring noise and crowds. Privacy concerns have occasionally been reported by visitors during busy periods. Slippery rocks around the pool are a consistent hazard.",
    },
  },
}
