...
export const jadeEmperorPagoda: Location = {
  ...
  bestTime: "Early morning on any day; 1st and 15th of the lunar month for peak activity; avoid Lunar New Year crowds",
  ...
  insights: {
    highlights: [
      "Main altar hall with elaborate lacquered Jade Emperor and celestial court statuary",
      "Sacred turtle pond in the rear courtyard — turtles released as acts of religious merit",
      "Continuous incense coil smoke filling the prayer halls — one of the most atmospheric interior spaces in the city",
    ],
    thingsToKnow: {
      crowds: "Busy on 1st and 15th lunar days; moderate at other times; quietest before 8 AM",
      ...
      seasonal: "Most active around Tết (Lunar New Year) — spectacular but very crowded",
    },
    visitorTips: [
    ...
    faq: [
      ...
      { question: "Why did Barack Obama visit this pagoda?", answer: "During his 2016 state visit to Vietnam, Obama released a turtle into the pagoda's pond — a Vietnamese tradition associated with good fortune and environmental symbolism — in a widely photographed moment." },
