...
export const hangEn: Location = {
  ...
  type: ["nature", "cave"],
  categories: [],
  experiences: ["caving", "trekking", "camping", "photography", "wildlife"],
  ...
  insights: {
    highlights: [
      "World's third largest cave - 1.6km long, 145m ceiling, 200m wide passages, 3km from Sơn Đoòng via underground river",
      "White sandbar campsite inside the cave - natural swimming pool, river stream, tens of thousands of swifts overhead",
      "Sunbeam phenomenon Dec-Mar: giant shafts of light pour through the cave mouth each morning and illuminate the interior",
      "The accessible Son Doong alternative: same cave system, fraction of the cost, achievable with moderate fitness",
    ],
    thingsToKnow: {
      crowds: "Group sizes strictly limited by national park permit. Book 1-2 months ahead minimum, more for Feb-Apr peak. No independent access - only Oxalis authorized.",
      difficulty: "Level 3 - Moderate (Oxalis scale). 25km trekking + 3km caving, 650m elevation gain, multiple river crossings. Requires prior trekking experience. Must be able to run 5km in under 50 minutes. Age 16-70 only.",
      safety: "Leeches on trail - long socks and insect repellent essential. Swifts drop above camp - earplugs recommended. Cave closed Oct-Nov due to underground flood risk. River crossings range knee to chest depth depending on season.",
      accessibility: "Oxalis only (oxalis.com.vn). 8,800,000 VND (~333 USD) all-inclusive. Max 16 guests/group. 3-4 departures/week; daily mid-Dec to late Jan. Contact: contact@oxalisadventure.com / +84-919900357.",
      seasonal: "Dec-Feb: sunbeam season + mild trekking temperature - best for photography. Mar-May: spring, green forest, butterfly season. Jun-Aug: dry, warm, best swimming. Sep: last month before closure. Oct-Nov: closed - flood risk.",
    },
    visitorTips: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Everything: professional guides (English-speaking), porters (8 per group of 10-16), all meals, camping equipment, sleeping bags, caving headlamps and gear, and transport from Phong Nha. You bring personal clothing, camera, and toiletries. The tour departs from and returns to Phong Nha/Sơn Trạch.",
      },
      {
        question: "When is Hang En closed?",
        answer: "October and November - Oxalis suspends all tours due to flood risk from the underground river system that runs through the cave. The cave interior can flood rapidly during typhoon season. Alternative dry caves (Tú Làn, Hang Tiên) remain accessible during this period.",
      },
    ],
    sentiment: {
      positive: "Consistently described as a once-in-a-lifetime experience. The campsite inside the cave, the swallow dawn display, and the sunbeam phenomenon receive particular praise. Oxalis guides and logistics rated highly across reviews.",
      negative: "Physical demands catch some visitors unprepared - the Dốc Ba Giàng climb on day 1 is harder than expected. Leeches are a consistent complaint. Some find the price high relative to Vietnam norms, though all-inclusive.",
    },
  },
}
