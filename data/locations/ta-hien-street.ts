...
export const taHienStreet: Location = {
  ...
  entranceFee: "Free",
  openingHours: "Bars and restaurants open from around 5:00 PM; busiest 8:00 PM - midnight",
  ...
  tips: [
    "Bia hơi - fresh-brewed draft beer served in small glasses - costs around 7,000-10,000 VND per glass here, among the cheapest beer in the world; it is brewed daily and runs out",
    ...
    "The street is pedestrianised on Friday evenings and weekends as part of the Old Quarter walking zone - the atmosphere improves significantly without motorbikes",
