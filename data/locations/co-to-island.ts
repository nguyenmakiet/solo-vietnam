  ...
  insights: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Very different experiences. Ha Long Bay has famous karst scenery and organised cruise infrastructure. Cô Tô has cleaner beaches, better snorkeling, and a more authentic fishing village atmosphere with far fewer tourists. Cô Tô requires more effort to reach but rewards with a more genuine island experience.",
      },
    ],
    sentiment: {
