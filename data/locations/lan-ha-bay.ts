...
export const lanHaBay: Location = {
  ...
  heroImage: heroUrl("lan-ha-bay-cat-ba-hai-phong-2_da4xiq"),
  gallery: [
    "lan-ha-bay-cat-ba-hai-phong-7_ga7fzg",
    "lan-ha-bay-cat-ba-hai-phong-6_dt4kih",
    "lan-ha-bay-cat-ba-hai-phong-4_ovmnrm",
  ...
  insights: {
    highlights: [
      "400+ limestone islands with cleaner water and fewer boats than Ha Long Bay's main tourist route",
      "Bioluminescence night kayaking - paddling through darkness as the water glows with each stroke, unique to Lan Hạ",
      "Hidden cave beaches and enclosed lagoons accessible only by kayak through narrow limestone archways",
    ],
    thingsToKnow: {
      crowds: "Weekdays are significantly quieter. Weekends now draw large numbers of Vietnamese domestic tourists - Lan Hạ has become the main alternative to an increasingly crowded and expensive Ha Long Bay. Still far fewer boats than Ha Long's main route on any given day.",
      difficulty: "Cave passages require low paddling through shallow archways - kayaks may brush rocks but no injury risk. Accessible for most fitness levels. Night kayaking adds a navigation challenge in darkness but guides lead the route.",
      safety: "Tour permits required and included in group tour costs. Water contains some litter drifting from Ha Long Bay. Night kayaking operates with guides - don't paddle independently in the dark between karsts.",
      accessibility: "Families with young children (age 3+) and most fitness levels can visit via standard cruise or boat tour. Kayaking requires basic paddling ability. Night tour is suitable for anyone comfortable on water in darkness.",
      seasonal: "Apr–Jun and Sep–Nov give the best combination of calm water, visibility, and manageable crowds. Winter months (Nov–Mar) are quieter but can be cold and misty. Summer brings more domestic tourists, especially on weekends.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "How does Lan Hạ Bay compare to Ha Long Bay?", answer: "The natural scenery is the same - identical karst geology, same limestone islands and emerald water. Lan Hạ has fewer boats, cleaner water, lower prices, and a more independent travel feel. Ha Long Bay has more premium cruise options and higher name recognition. Lan Hạ also has bioluminescence night kayaking, which Ha Long Bay's main tourist zone doesn't offer. If you've done Ha Long Bay already, Lan Hạ is the better choice. If you're choosing between them for a first visit, Lan Hạ gives more for less." },
      { question: "What is the bioluminescence night kayaking tour?", answer: "A kayaking tour that departs after dark, paddling through the bay between limestone karsts. Bioluminescent plankton in the water glow blue-green with each paddle stroke. The effect is weather and season dependent but when conditions are right it's genuinely remarkable. Tours cost around 28 USD per person and are bookable at most hostels and hotels in Cát Bà town - prices vary by operator." },
      { question: "Can I visit both Lan Hạ Bay and Ha Long Bay in one day?", answer: "Yes - the two bays share a border and some operators run combined day tours covering both. It's a long day but gives you the full karst landscape in a single trip. Useful if you only have one day in the area." },
    ],
    sentiment: {
      positive: "Consistently rated as superior to Ha Long Bay for independent travellers - fewer boats, better water quality, more intimate kayaking conditions, and the bioluminescence night tour as a standout experience. Prices are lower and the atmosphere is less commercialised.",
      negative: "Weekend crowds have increased noticeably as Lan Hạ's profile has risen and Cát Bà has become easier to reach. Some water litter drifts in from Ha Long Bay. Fewer premium cruise options than Ha Long Bay for travellers who want that experience.",
    },
  },
}
