...
export const frenchVillageBaNa: Location = {
  ...
  insights: {
    highlights: [
      "French Gothic and Romanesque architecture at 1,487m - Saint Denis Cathedral, cobbled streets, central square",
      "Debay Wine Cellar (1923) - the only genuinely historic structure on the mountain, carved into the rock face by the French",
      "Seasonal festivals: Carnival (Apr–Sep), B'estival beer festival (Jun–Sep), Halloween, Christmas - with street performers and international acts",
    ],
    thingsToKnow: {
      crowds: "Busiest mid-morning to early afternoon when day tour groups arrive. Best light and fewest people: 8–10 AM and 3–5 PM.",
      difficulty: "Easy walking throughout on cobbled and paved surfaces. Fantasy Park has rides for all fitness levels.",
      safety: null,
      accessibility: "Well-maintained paths and paved streets throughout. Cable car is the only access - no road option since 2018.",
      seasonal: "Mar–Sep: dry season, sunny, best for outdoor photography and festivals. Oct–Feb: cold, heavy fog, atmospheric - bring warm layers. Fog can obscure the Golden Bridge completely.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is the French Village authentic or a recreation?", answer: "It's a purpose-built recreation, constructed from 2014 in French Gothic and Romanesque style. The original French hill station was destroyed during the wars. The one genuine historic element is the Debay Wine Cellar, carved into the mountain by the French in 1923 and incorporated into the modern complex." },
      { question: "What is Fantasy Park and is it worth it?", answer: "Fantasy Park is a large indoor theme park inside a recreated French fortress - multiple floors of rides, a wax museum, 4D cinema, and arcade games. Included in the Bà Nà Hills ticket. Worth spending time in for families with children; adults without children typically spend 30-45 minutes before moving on." },
      { question: "How do I get to Bà Nà Hills from Đà Nẵng?", answer: "Road access has been closed since 2018 - cable car only. Take a taxi or Grab to the Suối Mơ base station (about 45 minutes from the city centre), or bus number 3 from the airport (30,000 VND, every 15-30 minutes). Cable car ride to the summit takes about 20 minutes." },
      { question: "Is it worth staying overnight at Bà Nà Hills?", answer: "Yes, if your budget allows it. Mercure Danang French Village Bana Hills is the only hotel inside the complex - staying there gets you the village at night when day visitors have gone, early cable car access to the Golden Bridge at 6 AM before crowds arrive, and the experience of 1,487m elevation after dark when the whole complex is lit up. Temperature drops significantly at night - bring warm layers, socks, and a jacket regardless of how hot it was in Đà Nẵng. The main tradeoff is cost; the hotel is premium priced." },
    ],
    sentiment: {
      positive: "Praised by visitors who embrace it for what it is - a well-executed European-themed resort at altitude, with strong photography opportunities, entertaining rides, and a genuinely unusual atmosphere. Overnight guests consistently rate the experience higher than day visitors.",
      negative: "Visitors expecting authentic experiences or natural scenery find it disorienting. The entirely artificial environment is a significant contrast with Vietnam's natural landscapes. Crowded during peak tour group hours.",
    },
  },
}
