...
export const pacBoHistoricSite: Location = {
  ...
  entranceFee: "25,000 VND/person; children under 1.2m free",
  ...
  tips: [
    "The site is a major pilgrimage destination for Vietnamese visitors - expect respectful crowds on weekends and national holidays",
    "The Lenin Stream and Karl Marx Mountain were named by Hồ Chí Minh himself during his time here - ask the guides about the story behind the names",
    "The cave where Hồ Chí Minh lived and worked is small and unadorned - the power of the site is entirely in its historical significance rather than its scale",
    "The surrounding jungle valley is genuinely beautiful - allow time to walk the stream trail beyond the main cave site",
    "Combine with Nguồm Pục Cave on the same day - both are in Hà Quảng District and about 15km apart by motorbike",
  ],
  content: {
    intro:
