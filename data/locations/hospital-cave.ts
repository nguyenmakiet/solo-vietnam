...
export const hospitalCave: Location = {
  ...
  tags: ["🏥 Wartime Underground Hospital", "📖 Vietnam War History", "🪨 Limestone Cave", "📸 Photography"],
  ...
  insights: {
    highlights: [
      "Limestone cave used as a secret wartime hospital and command centre from 1963 to 1975 - treating up to 150 patients at a time",
      "Originally named Động Hùng Sơn after a Trần dynasty general; renamed Hang Quân Y during the resistance war",
      "Recognisable from the road by a large natural opening visible in the limestone peak above",
    ],
    thingsToKnow: {
      crowds: "Very few visitors since the closure - the site is quiet.",
      difficulty: "Front entrance: 69 steps. Rear entrance: 43 steps. Exterior visit only - no technical challenge.",
      safety: "Both entrances gated. Strong damp and ammonia smell from bat colony inside.",
      accessibility: "Steps to each cave mouth. Exterior only - no interior navigation required.",
      seasonal: "Accessible year-round. Cave interior closed regardless of season.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is Hospital Cave still open to visit?", answer: "As of 2026, both entrances are closed and the interior is not accessible. You can walk up to the cave mouths from outside (69 steps at the front, 43 at the rear) but cannot go inside. Budget 10-15 minutes for an exterior visit, or skip it and spend the time at Trung Trang Cave or the national park instead." },
      { question: "What was Hospital Cave used for?", answer: "From 1963 to 1975 it was a fully functioning underground military hospital and command centre, capable of treating up to 150 patients simultaneously. The natural limestone provided complete concealment from aerial surveillance. It included operating rooms, patient wards, a pharmacy, dormitories, a communications centre, and a cinema room. The cave was never discovered during the war." },
      { question: "What is the history of the cave's name?", answer: "The cave was originally called Động Hùng Sơn, named after a Trần dynasty general who fought invaders. During the resistance against the US it was converted into a field hospital and renamed Hang Quân Y (Military Medical Cave). Both names reflect different chapters of Vietnamese resistance history." },
    ],
    sentiment: {
      positive: "The historical significance is genuine and the setting - a natural cave converted into a working hospital - is compelling. The exterior still gives a sense of the scale and the concealment the cave provided.",
      negative: "Interior has been closed since 2026, removing most of the reason to visit. Many online reviews describe the interior experience that is no longer available - check current status before planning around this site.",
    },
  },
}
