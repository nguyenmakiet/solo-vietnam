...
export const damTrauBeach: Location = {
  ...
  tips: [
    "The best plane-spotting window is when flights arrive - check the daily schedule for Vietnam Airlines and Bamboo Airways Côn Đảo routes and position yourself on the sand 10–15 minutes before landing",
    "Bãi Đầm Trầu Nhỏ (Small Đầm Trầu) is a short walk from the main beach - quieter, more secluded, good for private swimming",
    "Camping overnight is permitted - bring your own gear as there are no rentals on site; fires are allowed in designated areas",
    "Coral reefs are accessible with a snorkel just off the rocky edges of the beach - bring your own equipment as rentals on the island are limited",
    "The beach is 14km from Con Son town - rent a motorbike (around 150,000–200,000 VND/day) for flexibility; it's only 5–10 minutes from Cỏ Ống Airport",
