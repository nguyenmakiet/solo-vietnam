...
export const mySonSanctuary: Location = {
  ...
  type: ["temple", "heritage", "citadel", "history", "cultural"],
  categories: ["history", "architecture", "culture"],
  experiences: ["history", "culture", "photography", "walking-tour", "museum-visit"],
  tags: ["🏛️ UNESCO Heritage", "🛕 Cham Temples", "🌿 Jungle Ruins", "cham-culture", "hinduism"],
  ...
  gallery: [
    ...
    "my-son-sanctuary-quang-nam_wrfow5",
    "my-son-sanctuary-quang-nam_bdqbmj",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Over 70 Cham Hindu temple towers in a jungle valley - the most significant Cham archaeological site in Vietnam, abandoned for centuries and rediscovered in 1889",
      "Cham dance and music performances at the performance hall and Group G - check show times at the entrance board",
      "Best-preserved architecture in Groups B, C, and D - tapering brick towers with stone carvings of Hindu deities, all facing east toward the sunrise",
    ],
    thingsToKnow: {
      crowds: "Tour groups from Hội An arrive around 9-10 AM. 6-9 AM is significantly quieter and cooler. Late afternoon before closing is also less crowded.",
      difficulty: "Moderate walking across the valley floor - mostly flat but over uneven ground. Electric buggy from entrance to the main site is included in the ticket. Allow 2-3 hours.",
      safety: "Sun exposure is significant - bring a hat, sunscreen, and water. Some temple areas have uneven ground.",
      accessibility: "Electric buggy service from entrance. Some uneven terrain within the temple zones. Limited accessibility for wheelchairs in the older temple areas.",
      seasonal: "Best Feb-Aug (dry season). Oct-Jan wet season brings flooding, muddy paths, and reduced visibility. Avoid midday heat year-round.",
    },
    visitorTips: [
    ...
    faq: [
      {
        ...
        answer: "2-3 hours is the standard for a thorough visit covering all the main temple groups and the museum. A quick visit to the highlights takes about 1-1.5 hours. Add time if you want to watch the Cham performance.",
      },
      {
        question: "Is a guide necessary?",
        answer: "The on-site information panels are limited. A hired guide or the audio guide (70,000 VND) significantly improves the experience - the Cham history and symbolism of the different temple groups is genuinely interesting with context but hard to appreciate without it.",
      },
      {
        question: "How does Mỹ Sơn compare to Angkor Wat?",
        answer: "Mỹ Sơn is much smaller and less intact than Angkor - it's not a comparable scale. But as a Cham site specifically, it is the most significant in Vietnam and worth visiting for that reason. The jungle valley setting gives it a character that the more developed Angkor lacks.",
      },
    ],
    sentiment: {
      positive: "Visitors consistently praise the atmospheric jungle setting, the quality of the surviving architecture, and the site's relatively uncrowded early mornings. The Cham performances are frequently highlighted as an unexpected highlight.",
      negative: "Limited on-site signage makes the visit less meaningful without a guide or audio guide. Tour groups mid-morning significantly affect the atmosphere. Group A's destruction by bombing is visually striking but disappointing for those expecting intact temples.",
    },
  },
}
