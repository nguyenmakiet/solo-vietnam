...
export const lySonGarlicFields: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775827840232!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJRHl2WU95V1E.!2m2!1d15.37993229409859!2d109.1044025410706!3f113.0538766555751!4f-40.53217293317545!5f0.7820865974627469" },
  heroImage: heroUrl("galic-field-ly-son-island-9_tbedmo"),
  gallery: [
    "galic-field-ly-son-island-5_l5uib5",
    "galic-field-ly-son-island-7_y9opn4",
    "galic-field-ly-son-island-6_sp9yku",
    "galic-field-ly-son-island-2_jema2n",
    "galic-field-ly-son-island-8_ewnjfn",
    "galic-field-ly-son-island_a8l15o",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Garlic fields on both Đảo Lớn and Đảo Bé - visible from the ferry pier on Đảo Bé as you arrive",
      "Volcanic ash and white sand soil unique to Lý Sơn - produces the distinctive strong-flavoured purple garlic famous across Vietnam",
      "Harvest season Feb - Mar: dried garlic curing everywhere, farmers working the fields, full sensory experience",
      "Nov - Jan: young green shoots against dark volcanic soil, areca palms, quieter island",
    ],
    thingsToKnow: {
      crowds: "Feb - Mar harvest season is the most visited period. Nov - Jan is quieter. The fields themselves are never crowded - they're spread across both islands and most visitors see them as backdrop rather than destination.",
      difficulty: null,
      safety: null,
      accessibility: "Fields visible from roads across both islands. No entrance fee or formal access point. Elevated views from Núi Thới Lới and Núi Giếng Tiền. On Đảo Bé, fields start at the ferry pier.",
      seasonal: "Sep - Oct: planting season, fields being worked. Nov - Jan: young green shoots, areca palms, quieter island - good for photography without harvest crowds. Feb - Mar: full harvest, garlic drying everywhere, most photogenic and most visited. Apr - Aug: fields bare or fallow after harvest.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "When is the best time to visit the Lý Sơn garlic fields?", answer: "Two good windows: February to March for harvest season - garlic fully grown, drying scenes everywhere, active farming atmosphere. November to January for young green shoots against dark volcanic soil - quieter, less crowded, still beautiful. Avoid April to August when the fields are bare after harvest." },
      { question: "Are the garlic fields on Đảo Lớn or Đảo Bé?", answer: "Both. Fields cover the flat land across both islands. On Đảo Bé, the fields are visible immediately from the ferry pier. On Đảo Lớn, they're most concentrated in the An Hải area but visible throughout the island." },
      { question: "What makes Lý Sơn garlic special?", answer: "The soil - a combination of volcanic ash and white sand unique to the island. This gives Lý Sơn's purple garlic a stronger, more pungent flavour than mainland garlic. The island's reputation as 'Vương Quốc Tỏi' (Kingdom of Garlic) is built on this soil chemistry and the farming tradition that has developed around it." },
      { question: "Can I participate in the harvest?", answer: "Informally yes - farmers are generally welcoming if you approach respectfully. The harvest runs February to March; early morning is when most activity happens before the heat builds. Walking between the rows and chatting with farmers is part of the experience. Do not walk through crops or pick anything without being invited." },
      { question: "Where is the best viewpoint over the garlic fields?", answer: "Núi Thới Lới summit on Đảo Lớn gives the widest overview - the full patchwork of fields with the sea surrounding the island. Núi Giếng Tiền is a closer alternative. On Đảo Bé, the pier itself offers a straight-on view of the fields as you arrive by boat." },
    ],
    sentiment: {
      positive: "Consistently praised for the visual contrast of dark volcanic soil and green garlic rows against the blue sea, and for the sensory experience of harvest season - the smell, the activity, the drying garlic everywhere. Visitors appreciate the working-farm authenticity.",
      negative: "Outside the growing season the fields are bare and the visual appeal disappears. Some visitors find it underwhelming as a standalone destination without the context of the broader island visit.",
    },
  },
}
