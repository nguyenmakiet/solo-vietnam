...
export const bauSau: Location = {
  ...
  gallery: [
    ...
    "bau-sau-nam-cat-tien-dong-nai-10_dtkkhw",
    "bau-sau-nam-cat-tien-dong-nai-2_q75dvn",
    "bau-sau-nam-cat-tien-dong-nai-6_c2hh5p",
    "bau-sau-nam-cat-tien-dong-nai-9_qsyskb",
    "bau-sau-nam-cat-tien-dong-nai_a60k0r",
    "bau-sau-nam-cat-tien-dong-nai-7_l0qbhh",
    "bau-sau-nam-cat-tien-dong-nai-3_o2zt6t",
    "bau-sau-nam-cat-tien-dong-nai-5_iycod0",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Cycle 9km through the forest then hike 5km to observe Siamese crocodiles at close range - one of the only places in Vietnam where this is possible",
      "Spot diverse wildlife including gibbons, langurs, hornbills, and rare bird species like kingfishers and the Greater Adjutant",
      "Stay overnight at the lakeside ranger station to experience the night flashlight scene - hundreds of crocodile eyes reflecting across the dark water",
    ],
    thingsToKnow: {
      crowds: "Early morning visits (8am) on weekdays have fewer tourists than peak hours; overnight stays give you the lake almost entirely to yourself",
      difficulty: "Moderate - 9km cycling on flat concrete road followed by 5km jungle walk with minimal elevation gain; total trekking time 1-1.5 hours",
      safety: "Siamese crocodiles are gentle and no serious attacks have been recorded - follow guide instructions and maintain distance from the water's edge",
      ...
      seasonal: "Dry season (Nov-Apr) is easiest and wildlife concentrates around the shrinking lake; rainy season (Jul-Oct) is harder going but the forest atmosphere - rain on the canopy, running streams, intense green - is worth experiencing for a different kind of visit",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What are the total costs and payment methods?", answer: "Ferry: 60,000 VND/person, Crocodile Lake ticket: 250,000 VND/person, Bike rental: 150,000 VND/day plus 100,000 VND deposit, Jeep rental: ~700,000 VND/vehicle return trip (up to 7 people), Boat tour at the lake: ~150,000 VND/boat. Bring sufficient cash - card payment is not available." },
      { question: "How long does the full visit take?", answer: "Ferry crossing, then 45-60 minutes cycling 9km, then 1-1.5 hours walking 5km to lake. Allow a full day for a comfortable pace with time at the lake. Overnight stays require booking in advance." },
      { question: "Can I stay overnight at Bau Sau?", answer: "Yes - the ranger station at the lake has 3-5 rooms with a maximum capacity of around 19-20 people. Overnight stays sell out quickly, especially during public holidays. Book at least 1-2 months in advance by contacting the Cat Tien National Park Management Board: (0251) 3669 228. Staying overnight is strongly recommended - the night flashlight scene and early morning crocodile activity are the highlights of the entire experience." },
      { question: "What wildlife can I expect to see?", answer: "Crocodiles (multiple sightings likely), gibbons, langurs, Green Peafowl, hornbills, kingfishers, snakes, lizards, and various insects. Guide increases spotting success significantly. Overnight visitors also have a high chance of seeing crocodile eyes reflecting across the lake after dark." },
    ],
    sentiment: {
