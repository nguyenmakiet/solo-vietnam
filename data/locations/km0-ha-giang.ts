...
export const km0HaGiang: Location = {
  ...
  bestTime: "Year-round - most atmospheric in early morning before the loop riders set off",
  ...
  insights: {
    highlights: [
      "The traditional starting point of the Ha Giang Loop - photograph the Km 0 marker before heading north on National Highway 2 toward the Đồng Văn Karst Plateau",
      "Most atmospheric at dawn when loop riders gather to depart - the energy of 7-9 AM on any morning is unique to this spot",
      "46km north from here is the Heaven Gate at Quản Bạ - the first major viewpoint of the loop",
    ],
    thingsToKnow: {
      crowds: "The marker itself is never crowded; the surrounding area is busiest with departing riders between 7-9 AM",
