...
export const phongNamValley: Location = {
  ...
  insights: {
    highlights: [
      "Golden rice harvest September to October - one of the most photogenic valley landscapes in northeastern Vietnam",
      "Quây Sơn River winding between karst peaks and rice fields - the same river that forms Bản Giốc Waterfall 25km downstream",
      "Outstanding drone photography location - river bends, limestone towers, and golden fields in a single frame",
      "Genuine hidden gem - no tourist infrastructure, no group tours, almost entirely unknown to international travellers",
    ],
    thingsToKnow: {
      crowds: "Extremely quiet. Almost no international tourists and very few domestic visitors outside of harvest season. Even in September and October the valley sees a fraction of the crowds at nearby Bản Giốc.",
      difficulty: null,
      safety: null,
      accessibility: "Directly on the road between Bản Giốc and Cao Bằng city - no detour required. Bicycles available for rent in Trùng Khánh town. No facilities inside the valley; bring food and water.",
      seasonal: "Sep - Oct: rice harvest, golden fields, peak photography season. Mar - May: spring flowers, cool temperatures (15-22°C), occasional local agricultural festivals - a quieter alternative to harvest season. Jun - Aug: heavy rain, flood risk, slippery roads - not recommended. Nov - Feb: fallow or early-growth rice, cooler and drier but without the colour of harvest or spring.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What is the best time to visit Phong Nậm Valley?", answer: "September to October for golden rice harvest - this is the peak season and what produces the photos most associated with the valley. March to May is a good second window: spring wildflowers, cool air, and occasional local festivals. Avoid June to August (heavy rain, flood risk, slippery roads)." },
      { question: "Is Phong Nậm on the way to Bản Giốc?", answer: "Yes - it's directly on the road between Trùng Khánh town and Bản Giốc Waterfall, about 15km from town. Most travellers pass through it naturally on the Cao Bằng Loop and can stop without any detour." },
      { question: "What is the Quây Sơn River?", answer: "The river that runs through Phong Nậm Valley. It continues 25km downstream from here to form Bản Giốc Waterfall - one of Vietnam's most famous natural landmarks. Seeing the river in its quiet valley form at Phong Nậm and then at the waterfall gives a sense of the whole landscape." },
      { question: "Is Phong Nậm good for drone photography?", answer: "One of the best spots in Cao Bằng. The combination of the Quây Sơn River winding between karst peaks, golden rice fields, and Tày stilt houses creates aerial compositions that are hard to match in the northeast. September and October give the best colour." },
      { question: "Are there any facilities at Phong Nậm?", answer: "No - no cafes, restaurants, ticket booths, or tourist services inside the valley. Bring everything you need from Trùng Khánh town, 15km away." },
    ],
    sentiment: {
      positive: "Consistently praised by travellers who discover it for the authentic, undisturbed landscape - rice fields, river, karst peaks, and Tày villages with no tourist overlay. Drone pilots and photographers rate it particularly highly. The quietness is consistently mentioned as a feature, not a bug.",
      negative: "Nothing to do beyond walking, cycling, and photography - travellers expecting activities or facilities will be disappointed. Outside harvest season the visual payoff is lower. Very few English-language resources make it hard to find for international visitors planning independently.",
    },
  },
}
