...
export const hieuWaterfall: Location = {
  ...
  insights: {
    highlights: [
      "Multi-tier waterfall over a limestone base - no algae, no slipping, walk freely through the water between tiers",
      "Cold karst spring water year-round - genuinely refreshing after the motorbike ride through Pù Luông",
      "Upper tiers run through Hieu Village itself - stilt houses, bamboo bridges, and rice terraces framing the water",
    ],
    thingsToKnow: {
      crowds: "Lower tiers and base pool get crowded on holidays and weekends. Upper tiers are quieter at any time. If the base pool is packed, wait around an hour - most visitors head to lunch around 11:30 AM and it clears out.",
      difficulty: "Easy walk up the tiers - no technical terrain. The path to upper tiers is steeper and rougher but manageable. Limestone base means low slip risk even where water flows.",
      safety: "Road to the waterfall has steep sections - ride a manual motorbike or hire xe ôm if not confident. Take the lower fork (right) at the road split approaching the village. The upper path (left) is significantly steeper.",
      accessibility: "Base tier and pool accessible without difficulty. Upper tiers require a moderate uphill walk on uneven path.",
      seasonal: "Jun–Oct: peak water flow, surrounding rice terraces approaching harvest gold. Feb–Apr: water volume drops significantly and lower tiers can look modest. Cold water year-round regardless of season.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Why aren't the rocks slippery?", answer: "The waterfall flows over a limestone base. Algae struggles to grow on limestone the way it does on granite or clay, so the rocks stay clean where the water runs. You can walk directly through the water between tiers without the usual slipping risk." },
      { question: "How long does a visit take?", answer: "1 hour if you're walking the tiers without swimming. Budget 1.5-2 hours if you plan to swim at the base pool or upper tiers." },
      { question: "When is the best time to visit?", answer: "June to October for peak water flow. The surrounding rice terraces also turn gold toward harvest in this period, which adds to the overall view. February to April the water drops noticeably and the lower tiers look modest. Weekdays are quieter than weekends and public holidays." },
    ],
    sentiment: {
      positive: "Consistently praised for the cold water, the ability to walk freely between tiers without slipping, and the integration of the waterfall with the village and rice terraces. A highlight of the Pù Luông itinerary for most visitors.",
      negative: "Base pool and lower tiers get crowded on holidays. The road in has steep sections that catch out underpowered or automatic motorbikes.",
    },
  },
}
