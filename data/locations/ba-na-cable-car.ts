...
export const baNaCableCar: Location = {
  ...
  type: ["cable-car", "theme-park", "attraction"],
  ...
  insights: {
    highlights: [
      "Cable car through the cloud layer that frequently forms above the mountain - 30-second transition from grey mist to clear sunshine above the clouds is the defining moment of the ride",
      "Golden Bridge (held by giant stone hands) - the most photographed structure in Đà Nẵng, best in late afternoon light via Station 1",
      "French Village complex at the summit - colonial architecture, gardens, mountain railway, theme park, and Moon Castle across a large walkable area",
    ],
    thingsToKnow: {
      crowds: "9:30-11 AM is the busiest window. 7:30-8:30 AM is significantly quieter. Summer (Jun-Aug) peak season brings the largest crowds. Weekdays are calmer than weekends.",
      difficulty: "Significant walking across the mountain complex - wear flat, comfortable shoes. Cable car may affect those prone to motion sickness or with a fear of heights.",
      safety: "Motion sickness bags available in cabins. Cable car is stable but can sway in high wind. After 6 PM frequency can reduce to roughly hourly departures - plan descent accordingly.",
      accessibility: "Most areas accessible via cable car. Significant walking between zones. Staff at each station can advise on current accessibility.",
      seasonal: "Best Mar-Aug for clearest visibility. Weather at the summit is unpredictable year-round - bring a jacket and umbrella regardless of the forecast at sea level.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Which cable car station should I use?",
        answer: "Station 1 (Hội An - Marseille) goes to the Golden Bridge area. Station 2 (Suối Mơ - Bà Nà) goes to the mountain railway and flower gardens. Stations 3-4 go directly to the French Village. The new Hội An 2 station goes to Moon Castle. Stations 1 and 4 operate most consistently. Recommended route: up via Stations 3 or 4, down via Station 1 for the Golden Bridge at sunset.",
      },
      {
        question: "How long should I spend at Bà Nà Hills?",
        answer: "A full day (7:30 AM to 6 PM) is recommended to cover the main zones properly - the complex is larger than most visitors expect. Half-day visits are possible but rushed.",
      },
      {
        question: "What if I get motion sickness?",
        answer: "The cable car affects some people similarly to boats or winding mountain roads. Take motion sickness medication 30 minutes before the ride. Motion sickness bags are available in the cabin. Sit still, look at the horizon, and avoid excessive head movement.",
      },
    ],
    sentiment: {
      positive: "The cloud transition on the cable car ride and the Golden Bridge are consistently described as genuinely impressive. Early morning visits receive strong reviews for the atmosphere and lack of crowds.",
      negative: "Very expensive by Vietnamese standards. Weather fog at the summit can eliminate views and reduce the experience significantly. Some attractions closed without notice. After 6 PM the complex feels deserted.",
    },
  },
}
