...
export const honThomCableCar: Location = {
  ...
  insights: {
    highlights: [
      "8km crossing at up to 174 metres above the sea - the world's longest non-stop three-rope cable car, the crossing itself is the experience",
      "On clear days: transparent sea floor visible below, fishing villages, children swimming around village boats in the afternoon",
      "Kiss Bridge sunset viewpoint on Hòn Thơm island - one of the most praised sunset spots in southern Vietnam",
    ],
    thingsToKnow: {
      crowds: "Arrives early at 9 AM opening for the shortest queues. Midday closure 11:30 AM-1:30 PM means two distinct visitor sessions - early morning is less crowded.",
      difficulty: "No physical difficulty for the cable car. The highest pylon is 174 metres - not recommended for those with a fear of heights. Water park slides involve stair climbing.",
      safety: "Cable car suspends operations in strong wind or heavy rain - check weather before visiting. Keep ticket throughout the visit as it is checked on return. Last cable car back at 5 PM.",
      accessibility: "Cable car cabin accessible. Water park slides require stairs. Island paths are paved.",
      seasonal: "Best Nov-Apr for clear views. Nov-Dec: afternoon crossings may catch sunset on the water. Cable car closes in bad weather year-round.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Is the cable car worth it even without the water park?",
        answer: "Yes - the crossing itself is the main attraction. 8km over open sea at up to 174 metres altitude, with views of the southern archipelago, transparent water below, and fishing villages visible from above. The water park and beach are bonuses. If water parks aren't your scene, spending an hour or two on the island beach and Kiss Bridge before returning is enough.",
      },
      {
        question: "What are the operating hours and midday closure?",
        answer: "The cable car runs 9:00-11:30 AM and 1:30-5:00 PM daily. It closes for two hours at midday. The last cable car back to Phú Quốc departs at 5:00 PM - missing it means taking a boat back.",
      },
      {
        question: "Can the cable car be cancelled on the day?",
        answer: "Yes - the cable car suspends operations in strong wind or heavy rain. Check the weather forecast before making the 25km trip south. Conditions in the southern part of the island can differ from Dương Đông town.",
      },
    ],
    sentiment: {
      positive: "The cable car crossing is consistently described as one of the most memorable experiences on Phú Quốc - the aerial sea views, transparent water below, and scale of the crossing exceed most visitors' expectations. The Kiss Bridge sunset is frequently highlighted.",
      negative: "Midday closure catches some visitors off guard. Cable car cancellations due to weather frustrate visitors who have made the long trip south. Locker fees on the island are expensive. Some water park rides were under construction/maintenance in recent visits.",
    },
  },
}
