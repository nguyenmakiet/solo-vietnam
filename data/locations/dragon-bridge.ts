...
export const dragonBridge: Location = {
  ...
  content: {
    ...
    travelTips:
      "The Dragon Bridge is worth visiting twice: once during the day for photography and once at night for the atmosphere. The weekend fire show is genuinely impressive and free - one of the better free spectacles in Vietnam. Weeknight visits are quieter and the illuminated bridge reflects beautifully in the river. If you're in Đà Nẵng over a weekend, the show is non-negotiable. Combine with a riverside dinner beforehand - the restaurants on Bạch Đằng Street have direct views of the bridge from their terraces.",
  },
  insights: {
    highlights: [
