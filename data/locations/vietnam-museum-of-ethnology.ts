...
export const vietnamMuseumOfEthnology: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1779190121673!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRDRxb3kxcHdF!2m2!1d21.0405835931096!2d105.7984277260361!3f352.2708610026633!4f-6.174145741620308!5f0.7820865974627469", },
  heroImage: heroUrl("vietnam-museum-of-ethnology-ha-noi_vulbxj"),
  gallery: [
    "vietnam-museum-of-ethnology-ha-noi_vulbxj",
    "vietnam-museum-of-ethnology-10_fwgppz",
    "vietnam-museum-of-ethnology-ha-noi-3_qwvxgo",
    "vietnam-museum-of-ethnology-ha-noi-8_ognusp",
    "vietnam-museum-of-ethnology-ha-noi-7_cmfo8j",
    "vietnam-museum-of-ethnology-ha-noi-5_vczoqe",
    "vietnam-museum-of-ethnology-ha-noi-6_lswbop",
    "vietnam-museum-of-ethnology-ha-noi-9_xj2uwi",
    "vietnam-museum-of-ethnology-2_v76pno",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "54 ethnic groups documented across indoor galleries and a 2-hectare outdoor village of full-scale reconstructed traditional houses",
      "Water puppet show every Saturday and Sunday at 11 AM - a Vietnamese performance tradition dating back over 1,000 years",
      "Building designed by Tày architect Hà Đức Lịnh in the shape of a Đông Sơn bronze drum",
    ],
    thingsToKnow: {
      crowds: "Weekday mornings are quietest. Weekends attract school groups; outdoor section gets crowded. Water puppet show at 11 AM on weekends draws additional visitors.",
      difficulty: "Easy walking throughout. Outdoor section involves uneven ground between structures. Full visit covers a large area - wear comfortable shoes.",
      safety: "No touching displays. No flash photography. No drones or flycams permitted.",
      accessibility: "Mostly flat and accessible. Some outdoor paths between traditional houses are unpaved.",
      seasonal: "Oct-Apr is the most comfortable period for the outdoor section. Summer heat and rain make the outdoor village less pleasant to explore at length.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "How long should I spend here?", answer: "About 2.5 hours covers everything: 1 hour in the main indoor galleries, 1 hour in the outdoor traditional house village, and 30 minutes for the water puppet show if visiting on a weekend. Skip the Southeast Asia building unless specifically interested - it covers Korean and global cultures and is loosely connected to the main ethnology theme." },
      { question: "Is the water puppet show worth it?", answer: "Yes, once. It runs at 11 AM on Saturdays and Sundays and costs 50,000 VND extra. Water puppetry is a Vietnamese performance tradition dating back over 1,000 years - without context it can seem slow, but understanding what you're watching makes it more interesting. It's included in the same visit rather than a separate trip." },
      { question: "Do I need a guide?", answer: "Not essential. The English signage is thorough enough to follow the main narratives independently - one of the few Vietnamese museums where this is true. Audio guides are available at the entrance and add detail to the indoor displays if you want more depth." },
    ],
    sentiment: {
      positive: "Consistently rated the best museum in Vietnam by international visitors - praised for the quality and depth of documentation, the outdoor traditional house village, and the well-maintained grounds. The combination of indoor collection and outdoor architecture is genuinely distinctive.",
      negative: "Some individual object labels inside are vague - items displayed without ethnic attribution or context. The Southeast Asia building feels disconnected from the main ethnology theme. A few visitors find the water puppet show underwhelming without prior context.",
    },
  },
}
