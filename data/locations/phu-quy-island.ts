...
export const phuQuyIsland: Location = {
  ...
  tips: [
    "The ferry crossing from Phan Thiết to Phú Quý takes 3 hours and is weather-dependent - outside the January to August window the crossing can be rough or cancelled. Check sea conditions before booking the return journey",
    "Phú Quý has no cars - the island is explored by motorbike or bicycle, both available for rent at the pier. The full island circuit takes about 2-3 hours by motorbike",
