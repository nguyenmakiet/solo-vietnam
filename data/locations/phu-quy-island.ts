...
export const phuQuyIsland: Location = {
  ...
  heroImage: heroUrl("phu-quy-island-binh-thuan-12_wmf0hl"),
  gallery: [
    "phu-quy-island-binh-thuan-16_g8x0ty",
    "phu-quy-island-binh-thuan_1_eglnv2",
    "phu-quy-island-binh-thuan-15_nnabe6",
    "phu-quy-island-binh-thuan-9_x7trok",
    "phu-quy-island-binh-thuan-6_qknixk",
    "phu-quy-island-binh-thuan-5_r2wrf3",
    "phu-quy-island-binh-thuan-4_c3iotx",
    "phu-quy-island-binh-thuan-7_hvhxzk",
    "phu-quy-island-binh-thuan-3_k6ay32",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Coral diving with guide, filming, and photography from 250,000 VND - reefs in better condition than almost anywhere on the mainland Vietnamese coast",
      "Hòn Tranh boat tour: morning (7-11 AM) or afternoon (14:30-17:00) sessions - Vietnamese visitors only",
      "Núi Cao Cát, Đấu Trường La Mã, wind turbines, and Cây Cô Đơn sunset - full island circuit by motorbike",
      "Genuine fishing island character - no resorts, working community, local food from boats",
    ],
    thingsToKnow: {
      crowds: "Peak season April-June. Weekends see price spikes at homestays - check rates carefully before booking. The island has limited total bed count; book ahead in peak season.",
      difficulty: "Easy island circuit by motorbike. Some sites like Núi Cao Cát involve walking. Diving can be tiring - schedule land activities first.",
      safety: "Foreign visitors must carry original passport and valid visa - border guard checks at the pier. Some cross-island roads have no lighting at night. Sep-Nov typhoon season: sailings frequently cancelled, risk of being stranded.",
      ...
      seasonal: "Mar-Aug: dry season, calm seas, best diving visibility - peak season. Apr-Jun: ideal conditions, warmest water. Sep-Nov: typhoon season, sailings frequently cancelled, avoid. Dec-Feb: transitional, some rough crossings.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Phú Quý from Phan Thiết?",
        answer: "High-speed ferry from Phan Thiết port - three operators: Superdong, Phú Quý Express, Hưng Phát. Crossing 2.5-3.5 hours, fares 250,000-400,000 VND. Only 1-2 sailings per day; book ahead. Phú Quý Express is the only operator with sleeping berths - useful if you're prone to seasickness.",
      },
      {
        question: "Can foreign visitors join all tours on Phú Quý?",
        answer: "No - foreign visitors are not permitted on the Hòn Tranh boat tour. Coral diving and land-based sightseeing are open to everyone. Carry your original passport and valid visa at all times; border guard checks happen at the pier.",
      },
      {
        question: "What is the best itinerary for 2 nights?",
        answer: "Day 1: Dốc Phượt, cột cờ (flag tower), Khe Sung Sướng, Hồ Bánh Xe, sunset at Bãi Tắm Bưu Điện. Day 2: Hòn Tranh boat tour (Vietnamese visitors; morning 7-11 AM or afternoon 14:30-17:00), then Đấu Trường La Mã, Núi Cao Cát, wind turbines, sunset at Cây Cô Đơn and Kè Bãi Lăng. Schedule diving after land activities - it's tiring.",
      },
      {
        question: "Is coral diving worth it on Phú Quý?",
        answer: "Yes - at around 250,000 VND including a guide, filming, and photography, it's exceptional value. The reefs around Phú Quý are in better condition than almost anywhere on the mainland Vietnamese coast. Schedule it after energy-intensive land activities like Núi Cao Cát.",
      },
      {
        question: "When should I avoid visiting Phú Quý?",
        answer: "September to November - typhoon season. Ferry sailings are frequently cancelled and there is a real risk of being stranded on the island. The dry season March to August gives the most reliable crossing conditions.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the water clarity, the coral diving value, the genuine fishing island character, and the absence of resort development. The 2-day itinerary covering land and sea activities gets strong mentions.",
      negative: "Ferry crossings in rough conditions are unpleasant. Homestay prices spike unpredictably on weekends. Foreign visitors miss out on the Hòn Tranh tour. The night shellfish-catching tours are widely considered poor value.",
    },
  },
}
