...
export const muongHoaValley: Location = {
  ...
  insights: {
    highlights: [
      "Vietnam's largest rice terrace system - 2,200+ hectares changing colour across four distinct seasons",
      "Ancient Rock Field (Bãi Đá Cổ): nearly 200 carved megalithic stones dating back thousands of years - national monument",
      "Lao Chải (Black H'Mông) and Tả Van (Giáy) villages with distinct cultures, textiles, and homestay options",
      "Muong Hoa Stream: 15km through the valley, bamboo bridge near Tả Van is the most photogenic stretch",
    ],
    thingsToKnow: {
      crowds: "Peak season late Aug-Sep brings significant crowds, especially weekends. Tả Van and Lao Chải are quieter than the trailheads. Overnight stays give access to the valley before day visitors arrive.",
      difficulty: "Moderate - relatively flat valley floor, some climbing between villages. Slippery and muddy in wet season (Jun-Jul especially). Good trekking shoes essential.",
      safety: "Trails have no signs in places - a local guide is helpful for first-timers. Wet season trails are genuinely slippery. Ask permission before photographing villagers.",
      accessibility: "Ticket checkpoint: 150,000 VND adults, 100,000 VND children 6-12, free under 6. Motorbike, xe ôm, or mountain train from Sa Pa. Not suitable for wheelchairs or strollers.",
      seasonal: "Late Aug-mid Sep: golden harvest - peak season, most photogenic, book early. Mar-May: flooded terraces, mirror reflections. Jun-Jul: heavy rain, muddy trails - avoid. Dec-Feb: winter mist, possible frost/snow.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "When is the best time to visit Muong Hoa Valley?",
        answer: "Late August to mid-September for golden harvest - the whole valley turns gold and this is peak season. March to May for flooded terraces that reflect the sky like mirrors. December to February for misty winter atmosphere and occasional frost or snow. Avoid June-July heavy rain when trails are slippery and muddy.",
      },
      {
        question: "How long does the trek take?",
        answer: "The classic Cat Cat to Tả Van route covers about 10km and takes 4-5 hours with stops. The Lao Chải to Tả Van section alone is 2-3 hours. A full 15km valley traverse is a full day. Many visitors combine trekking one way with motorbike or xe ôm transport the other.",
      },
      {
        question: "Is a guide necessary?",
        answer: "Not essential but helpful for first-timers - the trail has unmarked junctions and a local guide adds cultural context to the H'Mông and Giáy villages. Guides also help navigate vendor interactions in the busier sections. For experienced trekkers with good navigation, the main route is manageable independently.",
      },
      {
        question: "What is the Ancient Rock Field?",
        answer: "Bãi Đá Cổ Mường Hoa - a field of nearly 200 carved megalithic stones near Hậu Thào with mysterious engravings believed to be thousands of years old. Recognised as a Vietnamese national monument. Often skipped by day visitors but worth the stop - one of the most unusual archaeological sites in the northern highlands.",
      },
    ],
    sentiment: {
      positive: "Overwhelmingly praised for the rice terrace scenery, the homestay overnight experience, the cultural variety of the four ethnic groups, and the Ancient Rock Field. Visitors who stay overnight consistently rate it higher than day trippers.",
      negative: "Vendors can be persistent in the busier sections near the trailheads. Peak harvest season brings significant crowds. Fog and mist in winter months can obscure views - weather-dependent experience.",
    },
  },
}
