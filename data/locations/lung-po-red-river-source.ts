...
export const lungPo: Location = {
  ...
  type: ["monument", "river", "nature", "cultural"],
  ...
  insights: {
    highlights: [
      "Border marker 92 - where the Red River first enters Vietnam, one of the two rivers that built Vietnamese civilization",
      "Two-colour water visible at the confluence: clear green Lũng Pô stream meets red-brown Red River from Yunnan",
      "31.43m flagpole (2017) with 125 spiral steps - panoramic view of the river valley and border mountains",
      "March kapok bloom: riverbanks turn vivid red with flowering kapok trees",
    ],
    thingsToKnow: {
      crowds: "Quiet and largely undeveloped. More visited by domestic Vietnamese travelers than foreign visitors. Busier during March kapok season.",
      difficulty: "Easy - flat walking around the site, 125 steps to flagpole summit. Road to site is fully paved and runs along the Red River.",
      safety: "GPS signal can drop near the border - download offline maps before visiting. Border zone with military presence; stay on marked paths.",
      accessibility: "Accessible by car or motorbike. Road runs along the Red River - scenic the whole way. Allow 30-45 minutes at the site. No facilities on site - bring water and food. Overnight in Y Tý or Bát Xát town.",
      seasonal: "Mar: kapok bloom, most photogenic. Sep-Nov: clearest skies, best visibility from flagpole. Year-round accessible on paved road.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Why is Lũng Pô significant?",
        answer: "It's where the Red River first enters Vietnam from China at border marker 92. The Red River - alongside the Mekong - is one of the two rivers that built Vietnamese civilization and fed the wet rice culture of the north for thousands of years. Standing here is standing at the upstream origin of that entire story.",
      },
      {
        question: "What is the two-colour water effect?",
        answer: "At the confluence of the Lũng Pô stream and the Red River, the two water bodies remain visibly distinct: the clear green local stream on one side and the red-brown silt-laden Red River arriving from Yunnan on the other. The contrast is visible to the naked eye on calm days.",
      },
      {
        question: "What is the best route to Lũng Pô?",
        answer: "Via ĐT.156 from Lào Cai city - well-maintained road following the Red River through scenic gorges, about 70km and 2-3 hours. The Y Tý approach has steeper rougher sections, better for high-clearance vehicles. Both routes are doable but ĐT.156 is the easier option.",
      },
      {
        question: "When should I visit for the kapok bloom?",
        answer: "March - kapok trees along the Red River banks burst into vivid red flowers, mirroring the colour of the river. One of northern Vietnam's most striking seasonal landscapes. Check road conditions before visiting as late-season weather can affect mountain roads.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the geographic and symbolic significance, the two-colour water effect, the flagpole views, and the emotional resonance for Vietnamese visitors. The March kapok season draws strong photography praise.",
      negative: "GPS signal loss frustrates independent navigation. Limited facilities. Y Tý approach road has poor sections.",
    },
  },
}
