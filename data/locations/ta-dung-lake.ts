...
export const taDungLake: Location = {
  ...
  tags: ["⛵ Island-Dotted Lake", "🌲 National Park", "🛶 Kayaking & SUP", "📸 Photography"],
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775885115038!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRDJscVhrb2dF!2m2!1d11.85283988458472!2d107.9323813636419!3f13.470270975304077!4f-34.265321683818236!5f0.7820865974627469" },
  heroImage: heroUrl("ta-dung-lake3_jk0xko"),
  gallery: [
    "ta-dung-lake5_qmer1f",
    "ta-dung-lake1_iohfui",
    "ta-dung-lake8_jpsbtm",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "47+ forested islands - the hilltops of submerged terrain from the hydroelectric dam flooding, original highland forest still intact",
      "Sea of clouds at 5-6 AM during rainy season (Jun-Nov) - one of the most unusual atmospheric effects in the Central Highlands",
      "Dry season: bleached submerged tree trunks emerge above the waterline - eerie and photogenic",
      "SUP and kayaking between the islands - calm water, forested shoreline, 21-22°C year-round",
    ],
    thingsToKnow: {
      crowds: "Off the main tourist circuit. Quiet on weekdays. Growing in popularity with Vietnamese photographers and outdoor groups.",
      difficulty: "Easy lake activities (boat, SUP, kayak). Tà Đùng peak trek (1,600m) is more demanding - arrange guide through national park office.",
      safety: "Boat hire from established operators at the pier. Contact national park management before trekking into the forest.",
      accessibility: "250km from Saigon (~6-7 hours). Sleeper buses to Gia Nghĩa then motorbike rental. Book homestay with lake view for early morning access.",
      seasonal: "Nov-Apr: dry season, blue skies, lower water level, submerged trees visible - best for photography. Jul-Oct: full water level, sea of clouds possible early morning. Year-round average 21-22°C.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Why does Tà Đùng Lake have islands?",
        answer: "The islands are the hilltops and ridges of terrain that was flooded when the Đồng Nai 3 hydroelectric dam was built. The forest on them is original highland forest that survived above the waterline. In the dry season, you can also see bleached tree trunks from the deeper submerged forest emerging above the surface.",
      },
      {
        question: "When is the best time to visit?",
        answer: "Two distinct windows: November to April (dry season) for blue skies, clear water, and the eerie submerged tree trunks - best for photography. July to October (rainy season) for the lake at full level and the possibility of sea of clouds at 5-6 AM. Year-round temperature is a cool 21-22°C.",
      },
      {
        question: "How do I get from Saigon to Tà Đùng?",
        answer: "About 250km, 6-7 hours. Two road options: via Bình Dương/Bình Phước/QL14 to Gia Nghĩa, or via Long Thành - Dầu Giây expressway → QL20 → QL28 through Bảo Lộc. Sleeper buses to Gia Nghĩa: Đại Nghĩa (0978 719 989) or Thùy Linh (1900 888 684), ~7 hours. Rent a motorbike from Gia Nghĩa.",
      },
      {
        question: "What activities are available?",
        answer: "SUP and kayaking between the islands, boat tours, island camping (permit from national park), Tà Đùng peak trek (1,600m - contact national park), and Thác Ông Voi waterfall nearby. Best photography window is 6-7 AM.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the unusual island landscape, the early morning mist and cloud effects, the cool highland temperature, and the genuine remoteness compared to more developed Central Highlands destinations.",
      negative: "Remote access requires motorbike from Gia Nghĩa. Limited tourist infrastructure. Sea of clouds not guaranteed. Rainy season weather can obstruct views.",
    },
  },
}
