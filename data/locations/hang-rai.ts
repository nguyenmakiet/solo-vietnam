...
export const hangRai: Location = {
  ...
  tags: ["🪨 Ancient Coral Rock Formations", "🌅 Sunset Views", "🌊 Wild Coast", "📸 Photography"],
  ...
  gallery: [
    ...
    "hang-rai-ninh-thuan3_ewljxb",
    "hang-rai-ninh-thuan_ssmgfx",
    "hang-rai-ninh-thuan6_yvxdjt",
    "hang-rai-ninh-thuan8_dlnllq",
    "hang-rai-ninh-thuan9_mr5xiz",
    "hang-rai-ninh-thuan10_xiwrli",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Ancient coral reef formations thousands of years old - exposed by shifting sea levels, shaped by centuries of waves into platforms, arches, and tide pools",
      "Waves crashing onto flat rock create waterfall-like white water cascades across the stone surface",
      "Exceptional sunset colours - the volcanic and coral rock turns deep red and purple in late afternoon light",
    ],
    thingsToKnow: {
      crowds: "Relatively quiet by Vietnamese coastal standards. Early morning and late afternoon are least busy. Avoid peak domestic holiday periods.",
      difficulty: "Uneven and sharp rock surfaces require careful footing and reef shoes. No technical difficulty but physical awareness needed on the platforms.",
      safety: "Ancient coral rock is sharp and jagged throughout - proper footwear essential, not sandals. Do not approach the formations during rough sea conditions. Sun exposure is extremely intense - full sun protection required. No shade on the rock platforms.",
      accessibility: "Electric cart available from entrance (20,000 VND round trip). Rock platforms are not accessible for limited mobility visitors.",
      seasonal: "Jan-Aug: dry season, calm seas, best conditions. Sep-Dec: monsoon season, rough seas, avoid. Sun is intense year-round on this coastline.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What is the entrance fee?", answer: "40,000 VND entrance fee. Electric cart from the main gate to the viewing area costs 10,000 VND round trip - the cart covers 1km so it's worth taking. Best visited at sunrise (5–6 AM) or late afternoon (4–6 PM) to avoid extreme midday heat." },
      { question: "How do I get to Hang Rai from Phan Rang?", answer: "Take Provincial Road 702 approximately 35km northeast from Phan Rang - Tháp Chàm city centre. By motorbike, about 45-50 minutes. The road is scenic with coastal views along the way. Hang Rai is on the same route as Vĩnh Hy Bay - most visitors combine both in a single day." },
      { question: "What is the best time to visit?", answer: "January to August for dry season and calm seas. Visit at low tide to access the rock platforms fully, and stay for sunset when the formations turn red and purple. Avoid September to December when monsoon conditions make the coastline rough and the site significantly less appealing." },
    ],
    sentiment: {
      positive: "Consistently praised for the raw, dramatic coastal scenery and the quality of light at sunset. The ancient coral formations are frequently described as unlike anything else on Vietnam's south coast.",
      negative: "Limited facilities on site. Requires careful timing - wrong season or wrong tide and the experience is significantly diminished. Sharp rocks throughout require appropriate footwear.",
    },
  },
}
