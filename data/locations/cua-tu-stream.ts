...
export const cuaTuStream: Location = {
  ...
  tags: ["🏞️ 9-Gate Stream", "🏊 Natural Pools", "🏕️ Camping", "🌿 Forest Trek"],
  ...
  insights: {
    highlights: [
      "Trek through primary forest to 9 natural stream gates - jump the waterfall and slide the rock chute at Gate 3",
      "Two large natural swimming pools on the streamside route with clear green water - wide enough for proper swimming",
      "Camp overnight at Gate 7 for the full 2-day wilderness experience (bring leech repellent for Gates 5-7)",
    ],
    thingsToKnow: {
      crowds: "Weekdays are quiet; weekends draw groups from Hanoi but the stream is long enough that it never feels crowded",
      difficulty: "Moderate - 1.5 hours trekking to Gate 3, mostly through forest and along streambed; wet rocks require care. Upper section to Gate 7 is harder.",
      safety: "Leeches present from Gate 5 upward - wear long socks and bring salt or repellent. Flash flood risk during heavy rain - do not enter the stream when upstream weather is uncertain. Since 2024 floods, beyond Gate 7 is not accessible.",
      accessibility: "Not suitable for visitors with limited mobility - the route involves stream crossings, uneven terrain, and wet rocks throughout",
      seasonal: "Best Apr-Oct for swimming; dry season (Nov-Mar) the stream is lower and some pools are too shallow to swim. Avoid during active typhoon or heavy rain warnings.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How many gates can you reach?",
        answer: "Since the 2024 flash floods, the accessible limit is Gate 7. The stream originally has 9 gates but the upper section beyond Gate 7 is not currently passable. For a 1-day trip, Gate 3 is the standard target. Gate 7 requires an overnight camp.",
      },
      {
        question: "Are there leeches?",
        answer: "Gates 1-3: no leeches. Gates 5, 6, and 7: leeches present, particularly after rain or in wet conditions. Wear long socks, tuck trousers in, and bring salt or leech repellent if going beyond Gate 3.",
      },
      {
        question: "Is there a fee and parking?",
        answer: "Gate 1 charges 10,000 VND entry. An environmental cleaning fee may also apply. Parking at the trailhead carpark costs 50,000 VND/vehicle. The forest route (đường rừng) bypasses Gate 1 and avoids the entry fee.",
      },
      {
        question: "Should I hire a porter?",
        answer: "For first-time visitors, hiring a porter is strongly recommended - they carry gear, guide the route, and provide real safety support on the more technical sections. Ask at the trailhead or book through a local tour operator.",
      },
    ],
    sentiment: {
      positive: "Consistently praised as one of the best accessible wilderness day trips from Hanoi - the natural pools, waterfall jumps at Gate 3, and primary forest setting deliver a genuine outdoor experience at low cost. Return visitors note the stream rewards repeat trips as you learn the terrain. Post-2024 flood improvements (concrete road, parking, environmental fee) have made access easier.",
      negative: "Leech presence in the upper section puts some visitors off. Dogs along the approach road are noted as intimidating by some. Litter left by previous campers visible on the banks despite being one of the cleaner streams near Hanoi. Dry season water levels can be low. Peak summer crowds at Gate 3.",
    },
  },
}
