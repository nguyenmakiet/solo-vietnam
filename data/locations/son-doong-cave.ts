...
export const sonDoongCave: Location = {
  ...
  insights: {
    highlights: [
      "World's largest cave by volume - some chambers fit a 40-story skyscraper",
      "Underground jungle ecosystem with sunlight entering through two ceiling dolines",
      "Multi-day expedition with cave camping, river crossings, and 90-metre internal wall climb",
    ],
    thingsToKnow: {
      crowds: "Annual quota of approximately 1,000 visitors total. Groups capped at 10 people. As of 2026, fully booked through 2028",
    ...
    faq: [
      { question: "Who can visit Sơn Đoòng?", answer: "Anyone who meets the fitness requirements and can secure a slot through Oxalis Adventure. The benchmark is runners comfortable at 5-10km daily, half-marathon finishers under 7 hours, or people who've completed multi-day treks like Fansipan trail route or Bạch Mộc Lương Tử without issues. Safety assistants help on technical sections - it's demanding but not technical mountaineering" },
      { question: "How much does it cost and when can I book?", answer: "Current price is approximately 3,000 USD per person, all-inclusive. A price increase to 15,000 USD is under discussion - check oxalisadventure.com for current rates. As of 2026, all slots are booked through 2028. New slots open annually, typically in September, and sell out within hours" },
      { question: "What makes each season different inside the cave?", answer: "Jan–Mar: cool air, sunlight shafts penetrate deepest, minimal interior mist - best for photography. Apr–May: mild temperatures, butterfly swarms on the trek, sunlight hits the wedding cake formation. Jun–Aug: clouds drift through chambers at eye level, underground river is swimmable, possible boat section on day 4. The cave interior stays 18-23°C year-round regardless of outside temperature" },
    ],
    sentiment: {
      positive: "Consistently described as the most extraordinary natural experience participants have had anywhere in the world. Oxalis's organisation and support team receive strong praise. The scale of the cave - clouds forming at eye level, jungles growing underground, chambers that make humans feel genuinely small - is what most visitors lead with when describing it",
      negative: "Price and exclusivity generate ongoing controversy - the tour is inaccessible to most Vietnamese nationals and a significant portion of international travellers. The proposed increase to 15,000 USD has intensified this debate. Waitlist situation means planning must begin years in advance",
    },
  },
}
