...
export const dauTiengLake: Location = {
  ...
  gallery: [
    ...
    "dau-tieng-lake-binh-duong-10_nkk3js",
    "dau-tieng-lake-binh-duong-9_gjkdmf",
    "dau-tieng-lake-binh-duong_p1gvzd",
    "dau-tieng-lake-binh-duong-8_nymwyj",
    "dau-tieng-lake-binh-duong-7_t3ro5c",
    "dau-tieng-lake-binh-duong-6_vmwxce",
    "dau-tieng-lake-binh-duong-2_hfuja7",
    "dau-tieng-lake-binh-duong-3_wuesz3",
  ],
  seoDescription:
    "Dầu Tiếng Lake is the largest artificial reservoir in Vietnam - a 270km² expanse of water on the Tây Ninh and Bình Dương border, surrounded by forest and used for irrigation, with sunrise photography, lakeside cycling, and the nearby Chùa Thái Sơn temple on Núi Cậu among the main visitor draws.",
  tips: [
    "Sunrise from the lake dam or the forested eastern shore is the signature photography experience - arrive before 5:30AM to set up before the light",
    "Time needed: Typically 1 night or 2 nights for a camping trip; a half-day is enough for a sunrise/photography-only visit",
    "The perimeter road around the lake is long enough for a full cycling day - rent a bicycle in Dầu Tiếng town and follow the dam road and forest tracks",
    "Camping on the lakeside is popular with groups from HCMC - bring all supplies as there are no facilities at the camping spots",
    "There's no lifeguard presence anywhere around the lake - swimming isn't recommended, and if you do go in, stay in shallow water close to shore and never swim alone; the lakebed also has sharp shells in places, so water shoes help",
    "If arriving by motorbike to camp overnight, park at a local household near the lake rather than leaving it unattended - theft has been reported at night in this relatively remote area",
    "Arrive by around 2-3 PM if you want a good camping spot directly on the shore - by 5 PM, only spots further back from the water tend to be left",
    "The dam periodically releases water (mostly Oct-Dec) to manage flow into the Saigon River, with releases announced only 1-2 days ahead and no fixed schedule - check locally before camping close to the shoreline during this window",
    "Phone signal around the lake is weak - register any data package you'll need before you leave home, since it's difficult to do once you're there",
    "Bring cash and ID - card and e-wallet payments aren't generally accepted locally, and some activities may ask to see identification",
    "The lake is roughly 70-85km from HCMC depending on the specific access point and source - easily combined with a Tây Ninh day that includes the Cao Đài Temple in Tây Ninh city and Núi Bà Đen",
    "Chùa Thái Sơn, a well-known temple on Núi Cậu right by the lake's Bình Dương shore, is a popular add-on for anyone interested in a spiritual/cultural stop alongside the lake scenery",
  ...
  insights: {
    highlights: [
      "Vietnam's largest artificial freshwater lake, spanning roughly 270 square kilometres (27,000 hectares) across the Tây Ninh-Bình Dương border",
      "A peaceful weekend escape from Ho Chi Minh City, paired with the Núi Cậu hills and Chùa Thái Sơn temple nearby",
      "A diverse forested landscape well suited to camping, cycling, and photography",
    ],
    thingsToKnow: {
      crowds: "Quiet and peaceful, especially suitable for weekend relaxation away from city crowds",
      difficulty: null,
      safety: "There is no lifeguard presence around the lake, so swimming isn't recommended - if you do go in, stick to shallow water close to shore. Petty theft of unattended motorbikes has been reported at night; park with a local household if camping overnight rather than leaving vehicles unwatched.",
      accessibility: "Limited facilities nearby; few shops or eating places directly around the lake shore itself",
      seasonal: "Water levels swing a lot with the season: roughly December-April is the low-water period, when more shoreline is exposed and camping spots are easiest to find; roughly August-October is the flood season, when water levels rise and good camping spots become scarce. Mid-June is often cited as a sweet spot - decent water levels, breezy weather, and still relatively easy to find a good spot. Best camping time in general is evening to morning; avoid midday visits due to extreme heat.",
    },
    visitorTips: [
      ...
      "Visit Chùa Thái Sơn on Núi Cậu for a nearby cultural and sightseeing stop",
    ],
    faq: [
      { question: "What is the best time to visit?", answer: "Best for camping and photography from evening through early morning. Avoid midday, when temperatures are extreme and shelter options are limited." },
      { question: "Are there facilities and restaurants at the lake?", answer: "Amenities directly at the lakeshore are limited - few shops or eating places nearby, though Dầu Tiếng town has restaurants, including some serving freshwater fish from the reservoir. Bring supplies if camping." },
      { question: "How far is it from Ho Chi Minh City?", answer: "Roughly 70-85km, depending on the exact access point - a manageable day trip or overnight destination at around 1.5-2 hours by motorbike or car." },
      { question: "Is it safe to swim in the lake?", answer: "There's no lifeguard presence anywhere around the lake, so swimming isn't officially recommended. If you do go in, stay in shallow water close to shore, never swim alone, and watch for sharp shells on the lakebed." },
    ],
    sentiment: {
      positive: "Visitors praise its peaceful atmosphere, natural beauty, and suitability for stress relief, camping, and outdoor activities.",
      negative: "Poor road conditions in places and a lack of facilities directly around the lake are common concerns.",
    },
  },
}
