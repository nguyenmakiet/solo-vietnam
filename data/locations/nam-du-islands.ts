...
export const namDuIslands: Location = {
  ...
  categories: [],
  experiences: ["beaches", "snorkeling", "boat-tours", "photography", "camping", "cycling"],
  ...
  tips: [
    "Nam Du consists of 21 islands - the main island (Hòn Lớn) has the pier, guesthouses, and most of the permanent population; the outer islands are accessed by chartered boat and some are completely uninhabited",
    "The crossing from Rạch Giá to Nam Du takes 2.5 - 3 hours by high-speed ferry - check the latest schedule carefully as services are reduced in the wet season (Jun - Oct) when seas are rough",
    "Renting a boat on the main island for a half-day island-hopping circuit is the best way to reach the outer islands with clearer water and better snorkeling than near the main pier",
    "Accommodation on the main island ranges from basic guesthouses to a few newer bungalow-style options - book ahead for the December to April peak as the island has limited beds total",
    "Nam Du is significantly further from the mainland than Phú Quốc or Hòn Sơn - factor in the 3-hour crossing both ways when planning and consider a minimum 2-3 nights rather than a rushed day trip",
  ],
  content: {
    intro:
