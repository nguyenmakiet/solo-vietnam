...
export const namDuIslands: Location = {
  ...
  heroImage: heroUrl("nam-du-island-kien-giang_ugjkkf"),
  gallery: [
    "nam-du-island-kien-giang-10_rwppjq",
    "nam-du-island-kien-giang_ugjkkf",
    "nam-du-island-kien-giang-2_c621za",
    "nam-du-island-kien-giang-9_qbwqqs",
    "nam-du-island-kien-giang-1_vmud11",
    "nam-du-island-kien-giang-7_dqalt7",
    "nam-du-island-kien-giang-5_f3rqz9",
    "nam-du-island-kien-giang-13_gxb6ie",
    "nam-du-island-kien-giang-8_di9ljn",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Bãi Cây Mến - the most famous beach on Nam Du, must-visit on the main island",
      "3-island boat tour (Hòn Mấu, Hòn Dầu, Hòn Hai Bờ Đập) - 350,000 VND/person, full day, outer island snorkeling",
      "Dốc Ân Tình (lighthouse road) - best at sunrise or for sunset views",
      "Practical alternative to Phú Quốc: closer from Rạch Giá, cheaper, less crowded, still genuinely island in character",
    ],
    thingsToKnow: {
      crowds: "Weekends sell out fast - ferry tickets and accommodation both. Weekdays noticeably quieter. Dec-Apr is peak dry season.",
      difficulty: "Easy main island circuit by motorbike. Outer island boat tour is a full day on the water - bring sun protection and seasickness medication if needed.",
      safety: "Carry CCCD or passport - ID checks at pier. Bring cash - no reliable ATMs. Jul-Sep rough season: ferries can be suspended 1-3 days, risk of being stranded. No national power grid - generator cuts common around 6-7 AM.",
      accessibility: "Motorbike rental 100,000-150,000 VND/day from guesthouses. Ferry from Rạch Giá ~2 hours, 210,000 VND one way. Book tickets online through operator websites in advance.",
      seasonal: "Nov-May: dry season, calm seas, clear water, best for outer islands and snorkeling. Jul-Sep: rough season, heavy rain, ferry suspensions possible - risk of being stranded 1-3 days.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Nam Du from Ho Chi Minh City?",
        answer: "Take an 11 PM overnight bus to Rạch Giá (arrives ~4 AM), then transfer to the ferry pier (~30 minutes). Ferry operators: Phú Quốc Express, Superdong, Ngọc Thành, Hoa Binh Ship. Book online. Crossing ~2 hours, 210,000 VND one way. 1-2 sailings per day - book ahead, weekends sell out.",
      },
      {
        question: "How long should I spend on Nam Du?",
        answer: "2 days 1 night (2N1Đ) for a relaxed stay focused on the main island. 3 days 2 nights (3N2Đ) to include the outer island boat tour (Hòn Mấu, Hòn Dầu, Hòn Hai Bờ Đập - 350,000 VND/person, full day). The outer island tour is what distinguishes the longer trip and is the water highlight of Nam Du.",
      },
      {
        question: "Is Nam Du better than Phú Quốc?",
      ...
      {
        question: "Can I get stranded on Nam Du?",
        answer: "Yes - July to September rough season brings heavy rain and rough seas that can suspend ferry services for 1-3 days. If visiting outside the dry season (Nov-May), build contingency days into your itinerary. This is a genuine risk, not a rare edge case.",
      },
      {
        question: "Does Nam Du have electricity?",
        answer: "Nam Du has no national power grid - electricity runs on generators. Power cuts are common, typically around 6-7 AM. Bring a portable charger and set expectations accordingly.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for clear water, fresh affordable seafood, the outer island boat tour, and the genuine island atmosphere compared to the overcrowded alternatives. Vietnamese visitors in particular appreciate the Phú Quốc alternative angle.",
      negative: "Generator power cuts. Some beaches have garbage accumulation. Ferry scheduling is limited and rough season stranding is a real risk. Tourism development is uneven - some newer services lack quality consistency.",
    },
  },
}
