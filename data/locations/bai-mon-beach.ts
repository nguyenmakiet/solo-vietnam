...
export const baiMonBeach: Location = {
  ...
  experiences: ["beach", "photography", "trekking", "camping"],
  ...
  gallery: [
    ...
    "mon-beach-phu-yen-5_mffwex",
    "mon-beach-phu-yen-3_v3exiu",
    "mon-beach-phu-yen-4_mzenmj",
    "mon-beach-phu-yen_imxizr",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "One of the first places on mainland Vietnam to receive sunrise (alongside Mũi Đôi - the debate is unresolved) - theatrical morning light directly in front of the beach",
      "Freshwater stream crossing the beach year-round - practical for rinsing, unusual for a coastal beach",
      "Sheltered between two headlands - calmer water than the open coast even in rough conditions",
      "Camping overnight + sunrise: the best version of this beach, before any day visitors arrive",
    ],
    thingsToKnow: {
      crowds: "Quiet on weekdays. Busier on weekends but still far less crowded than nearby coastal beaches. Most visitors combine with Mũi Điện lighthouse.",
      difficulty: "20-minute trail descent from lighthouse road. Path from Mũi Điện lighthouse also available. Steep in places - wear grip shoes.",
      safety: "Beach slopes steeply into deeper water. Local residents warn about rip currents - swimming is possible but stay close to shore. Non-swimmers should stay in the shallows. Very hot and exposed - no shade on main beach.",
      accessibility: "Entrance fee 30,000 VND. No food or water on site - bring everything from Đại Lãnh (8km). Some tree shade at far left corner of beach.",
      seasonal: "Jan-Aug: dry season, best for sunrise and swimming. Sep-Dec: rainy season, shorter duration than most of central Vietnam but conditions less reliable.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Can I swim at Bãi Môn?",
        answer: "Yes, but with caution. The beach slopes steeply into deeper water and local residents warn about rip currents - stay close to shore and don't swim far out. Non-swimmers should stay in the shallows near the stream outlet where the water is shallowest.",
      },
      {
        question: "What is the entrance fee?",
        answer: "30,000 VND per person.",
      },
      {
        question: "How do I get to Bãi Môn from Mũi Điện lighthouse?",
        answer: "There is a path leading directly down from the lighthouse compound to the beach - look for the trail signs on the way down. Takes about 15-20 minutes on foot. Alternatively, the trail from the lighthouse road junction also descends to the beach.",
      },
      {
        question: "Is camping allowed at Bãi Môn?",
        answer: "Yes - camping on the beach is possible and recommended for the sunrise experience. The beach has a freshwater stream running year-round for water needs. No facilities otherwise - bring tent, food, and supplies from Đại Lãnh village. The beach is quiet and safe overnight.",
      },
      {
        question: "Is Bãi Môn worth visiting on its own?",
        answer: "It's a solid beach - clean, uncrowded, good light - but honest assessment is around 7/10 as a standalone. It becomes genuinely special combined with the Mũi Điện lighthouse visit (110m views) and an overnight camp for sunrise. The sum is much better than the parts.",
      },
    ],
    sentiment: {
      positive: "Praised for the pristine condition, the freshwater stream, the sunrise experience, and the seclusion. Visitors who camp overnight consistently rate it higher than day visitors.",
      negative: "Very hot and exposed with no shade on the main beach. Steep beach profile and rip current warnings limit swimming confidence. No facilities mean full self-sufficiency required.",
    },
  },
}
