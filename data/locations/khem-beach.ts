...
export const khemBeach: Location = {
  ...
  insights: {
    ...
    thingsToKnow: {
      ...
      difficulty: "Flat easy beach access. The road down from An Thới is steep - take care on motorbike.",
      safety: "Lifeguards present in the resort section. During northeast monsoon (Nov-Mar) waves can be strong - check conditions before swimming. Some reports of security guards restricting access near resort boundaries.",
      accessibility: "Easy flat beach access. Paid bathrooms available (10,000 VND). Motorbike parking nearby.",
      seasonal: "Critical: Khem faces southeast. Best May-Sep (sheltered from southwest monsoon, calm clear water). Worst Nov-Mar (northeast monsoon brings rough surf, murky water, floating debris). This is the opposite of most Phú Quốc beaches.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Why is Khem Beach best in summer when most Phú Quốc beaches are best in winter?",
        answer: "Khem faces southeast, so it is sheltered from the southwest monsoon wind (May-September) that affects west-coast beaches. In contrast, the northeast monsoon (November-March) - which brings calm conditions to the west coast - hits Khem directly, causing rough surf, murky water, and debris. Plan accordingly.",
      },
      {
        question: "Is there a public section or is it all resort?",
        answer: "The northern end of the beach is public with no facilities. The southern section has resort infrastructure - sunbeds (100,000-150,000 VND per 4 hours, some free with food purchase), paid bathrooms (10,000 VND), towel rental (20,000 VND), and a beach bar. Both sections share the same sand and water quality.",
      },
      {
        question: "What time should I arrive?",
        answer: "Before 8 AM for the quietest experience and to secure a free sunbed if you want one. By 10 AM the resort section is significantly more crowded and free sunbeds are taken. Early morning also gives the best sunrise light on this southeast-facing beach.",
      },
    ],
    sentiment: {
      positive: "When visited in the right season, consistently rated one of Phú Quốc's best beaches - white sand, clear turquoise water, and a long stretch that feels less commercialised than Long Beach. The sunrise views are excellent.",
      negative: "November-March visitors frequently disappointed by murky water and debris. Crowding during peak hours frustrates visitors expecting a quiet beach. High restaurant prices and limited public facilities on the free section.",
    },
  },
}
