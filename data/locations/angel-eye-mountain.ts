...
export const angelEyeMountain: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775376442490!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQ2ZoNWFWNmdF!2m2!1d22.77592101393509!2d106.3126008888133!3f327.52512246819725!4f-2.105237062035286!5f0.7820865974627469",},
  heroImage: heroUrl("angle-eye-mountain-cao-bang-3_hy3dnf"),
  gallery: [
    "angle-eye-mountain-cao-bang-2_uun2lk",
    "angle-eye-mountain-cao-bang-3_hy3dnf",
    "angle-eye-mountain-cao-bang_phpawb",
  ],
  seoDescription:
  ...
  tips: [
    ...
    "Camping overnight on the flat meadow at the mountain base gives a view of the hole silhouetted against the night sky - local providers offer tent rental and meals for around US$30/person",
    "Pack a basic first-aid kit, a flashlight, and ideally a map or compass if you're planning to trek beyond the short climb to the opening - mobile reception is patchy in parts of the valley and it's easy to lose the trail on the longer summit route",
    "In the rainy season, SUP paddleboarding around the flooded valley is a popular alternative to walking - the still water reflects the mountain and grass in a way that's genuinely photogenic",
    "Nearby Nậm Trá Waterfall and Bản Danh hamlet - with its traditional Tày stilt houses roofed in yin-yang tiles and stone fences around the rice and corn fields - are worth combining with the mountain visit if you have an extra hour or two. The waterfall is at its fullest and most striking earlier in the rainy season (roughly April-July); by the dry season it runs dry and is replaced by grassland",
    "Try local specialties while you're in the area: xôi trứng kiến (ant-egg sticky rice), hạt dẻ (chestnuts), gà đồi (free-range hill chicken), and thạch đen (grass jelly) are all regional dishes worth seeking out",
  ...
  insights: {
    highlights: [
      ...
      "Seasonally transforms from a flooded karst lake into an open meadow, offering two completely different landscapes across the year",
    ...
    thingsToKnow: {
      ...
      difficulty: "The final approach is an easy 1.5-3km walk across flat meadows and stone paths. Reaching the mountain opening requires an additional short but steeper climb (about 15-20 minutes). Good footwear helps on the uneven, rocky sections.",
      safety: null,
      accessibility: "No tickets or official entrance. Motorbikes can usually reach close to the meadow in dry weather, though many visitors prefer parking earlier and walking the final section. The last stretch can be steep in places.",
      seasonal: "Water lake present in wet season (roughly April-August); dry and meadow-like by autumn and winter, with a desert-like appearance in the driest months. Ground becomes slippery after rain, requiring good bike skills or walking instead",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is there water and a lake when I visit?", answer: "Water presence depends on season. The wet season (roughly April-August) has a full lake; by autumn and winter the valley dries out into meadow. Check before visiting if this matters to you." },
      ...
      { question: "Is it crowded and do I need to buy tickets?", answer: "Completely free with no entry fee or tickets. Still receives far fewer visitors than Bản Giốc Waterfall despite being one of Cao Bằng's most distinctive landscapes." },
      { question: "Can I climb through the hole in the mountain?", answer: "Yes. A short but fairly steep climb of around 15-20 minutes leads to the natural opening. The longer trek beyond to the summit viewpoint should only be attempted with a local guide." },
      { question: "Why is it called 'Angel Eye Mountain'?", answer: "The English name was coined by international geologists documenting the Non Nước Cao Bằng UNESCO Global Geopark. Locally it's known as Núi Mắt Thần or Núi Thủng, and in Tày as Phja Piót ('the mountain with a hole')." },
    ],
    sentiment: {
      ...
      negative: "Plastic pollution visible in some areas (local newspapers have covered this as an ongoing environmental concern); lake absence in dry season disappoints some visitors; rough road conditions and steep final descent challenging for some riders",
    },
  },
}
