...
export const phiLiengWaterfall: Location = {
  ...
  tags: ["💦 7-Tier Waterfall", "🌿 Remote Forest Trek", "🏍️ Motorbike Trail", "📸 Photography"],
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775399793857!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJRHF2Y3U4Snc.!2m2!1d11.94539053933752!2d108.069286883824!3f90.03123511814029!4f12.919219766983801!5f0.7820865974627469" },
  heroImage: heroUrl("phi-lieng-waterfall-lam-dong_vu9mdt"),
  gallery: [
    "phi-lieng-waterfall-lam-dong-5_hov4s4",
    "phi-lieng-waterfall-lam-dong_vu9mdt",
    "phi-lieng-waterfall-lam-dong-8_hswamn",
    "phi-lieng-waterfall-lam-dong-2_kzjdsy",
    "phi-lieng-waterfall-lam-dong-1_r2rnhb",
    "phi-lieng-waterfall-lam-dong-6_f28m4t",
    "phi-lieng-waterfall-lam-dong-3_l2vvjw",
    "phi-lieng-waterfall-lam-dong-4_ivyruz",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "7-tier waterfall dropping over 70m - nicknamed Tây Nguyên Đệ Nhất Thác (greatest waterfall of the Central Highlands)",
      "40-45 degree rope-assisted descent to the base - one of the most physically demanding waterfall approaches in Lâm Đồng",
      "Camping at the base or on the sandbar 1.2km downstream - cold forest air, fishing, complete isolation",
      "No phone signal inside - fully offline experience in intact Central Highlands forest",
    ],
    thingsToKnow: {
      crowds: "Almost no other visitors on weekdays. Mainly local people working in the forest. Genuinely remote - no tourist infrastructure.",
      difficulty: "Challenging. The descent to the base is 40-45 degrees with rope assistance, approximately 70m. Slippery in all seasons, extremely dangerous in rainy season when spray keeps the path wet year-round. Pack light - heavy bags increase fall risk significantly.",
      safety: "No phone signal inside forest - download offline maps before entering. Go in a group; hire a local guide if unfamiliar with forest navigation. Flash flood risk April-June if camping near the stream. Swimming: cold water year-round, afternoon only, life jacket required in the pool. Do not descend or ascend with a heavy pack.",
      accessibility: "80km from Đà Lạt, 2-2.5 hours by motorbike. Can park at forest protection station and walk 5km in. No facilities at the falls - bring all food, water, and equipment.",
      seasonal: "Late Nov-Apr: dry season, best for trekking and camping. Jun-Nov: rainy season, maximum water volume but extremely slippery descent and flash flood risk. Apr-Jun transition: especially dangerous for flash floods if camping.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How hard is the trek to Phi Liêng Waterfall?",
        answer: "The approach trail is moderate but the descent to the waterfall base is genuinely challenging - a 40-45 degree slope dropping about 70m with rope assistance. Slippery in dry season, extremely dangerous in rainy season when the falls' spray keeps the path permanently wet. Pack light; a heavy bag significantly increases fall risk. Take it slowly and don't rush the descent.",
      },
      {
        question: "Can I visit without a guide?",
        answer: "Technically yes, but not recommended without forest experience. The trail has multiple branching paths that are easy to confuse, there is no phone signal inside, and getting lost is a real possibility. If unfamiliar with forest navigation, hire a local guide from Đam Rông commune or arrange through local contacts in Đà Lạt.",
      },
      {
        question: "When is the best time to visit?",
        answer: "Late November to April - dry season, manageable trail conditions, streams crossable, campable base. Rainy season (Jun-Nov) gives the most dramatic water volume but the descent becomes extremely slippery and dangerous. April to June is the most dangerous period for camping due to flash flood risk from upstream rain.",
      },
      {
        question: "Can I camp at Phi Liêng?",
        answer: "Yes - flat ground at the waterfall base, or a larger sandbar island about 1.2km downstream. Dry season camping only; avoid April-June when upstream rain can cause sudden flash floods. Bring sleeping mat, blanket, warm clothes, and a heat source - nights at the base are cold. Fishing in the downstream pools is possible.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the scale and power of the waterfall, the genuine remoteness, and the camping experience at the base. Visitors who make the effort describe it as one of the most rewarding outdoor experiences in Lâm Đồng.",
      negative: "The descent is genuinely dangerous and has caused injuries. No phone signal creates real navigation challenges for independent visitors. Rainy season conditions are hazardous.",
    },
  },
}
