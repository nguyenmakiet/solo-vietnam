...
export const k50Waterfall: Location = {
  ...
  tags: ["💦 54m Waterfall", "🌿 Jungle Trek", "🏕️ Overnight Camp", "🦅 Swallow Cave", "📸 Photography"],
  bestTime: "Jan – Jun (dry season; trails safer, rivers lower, leeches somewhat less abundant)",
  bestMonths: [1, 2, 3, 4, 5, 6],
  entranceFee: "~100,000 VND park entry + guide fee 200,000–500,000 VND/group + motorbike transport 150,000 VND/person (2025)",
  ...
  insights: {
    ...
    thingsToKnow: {
      ...
      difficulty: "Demanding multi-day trek. 4-5 hours each way from drop-off point, river crossings, slippery jungle floor, leech exposure. Requires good fitness and comfort with remote wilderness. Overnight camp mandatory.",
      ...
      accessibility: "Not accessible for limited mobility. Multi-day jungle trek with stream crossings and uneven terrain throughout. No facilities on trail.",
    ...
    faq: [
      ...
      { question: "What are the typical costs?", answer: "Park entrance: ~100,000 VND per person. Guide fee: 200,000–500,000 VND per group. Motorbike transport to trailhead: 150,000 VND per person (2025). Total roughly 600,000–800,000 VND per person excluding food for a two-day trip." },
    ],
    sentiment: {
      positive: "Consistently described as one of the best waterfall experiences in Vietnam by visitors who make the trek - the combination of primary jungle, the swallow cave, overnight camp, and genuine remoteness is unlike any accessible waterfall in the country. The effort is the point.",
