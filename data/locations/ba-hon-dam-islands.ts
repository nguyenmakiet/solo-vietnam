...
export const baHonDamIslands: Location = {
  ...
  tags: ["🏝️ Remote Islands", "🤿 Snorkeling", "🚣 Boat Trip", "🏕️ Island Camping", "✨ Bioluminescence"],
  ...
  gallery: [
    ...
    "ba-hon-dam-kien-giang_m8zges",
    "ba-hon-dam-kien-giang-2_raoibf",
    "ba-hon-dam-kien-giang_1_efneai",
    "ba-hon-dam-kien-giang-8_abycec",
    "ba-hon-dam-kien-giang-4_icwkes",
    "ba-hon-dam-kien-giang-5_an4jou",
  ...
  insights: {
    highlights: [
      "Three islands forming a triangle around a calm shallow lagoon - waist-deep at low tide, clear water, walkable between islands",
      "Bioluminescence (lân tinh) at night from 9-10 PM during the dry season (Nov-Apr) - one of the quieter reasons to stay overnight",
      "Colourful multi-toned pebble beach on Đầm Đước - the most photographed feature of the cluster",
      "Midday to afternoon low tide: wade out and forage for clams and shellfish on the sandflats",
    ],
    thingsToKnow: {
      crowds: "Quieter on weekdays; busier on weekends and Vietnamese holidays. Most visitors come as day trippers - overnight guests have the islands largely to themselves from late afternoon.",
      difficulty: "Easy and flat - walking between islands on sand and pebbles. Rocky sections require care; bring shoes with grip for the pebble beaches. Not ideal for young children on the rockier sections.",
      safety: "No ATMs on the islands - bring cash. No convenience stores; bring necessities from the mainland. Insect repellent recommended for evening. Rocky beaches can cause foot injuries - wear shoes.",
      accessibility: "Boat from Kiên Lương pier: 250,000 VND same-day, 300,000 VND overnight. Departs 7:30 AM and 9:00 AM. Return boats 14:00 and 16:00 for day trips. Most overnight accommodation on Đầm Đước.",
      seasonal: "Nov-Apr: dry season, calm seas, best visibility, bioluminescence most active. May-Oct: wet season, rough conditions, unreliable boat access. Nov-Apr is the only reliable window for the full experience.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "What are the boat times and fares from Kiên Lương?",
        answer: "Boats depart at 7:30 AM and 9:00 AM from Kiên Lương pier. Return boats for day trips at 14:00 and 16:00. Fares: 250,000 VND/person same-day return, 300,000 VND/person overnight return. Groups can charter a private boat for 1,700,000-2,500,000 VND. Overnight guests coordinate return time directly with their accommodation - usually 8-9 AM.",
      },
      {
        question: "What are the three islands and how do they differ?",
        answer: "Hòn Đầm Dương: best calm swimming conditions. Hòn Đầm Đước: colourful pebble beach, most accommodation, main overnight hub. Hòn Đầm Giếng: wilder feel, longer sandbar. All three form a triangle around a calm central lagoon that's only waist-deep at low tide - you can wade or swim between all three.",
      },
      {
        question: "Is overnight worth it on Ba Hòn Đầm?",
        answer: "Yes, if you have the time. Most visitors only come for the day. Staying adds: afternoon sunset from the islands, and bioluminescence (lân tinh) in the water from 9-10 PM during the dry season (November to April). Most overnight accommodation is on Đầm Đước - book in advance and confirm return boat time with your guesthouse.",
      },
      {
        question: "When does the bioluminescence appear?",
        answer: "From around 9-10 PM in the dry season (November to April), when the water is calmest and least disturbed. It's not guaranteed every night but is most reliable in this window. Go to the water's edge after dark - the effect is visible when the water is disturbed.",
      },
      {
        question: "What should I bring to Ba Hòn Đầm?",
        answer: "Cash (no ATMs on the islands), food and snacks from the mainland (island prices are high), insect repellent, a torch for night walks, shoes with grip for the pebble and rocky sections, and sunscreen. Accommodation on Đầm Đước has basic facilities but stock is limited.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the calm lagoon between the islands, the colourful pebble beaches, the foraging experience at low tide, and the undeveloped atmosphere. Bioluminescence gets strong mentions from overnight visitors.",
      negative: "Island prices are significantly higher than the mainland. Rocky beaches cause foot injuries without proper shoes. Limited amenities require self-sufficiency. Wet season access is unreliable.",
    },
  },
}
