...
export const poNagarChamTowers: Location = {
  ...
  insights: {
    highlights: [
      "Ancient Cham towers built over 1,000 years ago without cement, remarkably well-preserved with intricate carvings",
      "Hilltop location with stunning views of Cái River, city, and sea; excellent for photography",
      "Blend of Hindu and Buddhist architecture reflecting Cham civilization's cultural heritage",
    ],
    thingsToKnow: {
      crowds: "Tour groups arrive mid-morning (around 9-10 AM), making it crowded and noisy. Visit at 6-7:30 AM or late afternoon to avoid crowds",
      difficulty: "Involves climbing 190 steps; steps may be challenging for those with mobility issues. Site can be covered in 30 minutes to 1 hour at leisurely pace",
      safety: null,
      accessibility: "Free robes provided if shoulders and knees are exposed. Shoe removal required inside temples. Clean bathrooms available on-site",
      seasonal: null,
    },
    visitorTips: [
    ...
    faq: [
      { question: "What is the entrance fee and what does it include?", answer: "Entrance fee is 30,000 VND per person. Includes access to temple towers, gardens, sitting areas, bathrooms, and snack bars. Free robes available if needed" },
      { question: "What should I wear to visit Po Nagar Temple?", answer: "Shoulders and knees must be covered to enter the temples. Free robes provided if wearing shorts. Remove shoes before entering temple interiors" },
      { question: "When is the best time to visit to avoid crowds?", answer: "Visit early morning (6-7:30 AM) or late afternoon (after 4 PM). Tour groups typically arrive mid-morning around 9-10 AM, making it crowded and noisy" },
    ],
    sentiment: {
