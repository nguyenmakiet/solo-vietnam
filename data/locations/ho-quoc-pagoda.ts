...
export const hoQuocPagoda: Location = {
  ...
  tips: [
    "Dress modestly - shoulders and knees covered, remove shoes before entering the main halls",
    "The climb to the upper temple takes about 15 minutes - worth it for the coastal panorama at the top",
    "Visit on weekday mornings for the most peaceful atmosphere - weekends bring local worshippers and tour groups",
    "The pagoda faces east over the Gulf of Thailand - sunrise visits are spectacular but require arriving before the gates open",
  ],
  content: {
    intro:
