...
export const bacSonValley: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1776186029550!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJQ2M4dEdWTHc.!2m2!1d21.90593586099471!2d106.3388869980067!3f318.92409942815124!4f3.679167320796779!5f0.7820865974627469" },
  heroImage: heroUrl("bac-son-valley-lang-son-2_ieic8m"),
  gallery: [
    "bac-son-valley-lang-son-6_yey42h",
    "bac-son-valley-lang-son-7_dap0fg",
    "bac-son-valley-lang-son-1_v4inhf",
    "bac-son-valley-lang-son-5_uyq6zi",
    "bac-son-valley-lang-son-2_ieic8m",
    "bac-son-valley-lang-son-4_uxmid3",
    "bac-son-valley-lang-son-3_mqepow",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Patchwork rice valley completely enclosed by limestone karst peaks - Tày and Nùng stilt houses with red-tiled roofs scattered through the fields",
      "Nà Lay hill viewpoint: 1,200 stone steps to 600m summit, full panoramic view of the valley",
      "Jul-Oct golden rice harvest season - the valley's most photogenic window",
      "Lồng Tồng festival (Feb-Apr lunar calendar) - traditional Tày harvest prayer ceremony",
    ],
    thingsToKnow: {
      crowds: "Off the tourist circuit - very few foreign visitors. Quiet on weekdays year-round. Slightly busier during golden rice season (Sep-Oct) with Vietnamese photographers.",
      difficulty: "Valley loop: easy motorbike ride. Nà Lay viewpoint: 1,200 stone steps, 40-50 minutes up - challenging for weak joints. Some steps in poor repair.",
      safety: "Large spiders and webs on Nà Lay path, especially June-July - bring a stick. Bring water for the climb on sunny days.",
      accessibility: "80km from Lạng Sơn city. Direct buses from Hanoi available. Motorbike rental in Bắc Sơn town. Basic guesthouses in town.",
      seasonal: "Jul-Oct: golden rice, peak season, least rain. Feb-Apr: spring blossoms, Lồng Tồng festival, green paddies. Nov-Jan: cool, dry, good for trekking, quietest period.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "When is the best time to visit Bắc Sơn Valley?",
        answer: "July to October for golden rice harvest - the valley's most photogenic season, with late September to mid-October being the sweet spot. February to April for spring blossoms and the Tày Lồng Tồng festival. November to January for cool trekking weather and solitude. The valley is pleasant year-round.",
      },
      {
        question: "How do I get to Bắc Sơn from Hanoi?",
        answer: "Direct buses run from Hanoi's major stations (Giáp Bát, Yên Nghĩa, Mỹ Đình, Gia Lâm) - nhà xe Dung Nghị operates the route (0985 381 888). Journey about 4-5 hours. Alternatively, bus to Lạng Sơn city (2.5 hours) then transfer to Bắc Sơn (80km, 1.5 hours). By motorbike from Hanoi: about 4 hours.",
      },
      {
        question: "What is Nà Lay viewpoint?",
        answer: "The main viewpoint overlooking Bắc Sơn Valley, reached by climbing 1,200 stone steps to a 600m+ summit. Allow 40-50 minutes up. Best at sunrise for mist in the paddies and soft light on the karst peaks. Some steps are in poor repair - take care.",
      },
      {
        question: "What is the Lồng Tồng festival?",
        answer: "A traditional Tày harvest prayer ceremony held in February to April (lunar calendar). One of the most culturally distinctive festivals in Lạng Sơn province. Worth timing a visit around if the dates align.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the authentic valley atmosphere, the absence of tourist infrastructure, the Nà Lay panoramic view, and the golden rice season photography. Visitors appreciate the genuine working-village character.",
      negative: "Nà Lay steps are demanding and in poor repair in places. Limited tourist facilities. Spiders on the path concern some visitors.",
    },
  },
}
