...
export const traSuCajuputForest: Location = {
  ...
  gallery: [
    ...
    "tra-su-cajuput-forest-3_hg2hpk",
    "tra-su-cajuput-forest-2_jgdjgy",
    "tra-su-cajuput-forest-7_dtviin",
    "tra-su-cajuput-forest-4_trxr2c",
    "tra-su-cajuput-forest-5_o8ae1r",
    "tra-su-cajuput-forest-8_pm1gub",
    "tra-su-cajuput-forest-9_ujjulq",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Rowboat through flooded cajuput forest with mirror-flat green water reflection - best September to November",
      "Over 70 bird species including large heron and night heron colonies; birds return to roost visibly around 5-6 PM",
      "Cầu Tre Vạn Bước - 10km bamboo walkway through the forest, the longest bamboo bridge in Vietnam",
    ],
    thingsToKnow: {
      crowds: "Morning before 11 AM and late afternoon (3-4 PM onward) are quietest. Midday brings tour groups and heat simultaneously. Weekdays less crowded than weekends.",
      difficulty: "Easy. Rowboat is fully passive. Bamboo walkway is flat and accessible. Observation tower has stairs.",
      safety: "Bring mosquito repellent - present year-round, more abundant in rainy season. Cajuput forest water can carry organic smell at midday. Snakes and wildlife present in the forest.",
      accessibility: "Rowboat and main paths accessible for most visitors. Bamboo walkway is flat. Observation tower requires stairs. Wheelchair access limited beyond the main entrance area.",
      seasonal: "Sep-Nov: flood season, peak water level, strongest reflection, most birds. Dec-Aug: water drops significantly, visual impact reduced. Midday in any season is hot and potentially smelly - go early or late.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Rowing boat or motorized boat - which should I choose?", answer: "Rowing boat. It takes a different route through narrow channels between the cajuput trunks, moves slowly, and gives you time to look and photograph properly. The motorized boat is faster and covers a wider area but misses the intimate forest experience. Both cost 70,000 VND." },
      { question: "Should I tip the boat rower?", answer: "Yes - 30,000-40,000 VND per boat is reasonable and makes a real difference. The older local men and women who row these boats receive only around 10,000 VND per passenger from ticket revenue - roughly 50,000 VND maximum per trip for physical work in the heat." },
      { question: "When is the best time to visit?", answer: "September to November for flood season when the forest is fully inundated and the green mirror reflection is at its most vivid. Morning before 11 AM or late afternoon for cooler temperatures and less smell from the water. Around 5-6 PM birds return to roost in large numbers - worth timing if you're staying late." },
    ],
    sentiment: {
      positive: "Consistently praised for the rowboat experience through the flooded forest - the combination of mirror water, green canopy, and bird sounds is frequently described as unlike anywhere else in the delta. Accessible pricing and full facilities inside the forest.",
      negative: "Midday visits in hot weather can be uncomfortable and the water occasionally smells. Outside flood season the visual impact drops significantly. Motorboat drivers sometimes rush through without stopping for photos.",
    },
  },
}
