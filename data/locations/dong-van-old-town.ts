...
export const dongVanOldTown: Location = {
  ...
  insights: {
    highlights: [
      "40 surviving stone houses from the early 20th century - rammed-earth walls, yin-yang tile roofs, stone courtyards",
      "Saturday and Sunday evening cultural nights: bonfires, music, and dancing from around 8 PM - viral on Vietnamese social media",
      "Sunday dawn market where Kinh, Tày, Nùng, and Lô Lô communities trade - one of the most genuine minority markets in the north",
    ],
    thingsToKnow: {
      crowds: "Weekdays: quiet, atmospheric. Friday to Sunday: significantly busier with Vietnamese domestic tourists, ethnic minority visitors, and foreign loop riders. Weekend cultural nights draw large crowds from 8 PM.",
      difficulty: null,
      safety: "Bring cash from Hà Giang city - ATMs in Đồng Văn are unreliable. Cold year-round at 1,600m elevation - jacket required even in summer.",
      accessibility: "Stone-paved lanes throughout the old quarter. Uneven surfaces in places.",
      seasonal: "Sep-Nov: buckwheat flowers, clearest skies - best overall. Feb-Mar: peach and apricot blossoms on the mountain slopes. Jun-Aug: cool but rainy season with storms. Dec-Feb: coldest months, temperature can drop below 10°C, frost (sương muối) common, occasional snow. Annual average 20°C but swings from 1-2°C at coldest to near 40°C at hottest. Always bring a jacket regardless of season.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What are the Saturday and Sunday evening cultural nights?", answer: "Weekly events at the Đồng Văn old town night market, starting around 8 PM. Bonfires, live music, and dancing that brings together Vietnamese visitors, local ethnic minority communities, and foreign travellers. Viral on Vietnamese social media. Some visitors find them more commercial than authentically traditional - but they genuinely create a cross-cultural atmosphere that's unusual anywhere on the loop." },
      { question: "What is the Sunday morning market?", answer: "A trading market at dawn where Kinh, Tày, Nùng, Lô Lô, and H'Mông communities from surrounding villages gather to buy and sell. It's a working market, not a tourist market. Arrive early - it winds down by mid-morning." },
      { question: "How do I get to Đồng Văn from Hà Giang?", answer: "150km by the Ha Giang Loop - about 4.5 to 5 hours by motorbike via Quản Bạ, Yên Minh, and the major passes. Buses run daily from Hà Giang city but are slow. Most travellers hire a motorbike in Hà Giang city (150,000-200,000 VND/day). Bring sufficient cash - ATMs in Đồng Văn are unreliable." },
    ],
    sentiment: {
      positive: "Consistently praised for the dramatic stone architecture, the weekend evening atmosphere, and the Sunday market. The mix of cultures on weekend evenings - described as everyone's differences dissolving around music and dancing - gets strong mentions from foreign visitors in particular.",
      negative: "Weekend cultural nights are seen by some as commercialised rather than genuinely traditional. Can be crowded on weekends. The plateau cold catches some visitors unprepared.",
    },
  },
}
