...
export const buGiaMapNationalPark: Location = {
  ...
  tags: ["🌿 Primary Rainforest", "🦧 Gibbon Habitat", "🥾 Beginner Trek", "🏕️ Camping"],
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1776268565491!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQzgzOXFfd2dF!2m2!1d12.26233099245533!2d107.2084603440872!3f150.9915979593549!4f23.479992150090283!5f0.7820865974627469" },
  heroImage: heroUrl("bu-gia-map-national-park-binh-phuoc-2_spcrcx"),
  gallery: [
    "bu-gia-map-national-park-binh-phuoc-5_d9aiqo",
    "bu-gia-map-national-park-binh-phuoc-2_spcrcx",
    "bu-gia-map-national-park-binh-phuoc-3_ihnpq7",
    "bu-gia-map-national-park-binh-phuoc-8_js8hey",
    "bu-gia-map-national-park-binh-phuoc_lxoyoy",
    "bu-gia-map-national-park-binh-phuoc-7_z3vy2b",
    "bu-gia-map-national-park-binh-phuoc-6_jthfx8",
    "bu-gia-map-national-park-binh-phuoc-9_a8utlu",
    "bu-gia-map-national-park-binh-phuoc-4_wgfy65",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "2/10 difficulty - southern Vietnam's most beginner-friendly primary rainforest trek, 200km from Saigon",
      "Gibbon and douc langur presence in core zone - audible at dawn from the campsite",
      "Thác Lưu Ly waterfall and Tuyệt Tình Cốc swimming pool - key dry-season highlights",
      "Camping beside Đắk Manh stream with cơm lam and forest campfire meals",
      "1,117 plant species, 104 mammal species, 246 bird species in one of the last intact SE Vietnam lowland forests",
    ],
    thingsToKnow: {
      crowds: "One of the least visited national parks in southern Vietnam. Small groups, minimal infrastructure. Busier on weekends with HCMC tour groups.",
      difficulty: "2/10 - suitable for beginners and families. 8-11km per route, gentle gradients, red basalt soil. Main challenges: leeches and slippery stream crossings. No technical climbing.",
      safety: "Leeches in all seasons - prepare thoroughly (long socks, insect repellent, know how to remove). No phone signal in forest interior. Do not separate from group. No wild food without guide confirmation. Wet season stream crossings can be dangerous without a ranger.",
      accessibility: "200km from HCMC, 4-5 hours. Bus or motorbike. Park permit required - contact 02713.724.237 minimum 1-2 weeks ahead. Licensed guide mandatory for forest access. Tour packages 2,290,000-2,700,000 VND (2N1D all-inclusive from HCMC).",
      seasonal: "Nov-Apr (dry): best conditions, clear streams, far fewer leeches, bằng lăng trees turn orange-red. May-Oct (wet): muddy, leech-heavy, stream crossing risk - experienced trekkers only. Waterfalls most dramatic in wet season.",
    },
    visitorTips: [
    ...
    faq: [
      ...
      {
        question: "What wildlife can I expect to see or hear?",
        answer: "Yellow-cheeked gibbons and black-shanked douc langurs are present in the core zone - gibbon calls are audible at dawn from the campsite. The park also has gaur, sun bear, and Asian elephant in the deeper forest, though sightings are rare. Bird activity is high in early morning with 246 recorded species. Wildlife signs (tracks, droppings, feeding evidence) are common on the trail even when animals aren't visible.",
      },
    ],
    sentiment: {
      positive: "Consistently praised for the genuine primary forest atmosphere, the campfire experience at Đắk Manh stream, the waterfall and swimming pool stops, and the accessible difficulty level. Guides and porters receive strong reviews.",
      negative: "Leeches are a recurring complaint even in dry season. No phone signal throughout the forest. Wet season trails are genuinely difficult. Limited facilities require full self-sufficiency.",
    },
  },
}
