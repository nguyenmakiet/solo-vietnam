...
export const japaneseBridge: Location = {
  ...
  seoDescription:
    "The Japanese Covered Bridge (Chùa Cầu) is Hội An's most iconic structure - a roughly 400-year-old roofed bridge built by Japanese merchants in the early 1600s, spanning a small canal at the western edge of the Ancient Town, with a small temple built into its northern side and a history of restoration that includes a controversial 2022-2024 renovation.",
  tips: [
    "Visit before 7:30 AM or after 5:30 PM - the bridge is one of the most photographed spots in Vietnam and is genuinely mobbed during midday. If those windows don't work, around 9 AM or 2-3 PM tend to be somewhat quieter than the midday and sunset peaks, though still busier than early morning",
    ...
    "A large carved wooden plaque above the main door reads 'Lai Viễn Kiều' (Bridge for Travelers from Afar) in Chinese characters, gifted by an 18th-century Nguyễn lord",
  ...
  insights: {
    highlights: [
      "17th-century Japanese-built wooden bridge connecting the Japanese and Chinese merchant quarters, with a small temple built into its northern side",
      "Featured on Vietnam's 20,000 VND banknote; part of the Hội An Ancient Town UNESCO World Heritage Site",
      "One of the very few surviving Japanese merchant bridges anywhere in Southeast Asia",
    ],
    thingsToKnow: {
      crowds: "Extremely crowded during day and evening hours; visit before 8 AM for a peaceful experience and better photos",
      difficulty: null,
      safety: null,
      accessibility: "Narrow wooden plank side attachment requires lifting prams/strollers to cross the bridge",
      seasonal: "The bridge underwent a major, publicly debated restoration completed in August 2024; occasional seasonal river flooding is reported, though the bridge remains functional",
    },
    visitorTips: [
      "Visit before 8 AM to avoid crowds, enjoy cooler weather, and photograph without tourist obstruction",
      "The exterior is free to walk across; entry to the inner shrine requires the Hội An Ancient Town ticket (120,000 VND covers several heritage sites)",
      "Look for the monkey and dog statues at either end of the bridge - a nod to the tradition that construction began in the Year of the Monkey and finished in the Year of the Dog",
    ],
    faq: [
      { question: "Do I need a ticket to cross the bridge?", answer: "No, walking across the bridge exterior is free. Only entering the inner shrine requires an Old Town ticket (120,000 VND), which also covers several other heritage attractions." },
      { question: "When is the best time to visit?", answer: "Early morning before 8 AM offers a quiet, peaceful atmosphere with better light and minimal crowds. Evening is beautiful when the lanterns light up, but expect heavy tourist presence." },
      { question: "How long does a visit take?", answer: "Walking across the bridge takes 5-10 minutes. Accessing the shrine interior adds minimal time. Plan additional time for exploring the surrounding Ancient Town streets and shops." },
    ],
    sentiment: {
      positive: "Universally recognised as the iconic symbol of Hội An, with a genuinely distinctive architectural history; visitors value the historical significance and evening ambiance despite the crowds",
      negative: "Overcrowding makes photography difficult during the day; the 2022-2024 restoration was a significant point of contention, with many feeling it left the bridge looking noticeably newer and less atmospheric, at least in the period immediately after it reopened",
    },
  },
}
