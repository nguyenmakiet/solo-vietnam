...
export const trungTrangCave: Location = {
  ...
  insights: {
    highlights: [
      "300-metre cave with dense stalactite and stalagmite formations - the largest accessible cave on Cát Bà Island",
      "Three layers of history: local legend (Bà Chúa Trung Trang), wartime military base (Hang Hải Quân), and bat colony (Hang Dơi)",
      "Combined ticket covers both cave and national park entry - natural starting point for the Ngự Lâm viewpoint trek",
    ],
    thingsToKnow: {
      crowds: "Can get busy with tour groups moving through in single file. Visiting independently gives more time at each formation.",
      difficulty: "Short, accessible walk with concrete paths and metal stairs throughout. Some low passages require ducking. Not recommended for claustrophobic visitors or those with significant mobility issues.",
      safety: "Keep noise down near the bats - don't shout or make sudden loud sounds. Cave floor can be slippery in wet conditions.",
      accessibility: "Concrete flooring and metal stairs throughout. Not suitable for visitors with significant mobility issues due to stairs and narrow sections.",
      seasonal: "Apr–Sep is the best period - dry weather makes for better combined outdoor activities. Cave itself is accessible year-round and stays cool regardless of outside temperature.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "What does the ticket include and how much is it?", answer: "120,000 VND for adults, 60,000 VND for children. Includes both Trung Trang Cave and Cát Bà National Park entry - not sold separately for the cave alone. Keep your ticket if you plan to do the Ngự Lâm viewpoint trek afterward." },
      { question: "How long does a visit take?", answer: "About 1 hour at a relaxed pace. The cave is 300 metres with two main chambers. No need to rush - take time with the stalactite formations." },
      { question: "What is the history of the cave?", answer: "The cave has three names reflecting three eras. Hang Dơi (Bat Cave) was the original name for its bat colony. During the resistance wars it became Hang Hải Quân (Navy Cave) when used as a military base - traces are still visible inside. The name Trung Trang comes from a local legend about Bà Chúa Trung Trang, who defended the island from invaders and retreated to the cave afterward." },
    ],
    sentiment: {
      positive: "Visitors appreciate the quality of the formations, the cool interior, and the value of the combined cave and national park ticket. Straightforward and accessible for most fitness levels.",
      negative: "Experienced cave visitors coming from Phong Nha or Ninh Binh may find it underwhelming in scale. Some evidence of tourist damage on the formations.",
    },
  },
}
