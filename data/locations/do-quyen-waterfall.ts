...
export const doQuyenWaterfall: Location = {
  ...
  insights: {
    highlights: [
      "Nearly 400m waterfall in primary mountain forest - one of the tallest in central Vietnam, reached by 689 stone steps or adventure package",
      "Jungle Boss via ferrata + zipline + 200m abseil + suspension bridge - the first package of this type in Vietnam (11,250,000 VND/person)",
      "Rhododendron bloom Mar–Apr lines the trail in red and pink; combine with Ngũ Hồ Five Lakes trail for a full-day loop",
    ],
    thingsToKnow: {
      crowds: "Bạch Mã is less visited than other central Vietnam attractions. Weekday visits are quiet. Vietnamese public holidays bring more domestic visitors.",
      difficulty: "Challenging. The 689-step descent to the waterfall base is steep (45%+ gradient) with deteriorating infrastructure. Good fitness required. Combined Đỗ Quyên + Ngũ Hồ loop is a full-day physical commitment. The via ferrata adventure package requires confidence at height - not suitable for heart conditions.",
      safety: "689 steps have uneven surfaces and rusted railings - do not descend in wet conditions. No phone signal on the trail. Snakes present - wear closed shoes and long trousers. Flash flood and landslide risk in rainy season (Sep–Dec). 2026: additional 2-3 hour on-foot section due to landslide on summit road.",
      accessibility: "Summit viewpoint accessible by car (conditions permitting) or shuttle. Waterfall base not accessible for limited mobility. Motorbikes and bicycles banned on summit road - enforced.",
      seasonal: "Jan–Aug: dry season, recommended. Mar–Apr: rhododendron bloom, best overall. Sep–Dec: high rainfall, dangerous trails, avoid.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "Can I ride my motorbike up to the waterfall?",
        answer: "No - motorbikes and bicycles are banned on the summit road. The road is steep with dangerous bends and the rule is actively enforced. Options are: private car, walking (10km from the gate), or the park shuttle (900,000 VND one way, 1,300,000 VND return, up to 12 people).",
      },
      {
        question: "What is the Jungle Boss adventure package?",
        answer: "A 2-day 1-night adventure tour run by Jungle Boss Tours (junglebosstours.com) that descends to the waterfall base via via ferrata (301 rock steps), a 200m abseil from the top of the falls, a 130m suspension bridge with 319 iron rungs, and an 85m zipline through old-growth forest. Costs 11,250,000 VND per person, departs daily with minimum 4 guests. Not suitable for visitors with heart conditions.",
      },
      {
        question: "What is the best time to visit?",
        answer: "January to August for dry season conditions. March-April for the rhododendron bloom along the trail. Avoid September to December entirely - Bạch Mã is one of the highest-rainfall areas in Vietnam and the combination of slippery trails, flash floods, and landslide risk makes it genuinely dangerous in rainy season.",
      },
    ],
    sentiment: {
      positive: "Visitors consistently describe the waterfall as more impressive than expected - the height, the forest setting, and the remoteness make it one of the most memorable waterfalls in central Vietnam. The rhododendron season and the Jungle Boss adventure package receive strong praise.",
      negative: "The 689-step descent is physically demanding and the deteriorating railings are a genuine safety concern. The shuttle cost surprises some visitors. The 2026 landslide adds significant extra walking time to the visit.",
    },
  },
}
