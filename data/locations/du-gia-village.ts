...
export const duGiaVillage: Location = {
  ...
  tags: ["🏡 Tày & H'mông Village", "🌾 Rice Terraces", "🥾 Eastern Loop", "🤫 Off the Beaten Track"],
  ...
  insights: {
    highlights: [
      "Quiet Tày and H'mông village on the eastern loop - less visited than the western circuit, harder to reach, genuinely off the tourism trail",
      "Rice terraces at multiple elevations around the valley, best in October–November alongside blooming buckwheat flowers",
      "Some of the best homestay hospitality on the Ha Giang Loop - Tày families known for warmth, local food, and corn wine",
    ],
    thingsToKnow: {
      crowds: "Very few visitors by Ha Giang Loop standards. Vietnamese riders mostly skip it. Mainly foreign travellers who specifically seek the eastern loop. October peak season is the busiest but still quiet by comparison.",
      difficulty: "Road access is harder than the western loop - narrow, steep sections, rougher surface. Walking in the village and to the waterfall is easy.",
      safety: "Mountain road requires riding experience, especially in wet conditions. Rainy season (Jun–Sep) makes roads significantly more difficult.",
      accessibility: "No air conditioning. Basic wifi. Limited phone signal in the valley. Not suited to travellers who need reliable connectivity or modern amenities.",
      seasonal: "Oct–May: dry season, recommended. Oct–Nov: buckwheat flowers and golden rice terraces - the best combination. Jun–Sep: rainy season, roads deteriorate, visibility poor.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is Du Già worth visiting or should I stick to the main loop?", answer: "Depends what you're looking for. The main western loop (Quản Bạ, Đồng Văn, Mèo Vạc) has the most dramatic scenery and the most developed infrastructure. Du Già on the eastern loop is quieter, harder to reach, and appeals to travellers who want village life and slower pace over dramatic viewpoints. If you've done the main loop before or want something less touristy, Du Già is the stronger choice." },
      { question: "What ethnic groups live in Du Già?", answer: "Primarily Tày and H'mông, with some Dao. The village has over 8,000 residents across these communities. Most homestays are run by Tày families - traditionally lowland rice farmers who have been in the river valleys for centuries. H'mông communities are more common in the higher elevations around the area." },
      { question: "When should I avoid visiting?", answer: "June to September is rainy season - roads to Du Già become significantly more difficult, sometimes dangerous, and the overcast weather reduces the scenery. October to May is the recommended window, with October–November being the peak for buckwheat flowers and golden rice terraces." },
    ],
    sentiment: {
      positive: "Consistently praised by foreign travellers for authentic hospitality, local food, and the quiet valley atmosphere. The eastern loop road itself - cotton trees, rice terraces, small villages - gets strong mentions from riders who pay attention to it.",
      negative: "Hard to reach and comes late in the loop when riders are tired. Limited amenities. Not visually dramatic enough for visitors primarily motivated by photography. Vietnamese travellers largely skip it.",
    },
  },
}
