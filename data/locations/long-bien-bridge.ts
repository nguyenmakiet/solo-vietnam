...
export const longBienBridge: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1779188992224!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRDJyTC02a1FF!2m2!1d21.04210329112376!2d105.8570133397099!3f339.8420081064629!4f-11.549850271734272!5f0.7820865974627469", },
  heroImage: heroUrl("long-bien-bridge-ha-noi_ctkegp"),
  gallery: [
    "long-bien-bridge-ha-noi-9_owapgv",
    "long-bien-bridge-ha-noi-2_hijuce",
    "long-bien-bridge-ha-noi-3_cczl2w",
    "long-bien-bridge-ha-noi-4_kgqrji",
    "long-bien-bridge-ha-noi-5_xgj40c",
    "long-bien-bridge-ha-noi-8_gpbo6r",
    "long-bien-bridge-ha-noi-7_fve8sz",
    "long-bien-bridge-ha-noi-6_zgdvee",
    "long-bien-bridge-ha-noi-10_aittt8",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Contrary to popular belief, Long Bien Bridge was NOT designed by Gustave Eiffel - it was built by the rival French firm Daydé & Pillé, though its lattice ironwork explains why the comparison persists",
      "One of the few 100+ year old colonial-era bridges in Vietnam still carrying daily rail, motorbike, and pedestrian traffic",
      "Visible mismatched repairs from repeated US bombing during the American War (1967-1972)",
      "A quirky, rarely-explained detail: vehicles cross on the left, unlike the rest of Vietnam",
    ],
    thingsToKnow: {
      crowds: "Quietest early morning before 8 AM; busier in late afternoon (roughly 3-5 PM) when locals come out to walk, cycle, and watch the sunset",
      difficulty: "Flat and easy walking, but the surface is uneven with some sunken sections - watch your footing, especially near the edges",
      safety: "Cars are not permitted on the bridge - only trains, motorbikes, bicycles, and pedestrians. Avoid leaning on the aging railings, and if photographing near the tracks, stay alert for the train horn and clear the tracks well in advance",
      accessibility: "Flat, walkable surface throughout, though narrow in sections with no barrier from the motorbike lane or railway in places",
      seasonal: "Best Oct-Apr in the dry season; Oct-Nov reed grass season makes the Red River rock beach below the bridge especially photogenic",
    },
    visitorTips: [
