...
export const haLongBay: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775803720179!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJRDQ3S3E0UEE.!2m2!1d20.82210328316939!2d107.1779499556187!3f55.46569093879162!4f7.256726516048985!5f0.7820865974627469", },
  ...
  content: {
    ...
    travelTips:
      "The single most important decision is which boat you book. The karsts don't change - the difference is entirely in the boat quality, food, crew, and itinerary pacing. Budget junks pack 20+ cabins on tight schedules; 3-star boats (the popular middle option) offer buffet lunch and a more relaxed pace; 5-6 star luxury cruises add private sun decks, spas, and cooking classes. Read recent reviews and compare inclusions carefully - some budget cruises charge extra for kayaking that mid-range boats include.\n\nIf fewer people and better beaches matter more than the Ha Long name, consider Bái Tử Long Bay or Lan Hà Bay instead - identical landscape, meaningfully fewer boats.",
  },
  insights: {
    highlights: [
      "1,969 limestone karst islands across 1,553 km² - UNESCO World Heritage Site and Vietnam's most iconic natural landscape",
      "Route 2 overnight cruise: Titop Island, Hang Sửng Sốt cave, kayaking at Hang Luồn - the most complete bay experience",
      "Dawn and dusk on the water between the karsts - the mist and light conditions that make Ha Long Bay photographs look the way they do",
    ],
    thingsToKnow: {
      crowds: "Very busy with hundreds of tourist boats, especially Routes 1 and 2. Overnight cruises access quieter anchorages away from day trip traffic. Weekdays (Sun-Thu) significantly less crowded and cheaper than Fri-Sat.",
      difficulty: "Ti Top Island hike available but optional. Sung Sot Cave has stairs. Kayaking is easy and included in most Route 2 cruises.",
      safety: "Larger cruise ships and luxury boats are more stable - better for those prone to seasickness than small wooden day boats. Bay depth averages 5-10m.",
      accessibility: "Cave visits involve stairs. Ti Top Island viewpoint requires a moderate climb. Most boat decks are accessible.",
      seasonal: "Best Sep-Nov and Mar-Apr. Jun-Aug: peak domestic crowds, afternoon storms common. Winter (Dec-Feb): cooler, occasional mist which can be atmospheric but reduces visibility.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "What is the difference between Route 1 and Route 2?",
        answer: "Route 1 (3-4 hours, ~600,000-900,000 VND total): scenic sightseeing on shared boats, covers Hang Đầu Gỗ, Động Thiên Cung, and karst formations. Relaxed and budget-friendly. Route 2 (5-7 hours, from ~700,000-1,000,000+ VND total): the most complete experience, includes Titop Island, Hang Sửng Sốt, kayaking at Hang Luồn, and Hòn Đầu Người. Both prices include the 310,000 VND bay entry ticket.",
      },
      {
        question: "Day trip or overnight cruise?",
        answer: "Overnight is strongly recommended (minimum 2 days, 1 night). Day trips spend most time travelling and leave only 3-4 hours on the water at the busiest spots. Overnight cruises access quieter anchorages, include sunrise on the water, and give a fundamentally different experience.",
      },
      {
        question: "Ha Long Bay vs Lan Ha Bay vs Bai Tu Long Bay - which to choose?",
        answer: "All three share the same karst landscape. Ha Long Bay is the most visited and most developed. Lan Hà Bay (connected to Cát Bà Island) has near-identical scenery with far fewer tourist boats - better for those who want the landscape without the crowds. Bái Tử Long Bay is the quietest of the three. Ha Long is the easiest to access from Hanoi; the others require an extra transfer.",
      },
    ],
    sentiment: {
      positive: "The natural scenery is consistently described as genuinely spectacular - the karst formations, the mist at dawn, and the scale of the bay exceed most visitors' expectations. Overnight cruises with attentive crew and good food receive strong reviews.",
      negative: "Overcrowding with hundreds of tourist boats is the most common criticism - particularly at Sung Sot Cave and Titop Island during peak hours. Some budget boats receive poor reviews for food quality and rushed itineraries.",
    },
  },
}
