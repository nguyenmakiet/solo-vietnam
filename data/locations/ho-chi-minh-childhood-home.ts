...
export const hoChiMinhChildhoodHome: Location = {
  ...
  content: {
    ...
    travelTips:
      "Kim Liên sits in one of Vietnam's most historically dense regions - Nghệ An produced a disproportionate number of the country's revolutionary leaders and scholars, a fact locals attribute to the province's hardscrabble climate and culture of study under adversity. The site is significant for understanding Vietnamese history regardless of one's political perspective. Even for travelers with limited interest in the political history, the physical environment - a well-preserved 19th-century Vietnamese rural village - is genuinely interesting. If you're driving or riding the coastal route between Hanoi and Huế, the 30-minute detour from Vinh to Kim Liên is easily worth making.",
  },
  insights: {
    highlights: [
      "Traditional three-section thatched house featured on Vietnam's 500,000 dong banknote",
      "Birthplace of Ho Chi Minh with preserved family artifacts and ancestral altar",
      "Peaceful rural village setting with surrounding historical sites including old well and blacksmith",
    ],
    thingsToKnow: {
      crowds: "Very crowded during mornings, quieter after midday. Large numbers of veteran groups and school delegations visit, especially on national commemorations",
      difficulty: null,
      safety: null,
      accessibility: "No entrance ticket required. Site has midday closure period, so visitors cannot enter the house during lunch hours. Free parking available. Accessible roads to the village",
      seasonal: "Weather affects visits; rainy conditions may limit exploration of outdoor areas",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Is there an entrance fee?", answer: "No entrance ticket required. Visitors only purchase flowers and incense to offer at the altar if desired" },
      { question: "What are the visiting hours?", answer: "The site has a midday closure period, so visitors cannot enter the house during lunch hours. Arrive early morning or afternoon" },
      { question: "What can visitors see inside the house?", answer: "Original artifacts including wooden altar, weaving loom, wooden panels, storage baskets, and household items from Ho Chi Minh's childhood era" },
    ],
    sentiment: {
      positive: "Overwhelmingly positive. Visitors deeply moved by historical significance and preserved authenticity reflecting humble origins of Vietnam's founding leader",
      negative: null,
    },
  },
}