...
export const taXuaMountain: Location = {
  ...
  tags: ["🦕 Dinosaur Spine Ridge", "🌊 Sea of Clouds", "🐢 Turtle Rock", "🌿 Moss Forest", "📸 Photography"],
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775887983954!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJRFZzTFRtMVFF!2m2!1d21.43377221957714!2d104.3038885214718!3f255.96973229710827!4f-18.020431044174956!5f0.7820865974627469" },
  heroImage: heroUrl("ta-xua-mountai-yen-bai-9_rccz64"),
  gallery: [
    "ta-xua-mountai-yen-bai-2_dsvkk3",
    "ta-xua-mountai-yen-bai-1_kv1y8d",
    "ta-xua-mountai-yen-bai-3_em9kkn",
    "ta-xua-mountai-yen-bai-4_nnljkp",
    "ta-xua-mountai-yen-bai-5_hwe3he",
    "ta-xua-mountai-yen-bai-10_oeypwi",
    "ta-xua-mountai-yen-bai-6_rs4uer",
    "ta-xua-mountai-yen-bai-7_nidk27",
    "ta-xua-mountai-yen-bai-8_ragjpc",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Vietnam's 13th highest peak at 2,865m - part of the Hoàng Liên Sơn range on the Son La - Yen Bai border",
      "Dinosaur spine ridge: narrow exposed rocky ridge above the sea of clouds - one of the most dramatic sections of any trek in the Vietnamese northwest",
      "Ancient moss forest near the summit - centuries-old trees completely covered in moss and lichen, otherworldly atmosphere",
      "Turtle rock (tảng đá đầu rùa) - iconic outcrop on the day 2 descent route",
      "Rhododendron blooms February to April on the upper slopes",
    ],
    thingsToKnow: {
      crowds: "Popular with Vietnamese trekkers, especially on weekends from October to April. Weekday departures are quieter. The mountain huts fill up on peak weekends - book through a tour operator in advance.",
      difficulty: "Challenging. 23km total over 2 days with significant elevation gain. Day 1 is the harder day: 7km, 8 hours of trekking. The dinosaur spine section requires care - narrow, rocky, exposed drops on both sides, strong winds. The final 2.5km to the summit is steep and very muddy. Prior hiking experience recommended; physical training before the trip makes a real difference.",
      safety: "Stay with your group - do not separate, especially in the moss forest where the trail is easy to lose. The dinosaur spine has steep drops on both sides; strong winds are common and can be destabilizing. Use trekking poles on muddy sections. Hut accommodation is available - do not attempt to summit and descend in one day without prior experience on the route.",
      accessibility: "Accessible from Bắc Yên town, Son La. Most trekkers join organized tours (approximately 4,500,000 VND/person for 2 days including guide, porter, hut, and meals). The trailhead involves a motorbike section from town.",
      seasonal: "Nov - Apr: dry season, best cloud views, clearest skies - peak trekking season. Feb - Apr: rhododendron blooms add colour to the upper slopes. May - Oct: rainy season brings muddy, slippery trails and reduced visibility; sea of clouds less reliable. The moss forest is most vivid after rain regardless of season.",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Can I do Tà Xùa in one day?", answer: "Not recommended. The standard route is 2 days, 2 nights covering 23km total. Attempting the full route in one day would require around 14 hours of continuous trekking. Most tour operators only offer the 2-day format." },
      { question: "What is the dinosaur spine?", answer: "A narrow rocky ridge section with steep drops on both sides and strong winds. It's one of the most photographed sections of the trek - dramatic views over the sea of clouds when conditions are right. Anyone with a fear of heights will find it genuinely challenging. Take it slowly and follow your guide's line." },
      { question: "What is the best time to visit for sea of clouds?", answer: "November to April gives the highest probability of sea of clouds, with clearest skies in November to January. Morning hours - around sunrise - are when cloud formations are most dramatic. Weather is unpredictable and not guaranteed on any given day." },
      { question: "How cold is it in the mountain huts overnight?", answer: "The huts are built from wood, windproof, and have thick blankets. But temperatures at 2,000m+ drop significantly at night even in the dry season. Bring thermal base layers, a beanie, and thick socks at minimum. Hand warmers are a useful addition in December and January." },
      { question: "Do I need a guide?", answer: "Yes. The trail through the moss forest near the summit is easy to lose, and the terrain near the dinosaur spine is serious. All reputable operators include a guide and porter in their tour package. Solo independent trekking without local guidance is not recommended." },
    ],
    sentiment: {
      positive: "Consistently praised for the dinosaur spine experience above the sea of clouds, the moss forest atmosphere, and the sense of genuine achievement at the summit. The variety of terrain across 2 days - forest, ridge, rock, cloud - gets strong mentions. Vietnamese trekkers in particular describe it as one of the most memorable routes in the north.",
      negative: "Physically demanding - unprepared trekkers struggle on the muddy summit section and the long day 2 descent. The dinosaur spine intimidates visitors with a fear of heights. Sea of clouds is weather-dependent and not guaranteed. Peak weekends can feel crowded on the ridge.",
    },
  },
}
