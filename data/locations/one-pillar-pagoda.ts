...
export const onePillarPagoda: Location = {
  ...
  heroImage: heroUrl("one-pillar-pagoda-ha-noi_eb59rf"),
  gallery: [
    "one-pillar-pagoda-ha-noi-2_srhbn7",
    "one-pillar-pagoda-ha-noi_eb59rf",
    "one-pillar-pagoda-ha-noi-4_yl7nzd",
    "one-pillar-pagoda-ha-noi-3_masgno",
  ],
  seoDescription:
  ...
  tips: [
    ...
    "The current structure is a 1950s reconstruction - the French destroyed the original pagoda in 1954 before withdrawing from Hanoi, and it was rebuilt faithfully to the original design; the building itself is modern, not ancient",
    "Enter via the west side entrance - Google Maps sometimes directs visitors incorrectly, so it's worth double-checking on arrival rather than assuming the app has the exact right approach",
    "Expect a security checkpoint (metal detector, bag check) given the pagoda's location right next to the Ho Chi Minh Mausoleum complex",
    ...
    "Dress modestly - shoulders and knees covered - as the pagoda is an active place of worship, and this is enforced by guards; showing up underdressed may mean you're refused entry to the shrine itself",
    "The staircase up to the shrine is narrow, wide enough for one person at a time - be patient rather than pushing past others",
    "Photography is fine in the courtyard and around the pond, but avoid flash photos pointed directly at the Buddha statue inside, and don't throw anything into the pond",
    "City buses passing near the Mausoleum complex are a cheap option (fares around 7,000-9,000 VND) if you'd rather not take a taxi - check current routes, since exact bus numbers serving this stop have varied across sources",
  ...
  insights: {
    highlights: [
      "Built in 1049 during the Lý Dynasty, standing on a single stone pillar above a lotus pond symbolising purity",
      "Located right next to the Ho Chi Minh Mausoleum and Museum; visit takes 10-30 minutes on its own",
      "Peaceful spiritual atmosphere with gardens despite the surrounding busy streets in the heart of Hanoi",
    ],
    thingsToKnow: {
      crowds: "Popular tourist destination with steady visitor flow, especially during Tết. Early morning is recommended for a quieter experience.",
      difficulty: null,
      safety: "Expect a security checkpoint with a metal detector and bag search, given the proximity to the Mausoleum complex. Enter from the west side entrance. Dress code (shoulders and knees covered) is enforced.",
      accessibility: "A few steps and stairs lead to the main shrine; strollers can't go up, so toddlers need to be carried. The site is otherwise well-maintained and suitable for most visitors.",
      seasonal: "Particularly atmospheric during Tết, when many locals come to pray for the new year.",
    },
    visitorTips: [
      "Visit early morning for quieter crowds and better light for photos - opening is generally around 7 AM",
      "Enter via the west side entrance; Google Maps may direct you incorrectly, so double-check on arrival",
      "Combine your visit with the Ho Chi Minh Mausoleum and Museum nearby, and wear comfortable walking shoes for exploring the surrounding grounds",
    ],
    faq: [
      { question: "What or who is worshipped at the pagoda?", answer: "The pagoda is dedicated to Quan Âm (Avalokiteśvara), the bodhisattva of mercy and compassion, following the legend of Emperor Lý Thái Tông's dream. A gilded statue of Quan Âm sits on the altar inside." },
      { question: "Is there an entrance fee?", answer: "Entry is free for Vietnamese citizens. Foreign visitors pay 25,000 VND. This fee is specifically for the pagoda - the neighbouring Ho Chi Minh Mausoleum itself is free to visit for everyone." },
      { question: "What is the dress code?", answer: "Shoulders and knees should be covered. The dress code is enforced by guards at the entrance." },
      { question: "How long does a visit take?", answer: "Most visitors spend 10-30 minutes at the pagoda itself. It's a small site but historically and spiritually significant, and works well combined with the nearby Mausoleum and Museum for a longer morning (2-3 hours total)." },
    ],
    sentiment: {
      positive: "Visitors consistently praise the pagoda's spiritual significance, peaceful atmosphere, unique single-pillar architecture, historical importance, and strategic location near other major Hanoi sites.",
      negative: null,
    },
  },
}
