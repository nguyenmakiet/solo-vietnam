...
export const taNangPhanDungTrek: Location = {
  ...
  gallery: [
    ...
    "ta-nang-phan-dung-trek-5_kjlo4i",
    "ta-nang-phan-dung-trek-6_sg7ckl",
    "ta-nang-phan-dung-trek-8_etkgig",
    "ta-nang-phan-dung-trek-7_t7m6uo",
    "ta-nang-phan-dung-trek_a58x0e",
    "ta-nang-phan-dung-trek-3_kgzxf1",
    "ta-nang-phan-dung-trek-2_etly3j",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "30-55km crossing through 3 provinces (Lâm Đồng, Ninh Thuận, Bình Thuận) with tri-province peak at 1,701m",
      "Two distinct seasonal landscapes: golden-brown burned grassland (Jan-May) and vivid green savannah (Jun-Dec)",
      "Pioneer route first opened ~2015 via logging trails - now Vietnam's most celebrated southern multi-day trek",
      "Full terrain variety: highland pine forest, open grassland ridgelines, river valleys, lowland forest",
    ],
    thingsToKnow: {
      crowds: "Popular route with multiple operators running regular departures. Busiest Dec-Apr dry season. Green grass season (Aug-Oct) is less crowded.",
      difficulty: "Moderate to challenging. Long distance (30-55km), varied terrain, river crossings. Average elevation ~1,100m with peaks to 1,701m. Now well-supported with xe ôm, porters, clear trail - accessible for fit beginners with a guide. Do not attempt alone.",
      safety: "River crossings are the primary hazard - multiple fatalities from being swept away. Never cross in heavy rain. Getting lost and waterfall falls have also caused accidents. Book through an established operator with guide. Do not solo.",
      accessibility: "Tour packages from Đà Lạt operators: toongadventure.vn, bitour.vn, itrek.vn, NowTrip. Xe ôm forest motorbike assistance available on steep sections. Porter services available. Standard format 2N1D.",
      seasonal: "Jan-May (mùa cỏ cháy): golden-brown grassland, dry, best late Jan to early Mar. Jun-Dec (mùa cỏ xanh): green grassland, rainier, best Aug-Oct. Rainy season: muddy trails, check weather carefully, avoid heavy rain days for river crossings.",
    },
    visitorTips: [
    ...
    faq: [
      ...
      {
        question: "When is the best time to trek Tà Năng - Phan Dũng?",
        answer: "Two distinct windows: late January to early March (mùa cỏ cháy) for golden-brown burned grassland - dry, not too hot, the most photogenic season. August to October (mùa cỏ xanh) for vivid green grasslands - rainier but lush. Both have their own visual character. Avoid trekking during heavy rain regardless of season - river crossings become dangerous.",
      },
      {
        question: "How long does the trek take?",
        answer: "Standard format is 2 nights 1 day covering 30-55km depending on route. One-day completions (29km, departing 5 AM, finishing around 6 PM) are possible but extremely tiring for most people. Most operators run 2N1D packages.",
      },
      {
        question: "What are the main safety risks?",
        answer: "River crossings are the primary hazard - multiple fatalities have occurred from people being swept away, and water levels rise rapidly in rain. Getting lost and falls near waterfalls have also caused accidents. Book through a reputable operator, never go alone, and do not attempt river crossings in heavy rain.",
      },
      {
        question: "Which operators run this trek?",
        answer: "Established operators running regular departures: toongadventure.vn, bitour.vn, itrek.vn, NowTrip. All include guide, porter, camping gear, and meals in their 2N1D packages.",
      },
    ],
    sentiment: {
      positive: "Overwhelmingly praised as southern Vietnam's most beautiful multi-day trek. The landscape variety, the sense of genuine wilderness, and the physical achievement are consistently cited. Both seasonal versions (golden and green grass) have dedicated fans.",
      negative: "River crossings intimidate some participants. Trail can be very muddy in rainy season. One-day completions leave many people exhausted. Cattle dung in campsite areas is a recurring complaint.",
    },
  },
}
