...
export const taNangPhanDungTrek: Location = {
  ...
  address: "Đà Lạt, Lâm Đồng to Phan Dũng, Bình Thuận",
  ...
  insights: {
    highlights: [
      "35-55km trek crossing three provinces through pine forests, grasslands, waterfalls, and mountain peaks at 1,168m",
      "Terrain transitions from cool forests to hot lowlands with changing vegetation and cooler streams for refreshment",
      "Overnight camping experience with views of green mountains and white clouds at sunrise from mountain ridges",
    ],
    thingsToKnow: {
      crowds: "Popular route, but less crowded during rainy season. Some sub-routes like Yavly waterfall have very few visitors",
      difficulty: "Strenuous 35-55km trek requiring cardio fitness. Steep uphills need you to dismount motorbikes and push. Slippery terrain with loose rocks and inclines require careful footing",
      safety: "Hire local guide for first-timers; vegetation obscures trails making it easy to get lost. Route passes through remote forest and mountains. Do not attempt during rainy season due to slippery descents. Adequate water preparation essential for multi-day treks",
      accessibility: "Trek suitable for beginners with physical preparation. Some tours offer grab rừng (forest motorcycle) assistance. Can be done in 1 day (29km, dawn to dusk) or 2-3 days with overnight camping",
      seasonal: "Best dry season: February-May (easy terrain, no rain). Rainy season June-November: green grass but wet, slippery paths (harder). December-January transition: cool, less rain. June rainy season has some burnt grass",
    },
    visitorTips: [
    ...
    faq: [
      { question: "Should I trek during rainy season?", answer: "No. Rain makes descents extremely slippery and dangerous. Best periods are dry season (Feb-May) or transition months (Dec-Jan)" },
      { question: "Is it safe to trek without a guide?", answer: "First-timers should hire local guides. Vegetation obscures trails easily. Ensure water supply for multi-day treks. Remote terrain requires preparation" },
      { question: "Can I do this in one day?", answer: "Yes, 29km possible in one day (5am-6pm) but extremely tiring for unprepared trekkers. Most take 2-3 days with overnight camping for better experience" },
    ],
    sentiment: {
      positive: "Overwhelmingly praised as one of Vietnam's most beautiful trekking routes with diverse landscapes, stunning mountain views, and memorable wilderness experiences",
      negative: "Cattle dung scattered throughout campsites. Hyped expectations sometimes exceed reality. Extremely challenging for unprepared trekkers",
    },
  },
}
