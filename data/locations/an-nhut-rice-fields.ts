...
export const anNhutRiceFields: Location = {
  ...
  insights: {
    highlights: [
      "2km winding asphalt road through sweeping open rice fields - best at golden hour (4-5 PM) during harvest season when the paddies turn yellow",
      ...
      "One of the few places within 30 minutes of Vũng Tàu where rice fields, countryside food, and sunset photography come together in a single stop",
    ],
    thingsToKnow: {
      ...
      safety: "The 2km road through the fields is narrow with no guardrails and no street lighting after dark, with deep irrigation canals alongside it in places - ride carefully, especially around blind curves and after sunset",
      accessibility: "Flat and fully accessible - asphalt roads throughout, suitable for all mobility levels",
      seasonal: "Most photogenic during harvest seasons (late March-early April and early August) when fields turn golden. Green growing season is beautiful but different. Post-harvest (bare fields) is least rewarding. November visit: lush green fields noted as beautiful by visitors.",
    },
    visitorTips: [
    ...
    faq: [
      {
        ...
        answer: "The two harvest seasons when the rice turns golden fall around late March-early April and early August, though exact timing shifts a little each year with planting schedules. A green season visit (other months) still offers scenic fields with egrets and a cooler, lush atmosphere - just a different aesthetic.",
      },
      {
      ...
      {
        question: "Do I need a drone to get good photos here?",
        answer: "No. A drone shows off the fields' full scale better than any ground-level shot, but the winding road and the lone tree both photograph well from the ground too - it's a nice-to-have, not a requirement.",
      },
      {
        question: "Is it worth visiting outside harvest season?",
        answer: "Yes, though the experience is different. Outside the golden harvest windows, the fields are a deep green with egrets working the paddies - still scenic and much quieter, just without the golden-hour colour that harvest season is known for. Visiting right after harvest, when the fields are cut bare, is the one time that's genuinely less rewarding.",
      },
      {
        question: "Can I cycle here?",
        answer: "Yes - the 2km asphalt road through the fields is flat and well-suited to cycling, and it's a slower, quieter way to see the paddies than driving straight through.",
      },
    ],
    sentiment: {
