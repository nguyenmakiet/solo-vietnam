...
export const giengTienPeak: Location = {
  ...
  tips: [
    "Núi Giếng Tiền is the crater visible to the south when standing at Cổng Tò Vò - the two are always in the same eyeline and make sense to visit together",
    "Chùa Đục is built into the lower slopes of this crater - if you visit the pagoda, you are already at the base of Giếng Tiền",
    "The crater rim offers a different angle on the island's eastern coast compared to Thới Lới - less panoramic but quieter and less visited",
