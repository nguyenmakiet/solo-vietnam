...
export const saoBeach: Location = {
  ...
  heroImage: heroUrl("bai-sao-phu-quoc_ffa6xo"),
  gallery: [
  ...
  insights: {
    highlights: [
      "Over 2km of fine white sand in a sheltered southeast-facing bay - among the calmest swimming conditions on Phú Quốc in season",
      "Best June-October when the southwest monsoon shelters the bay - opposite of most Phú Quốc beaches",
      "Full range of water activities: kayaking (130,000-170,000 VND/hour), jet ski, parasailing, banana boat, windsurfing",
    ],
    thingsToKnow: {
      crowds: "Afternoons from 4 PM are when Vietnamese visitors tend to arrive. Mornings are quieter but water is rougher with incoming tides.",
      difficulty: "Flat easy beach access. Free entry via left fork at the junction - right fork charges 60,000 VND.",
      safety: "No lifeguards on the public section. Water shallow and generally calm in season. Jet ski traffic in busier periods.",
      accessibility: "Free public beach via left fork at junction. Beach clubs via right fork (60,000 VND, usually credited toward food). No public showers or restrooms on the free section.",
      seasonal: "Best Jun-Oct. Nov-Apr: waves and debris common despite being peak tourist season for the rest of the island - manage expectations if visiting then.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I avoid the 60,000 VND entry fee?",
        answer: "At the junction before the beach, take the left fork following signs for Nhà Hàng Mỹ Lan instead of the right fork (marked Bãi Sao 1 on Google Maps). The left fork leads to the free public beach.",
      },
      {
        question: "Why is the best season June-October when most Phú Quốc beaches are best November-April?",
        answer: "Bãi Sao faces southeast in a sheltered bay. The southwest monsoon (June-October) that affects west-coast beaches actually shelters Bãi Sao, keeping it calm and clear. The northeast monsoon (November-April) hits this bay directly bringing waves and debris. The same logic applies to Khem Beach nearby.",
      },
      {
        question: "Are the starfish at Bãi Sao natural?",
        answer: "The starfish occasionally seen at Bãi Sao are reportedly placed by vendors rather than naturally occurring. Natural wild starfish are at Rạch Vẹm fishing village to the north. Do not lift them from the water regardless.",
      },
    ],
    sentiment: {
      positive: "Beautiful white sand and clear water in the right season and time of day. Calm sheltered bay ideal for families. Good range of water activities. Affordable kayaking.",
      negative: "Entry fee trap at the right fork junction. Waves and debris November-April. No public showers or restrooms on the free section. Jet ski noise in busier periods.",
    },
  },
}
