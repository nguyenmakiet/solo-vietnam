...
export const phuocHaiFishingVillage: Location = {
  ...
  streetView: { embedUrl: "https://www.google.com/maps/embed?pb=!4v1775379383328!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJQzI0Y3ExTkE.!2m2!1d10.41810521554699!2d107.2884803069617!3f175.64917789626014!4f-28.500757878539176!5f0.7820865974627469" },
  heroImage: heroUrl("phuoc-hai-fishing-village-8_h9xwfl"),
  gallery: [
    "phuoc-hai-fishing-village-2_u90atx",
    "phuoc-hai-fishing-village_i3talb",
    "phuoc-hai-fishing-village-3_clhz4s",
    "phuoc-hai-fishing-village-4_bt535z",
    "phuoc-hai-fishing-village-5_bzet03",
    "phuoc-hai-fishing-village-6_ienrzc",
    "phuoc-hai-fishing-village-7_hofih2",
    "phuoc-hai-fishing-village-8_h9xwfl",
    "phuoc-hai-fishing-village-9_yvzxya",
  ],
  seoDescription:
  ...
  insights: {
    highlights: [
      "Fishing village + swimmable beach in one place - rare on this coastline; Phước Tỉnh has the fishing without the beach, Hồ Tràm has the beach without the fishing character",
      "Oysters (hàu) and fresh seafood among the best and cheapest near Ho Chi Minh City - 1.5 hours by Toàn Thắng bus",
      "Morning promenade 6-9 AM: over 5,500 boats in active fleet, fish sold directly from boat to market along the promenade",
      "Lễ Hội Nghinh Ông (15th-17th, 2nd lunar month) and Lễ Hội Dinh Cô (12th, 2nd lunar month) - major coastal fishing community festivals",
    ],
    thingsToKnow: {
      crowds: "Very popular with young people from Saigon. Saturday is the peak day. Sunday morning and weekdays are significantly quieter. Kite flying peaks on weekends.",
      difficulty: "Flat and easy. Beach swimming straightforward in calm conditions.",
      safety: "Check lunar calendar before swimming: days 8-12 and 22-27 are best for swimming (stable tides). Days 1-5 and 15-20 have strong tidal movement - better for shellfish foraging than swimming. Water is not crystal clear but reasonably clean.",
      accessibility: "Flat seafront promenade. Easy to navigate on foot or motorbike. Direct bus from HCMC (Toàn Thắng).",
      seasonal: "Nov-Apr: dry season, little rain, warm sun, best for swimming and outdoor activities. May-Oct: rainy season, frequent sudden showers. Peak crowd season is year-round on weekends but worst in dry season holiday periods.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "How do I get to Phước Hải from Ho Chi Minh City?",
        answer: "Take the Toàn Thắng bus - book online or at the bus station, direct service to Phước Hải, approximately 1.5 hours. This is the most convenient option for day trippers from Saigon without a motorbike.",
      },
      {
        question: "Why is Phước Hải better than nearby alternatives for a day trip?",
        answer: "It's the only spot on this stretch that combines a working fishing village with a beach good enough to swim in. Phước Tỉnh has more fishing character but poor swimming. Hồ Tràm has a nicer beach but has lost its fishing village feel. Vũng Tàu has both but is crowded and expensive. Phước Hải sits in the middle and is 1.5 hours from HCMC by bus.",
      },
      {
        question: "When is the best time of day to visit?",
        answer: "Two windows: 6-9 AM for the morning market, fishing boats, and seafood promenade atmosphere. 4-6 PM for swimming when the sun is lower. Freshwater rinse showers available by the square for 15,000 VND after swimming.",
      },
      {
        question: "When is the best time to swim?",
        answer: "Check the lunar calendar. Days 8-12 and 22-27 of the lunar month have stable tides - water stays near shore and conditions are calm for swimming. Days 1-5 and 15-20 see the tide go out very far and come in high - dramatic to watch, better for foraging shellfish than swimming.",
      },
      {
        question: "What festivals happen at Phước Hải?",
        answer: "Two major festivals in the 2nd lunar month: Lễ Hội Nghinh Ông on the 15th-17th - the fishing community's prayer and cultural festival with performances and ceremony. Lễ Hội Dinh Cô at nearby Long Hải on the 12th - dozens of beautifully decorated boats in a procession praying for national peace and good seas. Both are worth timing a visit around if your schedule allows.",
      },
      {
        question: "Is the seafood really worth it?",
        answer: "Yes - oysters (hàu) especially. Phước Hải is consistently mentioned as one of the top spots for cheap fresh seafood near Ho Chi Minh City. Prices are significantly lower than equivalent restaurants in Vũng Tàu or the city.",
      },
    ],
    sentiment: {
      positive: "The seafood - especially oysters - receives consistent strong praise for quality and price. The combination of fishing activity and beach access is frequently cited as the main reason to choose Phước Hải over alternatives. Easy bus access from HCMC gets positive mentions.",
      negative: "Saturday crowds are intense. The beach water isn't particularly clear. Can feel generic on weekends when tour groups are present. Rainy season showers can disrupt outdoor plans.",
    },
  },
}
