...
export const quangTriAncientCitadel: Location = {
  ...
  type: ["heritage", "history", "citadel", "cultural"],
  categories: [],
  ...
  gallery: [
    ...
    "quang-tri-ancient-citadel_nasfe3",
    "quang-tri-ancient-citadel-8_fnbboa",
    "quang-tri-ancient-citadel-3_gqqt3k",
    "quang-tri-ancient-citadel-4_c0r4iy",
    "quang-tri-ancient-citadel-2_zwpprx",
    "quang-tri-ancient-citadel-6_j5nvou",
    "quang-tri-ancient-citadel-7_dfg9pm",
    "quang-tri-ancient-citadel-5_qbc72e",
  ],
  seoDescription:
    "Quảng Trị Ancient Citadel is one of Vietnam's most sacred war memorials - the site of the 81-day Battle of 1972 (28 June - 16 September) where thousands of Vietnamese soldiers and civilians died defending the citadel against American airstrikes and South Vietnamese counterattacks.",
  tips: [
    ...
    "The museum at the citadel entrance provides essential historical context - the 81-day battle of 1972 (28 June-16 September) is not widely known outside Vietnam but is considered one of the most intense urban battles of the entire war. Vietnamese sources commonly cite up to 328,000 tonnes of bombs and ordnance dropped on the citadel and surrounding town over that period, though figures vary by source",
    "The Thạch Hãn River, which runs past the citadel, is considered just as sacred as the grounds themselves - soldiers crossed it nightly under fire to resupply and reinforce the garrison, at enormous cost, and locals still regard the riverbed as a resting place for the dead. Every evening, locals and veterans release flower lanterns onto the river in memory of those who never returned from crossing it - one of the more quietly moving things to witness in Quảng Trị if your timing allows",
    "Combine with the Hiền Lương Bridge and Bến Hải River (15km north) - the former demilitarised zone boundary between North and South Vietnam - for the most complete understanding of Quảng Trị's wartime significance. The citadel is also the anchor of a wider 'Special National Relic' listing that includes several nearby memorial sites, among them Trí Bưu Church and the Long Hưng crossroads",
    "The surrounding citadel walls (Vauban-style French colonial construction, first built in 1809 and expanded in 1837) are largely intact and can be walked - the contrast between the historic administrative architecture and the wartime destruction within is historically layered",
  ...
  insights: {
    highlights: [
      "Memorial to the 81-day 1972 siege (28 June-16 September) where thousands of soldiers and civilians died defending the citadel",
      "Preserved gates and rebuilt walls show the scale of destruction from intensive bombing during the Vietnam War",
    ...
    visitorTips: [
      ...
      "Dress modestly and avoid bright or revealing clothing, particularly if you're planning to offer incense",
      "Bring your own water and food as few dining options are available nearby",
    ],
    faq: [
      { question: "How long does a visit typically take?", answer: "A brief pass-through takes about 15 minutes, but allow 60-90 minutes if you want to offer incense, listen to a guide's explanation, and visit the on-site museum properly." },
      { question: "Is there an entrance fee?", answer: "No, entry tickets are free to visit Thành Cổ Quảng Trị Ancient Citadel." },
      { question: "What should I expect to see?", answer: "The central memorial, restored citadel gates and walls, commemorative monuments, and the museum documenting the 1972 battle." },
      { question: "Can I take photos or film here?", answer: "Yes, photography and filming are allowed. That said, visitors are expected to remain solemn and respectful, especially near the memorial - loud laughter or casual 'check-in' style posing isn't appropriate here." },
    ],
    sentiment: {
