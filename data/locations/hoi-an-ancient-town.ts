...
export const hoiAnAncientTown: Location = {
  ...
  insights: {
    highlights: [
      "Đêm Phố Cổ Lantern Night on the 14th of each lunar month: all electric lights off, entire Old Town lit only by lanterns, 6 PM to 10 PM",
      "5-6 AM morning walk: empty streets, locals doing morning routines, the Old Town before tourism wakes up - the best photography window",
      "Traditional architecture intact across 30 blocks - Japanese Covered Bridge, Chinese assembly halls, Vietnamese tube houses, French colonial facades in one walkable neighbourhood",
    ],
    thingsToKnow: {
      crowds: "Extremely crowded during peak daytime and evening hours. Early morning (5-6 AM) and late evening (after 9 PM) are the best windows. Main tourist streets packed; side alleys have fewer visitors.",
      difficulty: "Entirely flat and walkable. No difficulty.",
      safety: "Stay alert for bikes and motorbikes on narrow streets. When booking river boats, confirm it is a traditional rowing boat - motorised boats are not permitted in the Old Town waterway and some operators take tourists to less atmospheric areas instead.",
      accessibility: "Entire Old Town is walkable with flat pedestrian streets. No motorbike needed inside.",
      seasonal: "February-April: dry season, best weather. October-November: shoulder season with fewer crowds. June-August: hot and humid. October can bring flooding.",
    },
    visitorTips: [
    ...
    faq: [
      {
        question: "When is the Lantern Night (Đêm Phố Cổ) and what happens?",
        answer: "Đêm Phố Cổ runs every 14th of the lunar month from 6 PM to 10 PM. The central Old Town cuts all electric lights and switches to lantern light only. 2026 dates: Feb 11, Mar 13, Apr 11, May 11, Jun 9, Jul 9, Aug 7, Sep 6, Oct 5, Nov 4, Dec 3. It also runs every Saturday. Floating lanterns (đèn hoa đăng) for the river cost 5,000-10,000 VND each.",
      },
      {
        question: "When is the best time to visit Hội An?",
        answer: "For the quietest experience: 5-6 AM when the town is almost empty. For the most atmospheric: Lantern Night (14th lunar month, 6-10 PM). For good weather: February-April. Avoid mid-day peak hours in the main streets year-round.",
      },
      {
        question: "Is tailoring in Hội An reliable?",
        answer: "Quality varies significantly between shops. Order early in your stay (first morning) to allow time for fitting and alterations before departure. Never order on the last day. Research and compare before committing - don't feel pressured to decide on the spot.",
      },
    ],
    sentiment: {
      positive: "Overwhelming praise for Lantern Night atmosphere, riverside beauty, walkability, friendly locals, affordable food, and the magical quality of the town in the early morning and late evening.",
      negative: "Extreme overcrowding during peak daytime hours. Tourist-inflated pricing in central areas. Inconsistent tailoring quality. Some boat operators use motorised boats instead of traditional rowing boats.",
    },
  },
}
